...
class ITPThirdParty : gobject.boxed.Boxed
{
  ...
  */
  ...
  {
    const(char)* _cretval;
    _cretval = webkit_itp_third_party_get_domain(cast(WebKitITPThirdParty*)cPtr);
  ...
  */
  ...
  {
    GList* _cretval;
    _cretval = webkit_itp_third_party_get_first_parties(cast(WebKitITPThirdParty*)cPtr);
