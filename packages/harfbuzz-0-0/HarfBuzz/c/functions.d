...
{
  // Blob
  extern(C) GType function() c_hb_gobject_blob_get_type;

  // Buffer
  extern(C) GType function() c_hb_gobject_buffer_get_type;

  // ColorLine
  extern(C) GType function() c_hb_gobject_color_line_get_type;

  // ColorStop
  extern(C) GType function() c_hb_gobject_color_stop_get_type;

  // DrawFuncs
  extern(C) GType function() c_hb_gobject_draw_funcs_get_type;
  ...
  // Font
  extern(C) GType function() c_hb_gobject_font_get_type;
