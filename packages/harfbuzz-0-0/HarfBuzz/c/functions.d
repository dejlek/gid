...
{
  // Blob
  gidLink(hb_gobject_blob_get_type, "hb_gobject_blob_get_type", LIBS);

  // Buffer
  gidLink(hb_gobject_buffer_get_type, "hb_gobject_buffer_get_type", LIBS);

  // ColorLine
  gidLink(hb_gobject_color_line_get_type, "hb_gobject_color_line_get_type", LIBS);

  // ColorStop
  gidLink(hb_gobject_color_stop_get_type, "hb_gobject_color_stop_get_type", LIBS);

  // DrawFuncs
  gidLink(hb_gobject_draw_funcs_get_type, "hb_gobject_draw_funcs_get_type", LIBS);

  // DrawState
  gidLink(hb_gobject_draw_state_get_type, "hb_gobject_draw_state_get_type", LIBS);

  // Feature
  gidLink(hb_gobject_feature_get_type, "hb_gobject_feature_get_type", LIBS);

  // Font
  gidLink(hb_gobject_font_get_type, "hb_gobject_font_get_type", LIBS);

  // FontFuncs
  gidLink(hb_gobject_font_funcs_get_type, "hb_gobject_font_funcs_get_type", LIBS);

  // Global
  gidLink(hb_aat_layout_feature_type_get_name_id, "hb_aat_layout_feature_type_get_name_id", LIBS);
  gidLink(hb_aat_layout_feature_type_get_selector_infos, "hb_aat_layout_feature_type_get_selector_infos", LIBS);
  gidLink(hb_aat_layout_get_feature_types, "hb_aat_layout_get_feature_types", LIBS);
  gidLink(hb_aat_layout_has_positioning, "hb_aat_layout_has_positioning", LIBS);
  gidLink(hb_aat_layout_has_substitution, "hb_aat_layout_has_substitution", LIBS);
  gidLink(hb_aat_layout_has_tracking, "hb_aat_layout_has_tracking", LIBS);
  gidLink(hb_blob_copy_writable_or_fail, "hb_blob_copy_writable_or_fail", LIBS);
  gidLink(hb_blob_create, "hb_blob_create", LIBS);
  gidLink(hb_blob_create_from_file, "hb_blob_create_from_file", LIBS);
  gidLink(hb_blob_create_from_file_or_fail, "hb_blob_create_from_file_or_fail", LIBS);
  gidLink(hb_blob_create_or_fail, "hb_blob_create_or_fail", LIBS);
  gidLink(hb_blob_create_sub_blob, "hb_blob_create_sub_blob", LIBS);
  gidLink(hb_blob_destroy, "hb_blob_destroy", LIBS);
  gidLink(hb_blob_get_data, "hb_blob_get_data", LIBS);
  gidLink(hb_blob_get_data_writable, "hb_blob_get_data_writable", LIBS);
  gidLink(hb_blob_get_empty, "hb_blob_get_empty", LIBS);
  gidLink(hb_blob_get_length, "hb_blob_get_length", LIBS);
  gidLink(hb_blob_get_user_data, "hb_blob_get_user_data", LIBS);
  gidLink(hb_blob_is_immutable, "hb_blob_is_immutable", LIBS);
  gidLink(hb_blob_make_immutable, "hb_blob_make_immutable", LIBS);
  gidLink(hb_blob_reference, "hb_blob_reference", LIBS);
  gidLink(hb_blob_set_user_data, "hb_blob_set_user_data", LIBS);
  gidLink(hb_buffer_add, "hb_buffer_add", LIBS);
  gidLink(hb_buffer_add_codepoints, "hb_buffer_add_codepoints", LIBS);
  gidLink(hb_buffer_add_latin1, "hb_buffer_add_latin1", LIBS);
  gidLink(hb_buffer_add_utf16, "hb_buffer_add_utf16", LIBS);
  gidLink(hb_buffer_add_utf32, "hb_buffer_add_utf32", LIBS);
  gidLink(hb_buffer_add_utf8, "hb_buffer_add_utf8", LIBS);
  gidLink(hb_buffer_allocation_successful, "hb_buffer_allocation_successful", LIBS);
  gidLink(hb_buffer_append, "hb_buffer_append", LIBS);
  gidLink(hb_buffer_clear_contents, "hb_buffer_clear_contents", LIBS);
  gidLink(hb_buffer_create, "hb_buffer_create", LIBS);
  gidLink(hb_buffer_create_similar, "hb_buffer_create_similar", LIBS);
  gidLink(hb_buffer_deserialize_glyphs, "hb_buffer_deserialize_glyphs", LIBS);
  gidLink(hb_buffer_deserialize_unicode, "hb_buffer_deserialize_unicode", LIBS);
  gidLink(hb_buffer_destroy, "hb_buffer_destroy", LIBS);
  gidLink(hb_buffer_diff, "hb_buffer_diff", LIBS);
  gidLink(hb_buffer_get_cluster_level, "hb_buffer_get_cluster_level", LIBS);
  gidLink(hb_buffer_get_content_type, "hb_buffer_get_content_type", LIBS);
  gidLink(hb_buffer_get_direction, "hb_buffer_get_direction", LIBS);
  gidLink(hb_buffer_get_empty, "hb_buffer_get_empty", LIBS);
  gidLink(hb_buffer_get_flags, "hb_buffer_get_flags", LIBS);
  gidLink(hb_buffer_get_glyph_infos, "hb_buffer_get_glyph_infos", LIBS);
  gidLink(hb_buffer_get_glyph_positions, "hb_buffer_get_glyph_positions", LIBS);
  gidLink(hb_buffer_get_invisible_glyph, "hb_buffer_get_invisible_glyph", LIBS);
  gidLink(hb_buffer_get_language, "hb_buffer_get_language", LIBS);
  gidLink(hb_buffer_get_length, "hb_buffer_get_length", LIBS);
  gidLink(hb_buffer_get_not_found_glyph, "hb_buffer_get_not_found_glyph", LIBS);
  gidLink(hb_buffer_get_replacement_codepoint, "hb_buffer_get_replacement_codepoint", LIBS);
  gidLink(hb_buffer_get_script, "hb_buffer_get_script", LIBS);
  gidLink(hb_buffer_get_segment_properties, "hb_buffer_get_segment_properties", LIBS);
  gidLink(hb_buffer_get_unicode_funcs, "hb_buffer_get_unicode_funcs", LIBS);
  gidLink(hb_buffer_get_user_data, "hb_buffer_get_user_data", LIBS);
  gidLink(hb_buffer_guess_segment_properties, "hb_buffer_guess_segment_properties", LIBS);
  gidLink(hb_buffer_has_positions, "hb_buffer_has_positions", LIBS);
  gidLink(hb_buffer_normalize_glyphs, "hb_buffer_normalize_glyphs", LIBS);
  gidLink(hb_buffer_pre_allocate, "hb_buffer_pre_allocate", LIBS);
  gidLink(hb_buffer_reference, "hb_buffer_reference", LIBS);
  gidLink(hb_buffer_reset, "hb_buffer_reset", LIBS);
  gidLink(hb_buffer_reverse, "hb_buffer_reverse", LIBS);
  gidLink(hb_buffer_reverse_clusters, "hb_buffer_reverse_clusters", LIBS);
  gidLink(hb_buffer_reverse_range, "hb_buffer_reverse_range", LIBS);
  gidLink(hb_buffer_serialize, "hb_buffer_serialize", LIBS);
  gidLink(hb_buffer_serialize_format_from_string, "hb_buffer_serialize_format_from_string", LIBS);
  gidLink(hb_buffer_serialize_format_to_string, "hb_buffer_serialize_format_to_string", LIBS);
  gidLink(hb_buffer_serialize_glyphs, "hb_buffer_serialize_glyphs", LIBS);
  gidLink(hb_buffer_serialize_list_formats, "hb_buffer_serialize_list_formats", LIBS);
  gidLink(hb_buffer_serialize_unicode, "hb_buffer_serialize_unicode", LIBS);
  gidLink(hb_buffer_set_cluster_level, "hb_buffer_set_cluster_level", LIBS);
  gidLink(hb_buffer_set_content_type, "hb_buffer_set_content_type", LIBS);
  gidLink(hb_buffer_set_direction, "hb_buffer_set_direction", LIBS);
  gidLink(hb_buffer_set_flags, "hb_buffer_set_flags", LIBS);
  gidLink(hb_buffer_set_invisible_glyph, "hb_buffer_set_invisible_glyph", LIBS);
  gidLink(hb_buffer_set_language, "hb_buffer_set_language", LIBS);
  gidLink(hb_buffer_set_length, "hb_buffer_set_length", LIBS);
  gidLink(hb_buffer_set_message_func, "hb_buffer_set_message_func", LIBS);
  gidLink(hb_buffer_set_not_found_glyph, "hb_buffer_set_not_found_glyph", LIBS);
  gidLink(hb_buffer_set_replacement_codepoint, "hb_buffer_set_replacement_codepoint", LIBS);
  gidLink(hb_buffer_set_script, "hb_buffer_set_script", LIBS);
  gidLink(hb_buffer_set_segment_properties, "hb_buffer_set_segment_properties", LIBS);
  gidLink(hb_buffer_set_unicode_funcs, "hb_buffer_set_unicode_funcs", LIBS);
  gidLink(hb_buffer_set_user_data, "hb_buffer_set_user_data", LIBS);
  gidLink(hb_color_get_alpha, "hb_color_get_alpha", LIBS);
  gidLink(hb_color_get_blue, "hb_color_get_blue", LIBS);
  gidLink(hb_color_get_green, "hb_color_get_green", LIBS);
  gidLink(hb_color_get_red, "hb_color_get_red", LIBS);
  gidLink(hb_color_line_get_color_stops, "hb_color_line_get_color_stops", LIBS);
  gidLink(hb_color_line_get_extend, "hb_color_line_get_extend", LIBS);
  gidLink(hb_direction_from_string, "hb_direction_from_string", LIBS);
  gidLink(hb_direction_to_string, "hb_direction_to_string", LIBS);
  gidLink(hb_draw_close_path, "hb_draw_close_path", LIBS);
  gidLink(hb_draw_cubic_to, "hb_draw_cubic_to", LIBS);
  gidLink(hb_draw_funcs_create, "hb_draw_funcs_create", LIBS);
  gidLink(hb_draw_funcs_destroy, "hb_draw_funcs_destroy", LIBS);
  gidLink(hb_draw_funcs_get_empty, "hb_draw_funcs_get_empty", LIBS);
  gidLink(hb_draw_funcs_get_user_data, "hb_draw_funcs_get_user_data", LIBS);
  gidLink(hb_draw_funcs_is_immutable, "hb_draw_funcs_is_immutable", LIBS);
  gidLink(hb_draw_funcs_make_immutable, "hb_draw_funcs_make_immutable", LIBS);
  gidLink(hb_draw_funcs_reference, "hb_draw_funcs_reference", LIBS);
  gidLink(hb_draw_funcs_set_close_path_func, "hb_draw_funcs_set_close_path_func", LIBS);
  gidLink(hb_draw_funcs_set_cubic_to_func, "hb_draw_funcs_set_cubic_to_func", LIBS);
  gidLink(hb_draw_funcs_set_line_to_func, "hb_draw_funcs_set_line_to_func", LIBS);
  gidLink(hb_draw_funcs_set_move_to_func, "hb_draw_funcs_set_move_to_func", LIBS);
  gidLink(hb_draw_funcs_set_quadratic_to_func, "hb_draw_funcs_set_quadratic_to_func", LIBS);
  gidLink(hb_draw_funcs_set_user_data, "hb_draw_funcs_set_user_data", LIBS);
  gidLink(hb_draw_line_to, "hb_draw_line_to", LIBS);
  gidLink(hb_draw_move_to, "hb_draw_move_to", LIBS);
  gidLink(hb_draw_quadratic_to, "hb_draw_quadratic_to", LIBS);
  gidLink(hb_face_builder_add_table, "hb_face_builder_add_table", LIBS);
  gidLink(hb_face_builder_create, "hb_face_builder_create", LIBS);
  gidLink(hb_face_builder_sort_tables, "hb_face_builder_sort_tables", LIBS);
  gidLink(hb_face_collect_nominal_glyph_mapping, "hb_face_collect_nominal_glyph_mapping", LIBS);
  gidLink(hb_face_collect_unicodes, "hb_face_collect_unicodes", LIBS);
  gidLink(hb_face_collect_variation_selectors, "hb_face_collect_variation_selectors", LIBS);
  gidLink(hb_face_collect_variation_unicodes, "hb_face_collect_variation_unicodes", LIBS);
  gidLink(hb_face_count, "hb_face_count", LIBS);
  gidLink(hb_face_create, "hb_face_create", LIBS);
  gidLink(hb_face_create_for_tables, "hb_face_create_for_tables", LIBS);
  gidLink(hb_face_destroy, "hb_face_destroy", LIBS);
  gidLink(hb_face_get_empty, "hb_face_get_empty", LIBS);
  gidLink(hb_face_get_glyph_count, "hb_face_get_glyph_count", LIBS);
  gidLink(hb_face_get_index, "hb_face_get_index", LIBS);
  gidLink(hb_face_get_table_tags, "hb_face_get_table_tags", LIBS);
  gidLink(hb_face_get_upem, "hb_face_get_upem", LIBS);
  gidLink(hb_face_get_user_data, "hb_face_get_user_data", LIBS);
  gidLink(hb_face_is_immutable, "hb_face_is_immutable", LIBS);
  gidLink(hb_face_make_immutable, "hb_face_make_immutable", LIBS);
  gidLink(hb_face_reference, "hb_face_reference", LIBS);
  gidLink(hb_face_reference_blob, "hb_face_reference_blob", LIBS);
  gidLink(hb_face_reference_table, "hb_face_reference_table", LIBS);
  gidLink(hb_face_set_glyph_count, "hb_face_set_glyph_count", LIBS);
  gidLink(hb_face_set_index, "hb_face_set_index", LIBS);
  gidLink(hb_face_set_upem, "hb_face_set_upem", LIBS);
  gidLink(hb_face_set_user_data, "hb_face_set_user_data", LIBS);
  gidLink(hb_feature_from_string, "hb_feature_from_string", LIBS);
  gidLink(hb_feature_to_string, "hb_feature_to_string", LIBS);
  gidLink(hb_font_add_glyph_origin_for_direction, "hb_font_add_glyph_origin_for_direction", LIBS);
  gidLink(hb_font_changed, "hb_font_changed", LIBS);
  gidLink(hb_font_create, "hb_font_create", LIBS);
  gidLink(hb_font_create_sub_font, "hb_font_create_sub_font", LIBS);
  gidLink(hb_font_destroy, "hb_font_destroy", LIBS);
  gidLink(hb_font_draw_glyph, "hb_font_draw_glyph", LIBS);
  gidLink(hb_font_funcs_create, "hb_font_funcs_create", LIBS);
  gidLink(hb_font_funcs_destroy, "hb_font_funcs_destroy", LIBS);
  gidLink(hb_font_funcs_get_empty, "hb_font_funcs_get_empty", LIBS);
  gidLink(hb_font_funcs_get_user_data, "hb_font_funcs_get_user_data", LIBS);
  gidLink(hb_font_funcs_is_immutable, "hb_font_funcs_is_immutable", LIBS);
  gidLink(hb_font_funcs_make_immutable, "hb_font_funcs_make_immutable", LIBS);
  gidLink(hb_font_funcs_reference, "hb_font_funcs_reference", LIBS);
  gidLink(hb_font_funcs_set_draw_glyph_func, "hb_font_funcs_set_draw_glyph_func", LIBS);
  gidLink(hb_font_funcs_set_font_h_extents_func, "hb_font_funcs_set_font_h_extents_func", LIBS);
  gidLink(hb_font_funcs_set_font_v_extents_func, "hb_font_funcs_set_font_v_extents_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_contour_point_func, "hb_font_funcs_set_glyph_contour_point_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_extents_func, "hb_font_funcs_set_glyph_extents_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_from_name_func, "hb_font_funcs_set_glyph_from_name_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_func, "hb_font_funcs_set_glyph_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_h_advance_func, "hb_font_funcs_set_glyph_h_advance_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_h_advances_func, "hb_font_funcs_set_glyph_h_advances_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_h_kerning_func, "hb_font_funcs_set_glyph_h_kerning_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_h_origin_func, "hb_font_funcs_set_glyph_h_origin_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_name_func, "hb_font_funcs_set_glyph_name_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_shape_func, "hb_font_funcs_set_glyph_shape_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_v_advance_func, "hb_font_funcs_set_glyph_v_advance_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_v_advances_func, "hb_font_funcs_set_glyph_v_advances_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_v_kerning_func, "hb_font_funcs_set_glyph_v_kerning_func", LIBS);
  gidLink(hb_font_funcs_set_glyph_v_origin_func, "hb_font_funcs_set_glyph_v_origin_func", LIBS);
  gidLink(hb_font_funcs_set_nominal_glyph_func, "hb_font_funcs_set_nominal_glyph_func", LIBS);
  gidLink(hb_font_funcs_set_nominal_glyphs_func, "hb_font_funcs_set_nominal_glyphs_func", LIBS);
  gidLink(hb_font_funcs_set_paint_glyph_func, "hb_font_funcs_set_paint_glyph_func", LIBS);
  gidLink(hb_font_funcs_set_user_data, "hb_font_funcs_set_user_data", LIBS);
  gidLink(hb_font_funcs_set_variation_glyph_func, "hb_font_funcs_set_variation_glyph_func", LIBS);
  gidLink(hb_font_get_empty, "hb_font_get_empty", LIBS);
  gidLink(hb_font_get_extents_for_direction, "hb_font_get_extents_for_direction", LIBS);
  gidLink(hb_font_get_face, "hb_font_get_face", LIBS);
  gidLink(hb_font_get_glyph, "hb_font_get_glyph", LIBS);
  gidLink(hb_font_get_glyph_advance_for_direction, "hb_font_get_glyph_advance_for_direction", LIBS);
  gidLink(hb_font_get_glyph_advances_for_direction, "hb_font_get_glyph_advances_for_direction", LIBS);
  gidLink(hb_font_get_glyph_contour_point, "hb_font_get_glyph_contour_point", LIBS);
  gidLink(hb_font_get_glyph_contour_point_for_origin, "hb_font_get_glyph_contour_point_for_origin", LIBS);
  gidLink(hb_font_get_glyph_extents, "hb_font_get_glyph_extents", LIBS);
  gidLink(hb_font_get_glyph_extents_for_origin, "hb_font_get_glyph_extents_for_origin", LIBS);
  gidLink(hb_font_get_glyph_from_name, "hb_font_get_glyph_from_name", LIBS);
  gidLink(hb_font_get_glyph_h_advance, "hb_font_get_glyph_h_advance", LIBS);
  gidLink(hb_font_get_glyph_h_advances, "hb_font_get_glyph_h_advances", LIBS);
  gidLink(hb_font_get_glyph_h_kerning, "hb_font_get_glyph_h_kerning", LIBS);
  gidLink(hb_font_get_glyph_h_origin, "hb_font_get_glyph_h_origin", LIBS);
  gidLink(hb_font_get_glyph_kerning_for_direction, "hb_font_get_glyph_kerning_for_direction", LIBS);
  gidLink(hb_font_get_glyph_name, "hb_font_get_glyph_name", LIBS);
  gidLink(hb_font_get_glyph_origin_for_direction, "hb_font_get_glyph_origin_for_direction", LIBS);
  gidLink(hb_font_get_glyph_shape, "hb_font_get_glyph_shape", LIBS);
  gidLink(hb_font_get_glyph_v_advance, "hb_font_get_glyph_v_advance", LIBS);
  gidLink(hb_font_get_glyph_v_advances, "hb_font_get_glyph_v_advances", LIBS);
  gidLink(hb_font_get_glyph_v_kerning, "hb_font_get_glyph_v_kerning", LIBS);
  gidLink(hb_font_get_glyph_v_origin, "hb_font_get_glyph_v_origin", LIBS);
  gidLink(hb_font_get_h_extents, "hb_font_get_h_extents", LIBS);
  gidLink(hb_font_get_nominal_glyph, "hb_font_get_nominal_glyph", LIBS);
  gidLink(hb_font_get_nominal_glyphs, "hb_font_get_nominal_glyphs", LIBS);
  gidLink(hb_font_get_parent, "hb_font_get_parent", LIBS);
  gidLink(hb_font_get_ppem, "hb_font_get_ppem", LIBS);
  gidLink(hb_font_get_ptem, "hb_font_get_ptem", LIBS);
  gidLink(hb_font_get_scale, "hb_font_get_scale", LIBS);
  gidLink(hb_font_get_serial, "hb_font_get_serial", LIBS);
  gidLink(hb_font_get_synthetic_bold, "hb_font_get_synthetic_bold", LIBS);
  gidLink(hb_font_get_synthetic_slant, "hb_font_get_synthetic_slant", LIBS);
  gidLink(hb_font_get_user_data, "hb_font_get_user_data", LIBS);
  gidLink(hb_font_get_v_extents, "hb_font_get_v_extents", LIBS);
  gidLink(hb_font_get_var_coords_design, "hb_font_get_var_coords_design", LIBS);
  gidLink(hb_font_get_var_coords_normalized, "hb_font_get_var_coords_normalized", LIBS);
  gidLink(hb_font_get_var_named_instance, "hb_font_get_var_named_instance", LIBS);
  gidLink(hb_font_get_variation_glyph, "hb_font_get_variation_glyph", LIBS);
  gidLink(hb_font_glyph_from_string, "hb_font_glyph_from_string", LIBS);
  gidLink(hb_font_glyph_to_string, "hb_font_glyph_to_string", LIBS);
  gidLink(hb_font_is_immutable, "hb_font_is_immutable", LIBS);
  gidLink(hb_font_make_immutable, "hb_font_make_immutable", LIBS);
  gidLink(hb_font_paint_glyph, "hb_font_paint_glyph", LIBS);
  gidLink(hb_font_reference, "hb_font_reference", LIBS);
  gidLink(hb_font_set_face, "hb_font_set_face", LIBS);
  gidLink(hb_font_set_funcs, "hb_font_set_funcs", LIBS);
  gidLink(hb_font_set_funcs_data, "hb_font_set_funcs_data", LIBS);
  gidLink(hb_font_set_parent, "hb_font_set_parent", LIBS);
  gidLink(hb_font_set_ppem, "hb_font_set_ppem", LIBS);
  gidLink(hb_font_set_ptem, "hb_font_set_ptem", LIBS);
  gidLink(hb_font_set_scale, "hb_font_set_scale", LIBS);
  gidLink(hb_font_set_synthetic_bold, "hb_font_set_synthetic_bold", LIBS);
  gidLink(hb_font_set_synthetic_slant, "hb_font_set_synthetic_slant", LIBS);
  gidLink(hb_font_set_user_data, "hb_font_set_user_data", LIBS);
  gidLink(hb_font_set_var_coords_design, "hb_font_set_var_coords_design", LIBS);
  gidLink(hb_font_set_var_coords_normalized, "hb_font_set_var_coords_normalized", LIBS);
  gidLink(hb_font_set_var_named_instance, "hb_font_set_var_named_instance", LIBS);
  gidLink(hb_font_set_variation, "hb_font_set_variation", LIBS);
  gidLink(hb_font_set_variations, "hb_font_set_variations", LIBS);
  gidLink(hb_font_subtract_glyph_origin_for_direction, "hb_font_subtract_glyph_origin_for_direction", LIBS);
  gidLink(hb_ft_face_create, "hb_ft_face_create", LIBS);
  gidLink(hb_ft_face_create_cached, "hb_ft_face_create_cached", LIBS);
  gidLink(hb_ft_face_create_referenced, "hb_ft_face_create_referenced", LIBS);
  gidLink(hb_ft_font_changed, "hb_ft_font_changed", LIBS);
  gidLink(hb_ft_font_create, "hb_ft_font_create", LIBS);
  gidLink(hb_ft_font_create_referenced, "hb_ft_font_create_referenced", LIBS);
  gidLink(hb_ft_font_get_face, "hb_ft_font_get_face", LIBS);
  gidLink(hb_ft_font_get_load_flags, "hb_ft_font_get_load_flags", LIBS);
  gidLink(hb_ft_font_lock_face, "hb_ft_font_lock_face", LIBS);
  gidLink(hb_ft_font_set_funcs, "hb_ft_font_set_funcs", LIBS);
  gidLink(hb_ft_font_set_load_flags, "hb_ft_font_set_load_flags", LIBS);
  gidLink(hb_ft_font_unlock_face, "hb_ft_font_unlock_face", LIBS);
  gidLink(hb_ft_hb_font_changed, "hb_ft_hb_font_changed", LIBS);
  gidLink(hb_glib_blob_create, "hb_glib_blob_create", LIBS);
  gidLink(hb_glib_get_unicode_funcs, "hb_glib_get_unicode_funcs", LIBS);
  gidLink(hb_glib_script_from_script, "hb_glib_script_from_script", LIBS);
  gidLink(hb_glib_script_to_script, "hb_glib_script_to_script", LIBS);
  gidLink(hb_glyph_info_get_glyph_flags, "hb_glyph_info_get_glyph_flags", LIBS);
  gidLink(hb_language_from_string, "hb_language_from_string", LIBS);
  gidLink(hb_language_get_default, "hb_language_get_default", LIBS);
  gidLink(hb_language_matches, "hb_language_matches", LIBS);
  gidLink(hb_language_to_string, "hb_language_to_string", LIBS);
  gidLink(hb_map_allocation_successful, "hb_map_allocation_successful", LIBS);
  gidLink(hb_map_clear, "hb_map_clear", LIBS);
  gidLink(hb_map_copy, "hb_map_copy", LIBS);
  gidLink(hb_map_create, "hb_map_create", LIBS);
  gidLink(hb_map_del, "hb_map_del", LIBS);
  gidLink(hb_map_destroy, "hb_map_destroy", LIBS);
  gidLink(hb_map_get, "hb_map_get", LIBS);
  gidLink(hb_map_get_empty, "hb_map_get_empty", LIBS);
  gidLink(hb_map_get_population, "hb_map_get_population", LIBS);
  gidLink(hb_map_get_user_data, "hb_map_get_user_data", LIBS);
  gidLink(hb_map_has, "hb_map_has", LIBS);
  gidLink(hb_map_hash, "hb_map_hash", LIBS);
  gidLink(hb_map_is_empty, "hb_map_is_empty", LIBS);
  gidLink(hb_map_is_equal, "hb_map_is_equal", LIBS);
  gidLink(hb_map_keys, "hb_map_keys", LIBS);
  gidLink(hb_map_next, "hb_map_next", LIBS);
  gidLink(hb_map_reference, "hb_map_reference", LIBS);
  gidLink(hb_map_set, "hb_map_set", LIBS);
  gidLink(hb_map_set_user_data, "hb_map_set_user_data", LIBS);
  gidLink(hb_map_update, "hb_map_update", LIBS);
  gidLink(hb_map_values, "hb_map_values", LIBS);
  gidLink(hb_ot_color_glyph_get_layers, "hb_ot_color_glyph_get_layers", LIBS);
  gidLink(hb_ot_color_glyph_has_paint, "hb_ot_color_glyph_has_paint", LIBS);
  gidLink(hb_ot_color_glyph_reference_png, "hb_ot_color_glyph_reference_png", LIBS);
  gidLink(hb_ot_color_glyph_reference_svg, "hb_ot_color_glyph_reference_svg", LIBS);
  gidLink(hb_ot_color_has_layers, "hb_ot_color_has_layers", LIBS);
  gidLink(hb_ot_color_has_paint, "hb_ot_color_has_paint", LIBS);
  gidLink(hb_ot_color_has_palettes, "hb_ot_color_has_palettes", LIBS);
  gidLink(hb_ot_color_has_png, "hb_ot_color_has_png", LIBS);
  gidLink(hb_ot_color_has_svg, "hb_ot_color_has_svg", LIBS);
  gidLink(hb_ot_color_palette_color_get_name_id, "hb_ot_color_palette_color_get_name_id", LIBS);
  gidLink(hb_ot_color_palette_get_colors, "hb_ot_color_palette_get_colors", LIBS);
  gidLink(hb_ot_color_palette_get_count, "hb_ot_color_palette_get_count", LIBS);
  gidLink(hb_ot_color_palette_get_flags, "hb_ot_color_palette_get_flags", LIBS);
  gidLink(hb_ot_color_palette_get_name_id, "hb_ot_color_palette_get_name_id", LIBS);
  gidLink(hb_ot_font_set_funcs, "hb_ot_font_set_funcs", LIBS);
  gidLink(hb_ot_layout_collect_features, "hb_ot_layout_collect_features", LIBS);
  gidLink(hb_ot_layout_collect_features_map, "hb_ot_layout_collect_features_map", LIBS);
  gidLink(hb_ot_layout_collect_lookups, "hb_ot_layout_collect_lookups", LIBS);
  gidLink(hb_ot_layout_feature_get_characters, "hb_ot_layout_feature_get_characters", LIBS);
  gidLink(hb_ot_layout_feature_get_lookups, "hb_ot_layout_feature_get_lookups", LIBS);
  gidLink(hb_ot_layout_feature_get_name_ids, "hb_ot_layout_feature_get_name_ids", LIBS);
  gidLink(hb_ot_layout_feature_with_variations_get_lookups, "hb_ot_layout_feature_with_variations_get_lookups", LIBS);
  gidLink(hb_ot_layout_get_attach_points, "hb_ot_layout_get_attach_points", LIBS);
  gidLink(hb_ot_layout_get_baseline, "hb_ot_layout_get_baseline", LIBS);
  gidLink(hb_ot_layout_get_baseline2, "hb_ot_layout_get_baseline2", LIBS);
  gidLink(hb_ot_layout_get_baseline_with_fallback, "hb_ot_layout_get_baseline_with_fallback", LIBS);
  gidLink(hb_ot_layout_get_baseline_with_fallback2, "hb_ot_layout_get_baseline_with_fallback2", LIBS);
  gidLink(hb_ot_layout_get_font_extents, "hb_ot_layout_get_font_extents", LIBS);
  gidLink(hb_ot_layout_get_font_extents2, "hb_ot_layout_get_font_extents2", LIBS);
  gidLink(hb_ot_layout_get_glyph_class, "hb_ot_layout_get_glyph_class", LIBS);
  gidLink(hb_ot_layout_get_glyphs_in_class, "hb_ot_layout_get_glyphs_in_class", LIBS);
  gidLink(hb_ot_layout_get_horizontal_baseline_tag_for_script, "hb_ot_layout_get_horizontal_baseline_tag_for_script", LIBS);
  gidLink(hb_ot_layout_get_ligature_carets, "hb_ot_layout_get_ligature_carets", LIBS);
  gidLink(hb_ot_layout_get_size_params, "hb_ot_layout_get_size_params", LIBS);
  gidLink(hb_ot_layout_has_glyph_classes, "hb_ot_layout_has_glyph_classes", LIBS);
  gidLink(hb_ot_layout_has_positioning, "hb_ot_layout_has_positioning", LIBS);
  gidLink(hb_ot_layout_has_substitution, "hb_ot_layout_has_substitution", LIBS);
  gidLink(hb_ot_layout_language_find_feature, "hb_ot_layout_language_find_feature", LIBS);
  gidLink(hb_ot_layout_language_get_feature_indexes, "hb_ot_layout_language_get_feature_indexes", LIBS);
  gidLink(hb_ot_layout_language_get_feature_tags, "hb_ot_layout_language_get_feature_tags", LIBS);
  gidLink(hb_ot_layout_language_get_required_feature, "hb_ot_layout_language_get_required_feature", LIBS);
  gidLink(hb_ot_layout_language_get_required_feature_index, "hb_ot_layout_language_get_required_feature_index", LIBS);
  gidLink(hb_ot_layout_lookup_collect_glyphs, "hb_ot_layout_lookup_collect_glyphs", LIBS);
  gidLink(hb_ot_layout_lookup_get_glyph_alternates, "hb_ot_layout_lookup_get_glyph_alternates", LIBS);
  gidLink(hb_ot_layout_lookup_get_optical_bound, "hb_ot_layout_lookup_get_optical_bound", LIBS);
  gidLink(hb_ot_layout_lookup_substitute_closure, "hb_ot_layout_lookup_substitute_closure", LIBS);
  gidLink(hb_ot_layout_lookup_would_substitute, "hb_ot_layout_lookup_would_substitute", LIBS);
  gidLink(hb_ot_layout_lookups_substitute_closure, "hb_ot_layout_lookups_substitute_closure", LIBS);
  gidLink(hb_ot_layout_script_find_language, "hb_ot_layout_script_find_language", LIBS);
  gidLink(hb_ot_layout_script_get_language_tags, "hb_ot_layout_script_get_language_tags", LIBS);
  gidLink(hb_ot_layout_script_select_language, "hb_ot_layout_script_select_language", LIBS);
  gidLink(hb_ot_layout_script_select_language2, "hb_ot_layout_script_select_language2", LIBS);
  gidLink(hb_ot_layout_table_choose_script, "hb_ot_layout_table_choose_script", LIBS);
  gidLink(hb_ot_layout_table_find_feature_variations, "hb_ot_layout_table_find_feature_variations", LIBS);
  gidLink(hb_ot_layout_table_find_script, "hb_ot_layout_table_find_script", LIBS);
  gidLink(hb_ot_layout_table_get_feature_tags, "hb_ot_layout_table_get_feature_tags", LIBS);
  gidLink(hb_ot_layout_table_get_lookup_count, "hb_ot_layout_table_get_lookup_count", LIBS);
  gidLink(hb_ot_layout_table_get_script_tags, "hb_ot_layout_table_get_script_tags", LIBS);
  gidLink(hb_ot_layout_table_select_script, "hb_ot_layout_table_select_script", LIBS);
  gidLink(hb_ot_math_get_constant, "hb_ot_math_get_constant", LIBS);
  gidLink(hb_ot_math_get_glyph_assembly, "hb_ot_math_get_glyph_assembly", LIBS);
  gidLink(hb_ot_math_get_glyph_italics_correction, "hb_ot_math_get_glyph_italics_correction", LIBS);
  gidLink(hb_ot_math_get_glyph_kerning, "hb_ot_math_get_glyph_kerning", LIBS);
  gidLink(hb_ot_math_get_glyph_kernings, "hb_ot_math_get_glyph_kernings", LIBS);
  gidLink(hb_ot_math_get_glyph_top_accent_attachment, "hb_ot_math_get_glyph_top_accent_attachment", LIBS);
  gidLink(hb_ot_math_get_glyph_variants, "hb_ot_math_get_glyph_variants", LIBS);
  gidLink(hb_ot_math_get_min_connector_overlap, "hb_ot_math_get_min_connector_overlap", LIBS);
  gidLink(hb_ot_math_has_data, "hb_ot_math_has_data", LIBS);
  gidLink(hb_ot_math_is_glyph_extended_shape, "hb_ot_math_is_glyph_extended_shape", LIBS);
  gidLink(hb_ot_meta_get_entry_tags, "hb_ot_meta_get_entry_tags", LIBS);
  gidLink(hb_ot_meta_reference_entry, "hb_ot_meta_reference_entry", LIBS);
  gidLink(hb_ot_metrics_get_position, "hb_ot_metrics_get_position", LIBS);
  gidLink(hb_ot_metrics_get_position_with_fallback, "hb_ot_metrics_get_position_with_fallback", LIBS);
  gidLink(hb_ot_metrics_get_variation, "hb_ot_metrics_get_variation", LIBS);
  gidLink(hb_ot_metrics_get_x_variation, "hb_ot_metrics_get_x_variation", LIBS);
  gidLink(hb_ot_metrics_get_y_variation, "hb_ot_metrics_get_y_variation", LIBS);
  gidLink(hb_ot_name_get_utf16, "hb_ot_name_get_utf16", LIBS);
  gidLink(hb_ot_name_get_utf32, "hb_ot_name_get_utf32", LIBS);
  gidLink(hb_ot_name_get_utf8, "hb_ot_name_get_utf8", LIBS);
  gidLink(hb_ot_name_list_names, "hb_ot_name_list_names", LIBS);
  gidLink(hb_ot_shape_glyphs_closure, "hb_ot_shape_glyphs_closure", LIBS);
  gidLink(hb_ot_shape_plan_collect_lookups, "hb_ot_shape_plan_collect_lookups", LIBS);
  gidLink(hb_ot_tag_from_language, "hb_ot_tag_from_language", LIBS);
  gidLink(hb_ot_tag_to_language, "hb_ot_tag_to_language", LIBS);
  gidLink(hb_ot_tag_to_script, "hb_ot_tag_to_script", LIBS);
  gidLink(hb_ot_tags_from_script, "hb_ot_tags_from_script", LIBS);
  gidLink(hb_ot_tags_from_script_and_language, "hb_ot_tags_from_script_and_language", LIBS);
  gidLink(hb_ot_tags_to_script_and_language, "hb_ot_tags_to_script_and_language", LIBS);
  gidLink(hb_ot_var_find_axis, "hb_ot_var_find_axis", LIBS);
  gidLink(hb_ot_var_find_axis_info, "hb_ot_var_find_axis_info", LIBS);
  gidLink(hb_ot_var_get_axes, "hb_ot_var_get_axes", LIBS);
  gidLink(hb_ot_var_get_axis_count, "hb_ot_var_get_axis_count", LIBS);
  gidLink(hb_ot_var_get_axis_infos, "hb_ot_var_get_axis_infos", LIBS);
  gidLink(hb_ot_var_get_named_instance_count, "hb_ot_var_get_named_instance_count", LIBS);
  gidLink(hb_ot_var_has_data, "hb_ot_var_has_data", LIBS);
  gidLink(hb_ot_var_named_instance_get_design_coords, "hb_ot_var_named_instance_get_design_coords", LIBS);
  gidLink(hb_ot_var_named_instance_get_postscript_name_id, "hb_ot_var_named_instance_get_postscript_name_id", LIBS);
  gidLink(hb_ot_var_named_instance_get_subfamily_name_id, "hb_ot_var_named_instance_get_subfamily_name_id", LIBS);
  gidLink(hb_ot_var_normalize_coords, "hb_ot_var_normalize_coords", LIBS);
  gidLink(hb_ot_var_normalize_variations, "hb_ot_var_normalize_variations", LIBS);
  gidLink(hb_paint_color, "hb_paint_color", LIBS);
  gidLink(hb_paint_color_glyph, "hb_paint_color_glyph", LIBS);
  gidLink(hb_paint_custom_palette_color, "hb_paint_custom_palette_color", LIBS);
  gidLink(hb_paint_funcs_create, "hb_paint_funcs_create", LIBS);
  gidLink(hb_paint_funcs_destroy, "hb_paint_funcs_destroy", LIBS);
  gidLink(hb_paint_funcs_get_empty, "hb_paint_funcs_get_empty", LIBS);
  gidLink(hb_paint_funcs_get_user_data, "hb_paint_funcs_get_user_data", LIBS);
  gidLink(hb_paint_funcs_is_immutable, "hb_paint_funcs_is_immutable", LIBS);
  gidLink(hb_paint_funcs_make_immutable, "hb_paint_funcs_make_immutable", LIBS);
  gidLink(hb_paint_funcs_reference, "hb_paint_funcs_reference", LIBS);
  gidLink(hb_paint_funcs_set_color_func, "hb_paint_funcs_set_color_func", LIBS);
  gidLink(hb_paint_funcs_set_color_glyph_func, "hb_paint_funcs_set_color_glyph_func", LIBS);
  gidLink(hb_paint_funcs_set_custom_palette_color_func, "hb_paint_funcs_set_custom_palette_color_func", LIBS);
  gidLink(hb_paint_funcs_set_image_func, "hb_paint_funcs_set_image_func", LIBS);
  gidLink(hb_paint_funcs_set_linear_gradient_func, "hb_paint_funcs_set_linear_gradient_func", LIBS);
  gidLink(hb_paint_funcs_set_pop_clip_func, "hb_paint_funcs_set_pop_clip_func", LIBS);
  gidLink(hb_paint_funcs_set_pop_group_func, "hb_paint_funcs_set_pop_group_func", LIBS);
  gidLink(hb_paint_funcs_set_pop_transform_func, "hb_paint_funcs_set_pop_transform_func", LIBS);
  gidLink(hb_paint_funcs_set_push_clip_glyph_func, "hb_paint_funcs_set_push_clip_glyph_func", LIBS);
  gidLink(hb_paint_funcs_set_push_clip_rectangle_func, "hb_paint_funcs_set_push_clip_rectangle_func", LIBS);
  gidLink(hb_paint_funcs_set_push_group_func, "hb_paint_funcs_set_push_group_func", LIBS);
  gidLink(hb_paint_funcs_set_push_transform_func, "hb_paint_funcs_set_push_transform_func", LIBS);
  gidLink(hb_paint_funcs_set_radial_gradient_func, "hb_paint_funcs_set_radial_gradient_func", LIBS);
  gidLink(hb_paint_funcs_set_sweep_gradient_func, "hb_paint_funcs_set_sweep_gradient_func", LIBS);
  gidLink(hb_paint_funcs_set_user_data, "hb_paint_funcs_set_user_data", LIBS);
  gidLink(hb_paint_image, "hb_paint_image", LIBS);
  gidLink(hb_paint_linear_gradient, "hb_paint_linear_gradient", LIBS);
  gidLink(hb_paint_pop_clip, "hb_paint_pop_clip", LIBS);
  gidLink(hb_paint_pop_group, "hb_paint_pop_group", LIBS);
  gidLink(hb_paint_pop_transform, "hb_paint_pop_transform", LIBS);
  gidLink(hb_paint_push_clip_glyph, "hb_paint_push_clip_glyph", LIBS);
  gidLink(hb_paint_push_clip_rectangle, "hb_paint_push_clip_rectangle", LIBS);
  gidLink(hb_paint_push_group, "hb_paint_push_group", LIBS);
  gidLink(hb_paint_push_transform, "hb_paint_push_transform", LIBS);
  gidLink(hb_paint_radial_gradient, "hb_paint_radial_gradient", LIBS);
  gidLink(hb_paint_sweep_gradient, "hb_paint_sweep_gradient", LIBS);
  gidLink(hb_script_from_iso15924_tag, "hb_script_from_iso15924_tag", LIBS);
  gidLink(hb_script_from_string, "hb_script_from_string", LIBS);
  gidLink(hb_script_get_horizontal_direction, "hb_script_get_horizontal_direction", LIBS);
  gidLink(hb_script_to_iso15924_tag, "hb_script_to_iso15924_tag", LIBS);
  gidLink(hb_segment_properties_equal, "hb_segment_properties_equal", LIBS);
  gidLink(hb_segment_properties_hash, "hb_segment_properties_hash", LIBS);
  gidLink(hb_segment_properties_overlay, "hb_segment_properties_overlay", LIBS);
  gidLink(hb_set_add, "hb_set_add", LIBS);
  gidLink(hb_set_add_range, "hb_set_add_range", LIBS);
  gidLink(hb_set_add_sorted_array, "hb_set_add_sorted_array", LIBS);
  gidLink(hb_set_allocation_successful, "hb_set_allocation_successful", LIBS);
  gidLink(hb_set_clear, "hb_set_clear", LIBS);
  gidLink(hb_set_copy, "hb_set_copy", LIBS);
  gidLink(hb_set_create, "hb_set_create", LIBS);
  gidLink(hb_set_del, "hb_set_del", LIBS);
  gidLink(hb_set_del_range, "hb_set_del_range", LIBS);
  gidLink(hb_set_destroy, "hb_set_destroy", LIBS);
  gidLink(hb_set_get_empty, "hb_set_get_empty", LIBS);
  gidLink(hb_set_get_max, "hb_set_get_max", LIBS);
  gidLink(hb_set_get_min, "hb_set_get_min", LIBS);
  gidLink(hb_set_get_population, "hb_set_get_population", LIBS);
  gidLink(hb_set_get_user_data, "hb_set_get_user_data", LIBS);
  gidLink(hb_set_has, "hb_set_has", LIBS);
  gidLink(hb_set_hash, "hb_set_hash", LIBS);
  gidLink(hb_set_intersect, "hb_set_intersect", LIBS);
  gidLink(hb_set_invert, "hb_set_invert", LIBS);
  gidLink(hb_set_is_empty, "hb_set_is_empty", LIBS);
  gidLink(hb_set_is_equal, "hb_set_is_equal", LIBS);
  gidLink(hb_set_is_inverted, "hb_set_is_inverted", LIBS);
  gidLink(hb_set_is_subset, "hb_set_is_subset", LIBS);
  gidLink(hb_set_next, "hb_set_next", LIBS);
  gidLink(hb_set_next_many, "hb_set_next_many", LIBS);
  gidLink(hb_set_next_range, "hb_set_next_range", LIBS);
  gidLink(hb_set_previous, "hb_set_previous", LIBS);
  gidLink(hb_set_previous_range, "hb_set_previous_range", LIBS);
  gidLink(hb_set_reference, "hb_set_reference", LIBS);
  gidLink(hb_set_set, "hb_set_set", LIBS);
  gidLink(hb_set_set_user_data, "hb_set_set_user_data", LIBS);
  gidLink(hb_set_subtract, "hb_set_subtract", LIBS);
  gidLink(hb_set_symmetric_difference, "hb_set_symmetric_difference", LIBS);
  gidLink(hb_set_union, "hb_set_union", LIBS);
  gidLink(hb_shape, "hb_shape", LIBS);
  gidLink(hb_shape_full, "hb_shape_full", LIBS);
  gidLink(hb_shape_justify, "hb_shape_justify", LIBS);
  gidLink(hb_shape_list_shapers, "hb_shape_list_shapers", LIBS);
  gidLink(hb_shape_plan_create, "hb_shape_plan_create", LIBS);
  gidLink(hb_shape_plan_create2, "hb_shape_plan_create2", LIBS);
  gidLink(hb_shape_plan_create_cached, "hb_shape_plan_create_cached", LIBS);
  gidLink(hb_shape_plan_create_cached2, "hb_shape_plan_create_cached2", LIBS);
  gidLink(hb_shape_plan_destroy, "hb_shape_plan_destroy", LIBS);
  gidLink(hb_shape_plan_execute, "hb_shape_plan_execute", LIBS);
  gidLink(hb_shape_plan_get_empty, "hb_shape_plan_get_empty", LIBS);
  gidLink(hb_shape_plan_get_shaper, "hb_shape_plan_get_shaper", LIBS);
  gidLink(hb_shape_plan_get_user_data, "hb_shape_plan_get_user_data", LIBS);
  gidLink(hb_shape_plan_reference, "hb_shape_plan_reference", LIBS);
  gidLink(hb_shape_plan_set_user_data, "hb_shape_plan_set_user_data", LIBS);
  gidLink(hb_style_get_value, "hb_style_get_value", LIBS);
  gidLink(hb_tag_from_string, "hb_tag_from_string", LIBS);
  gidLink(hb_tag_to_string, "hb_tag_to_string", LIBS);
  gidLink(hb_unicode_combining_class, "hb_unicode_combining_class", LIBS);
  gidLink(hb_unicode_compose, "hb_unicode_compose", LIBS);
  gidLink(hb_unicode_decompose, "hb_unicode_decompose", LIBS);
  gidLink(hb_unicode_decompose_compatibility, "hb_unicode_decompose_compatibility", LIBS);
  gidLink(hb_unicode_eastasian_width, "hb_unicode_eastasian_width", LIBS);
  gidLink(hb_unicode_funcs_create, "hb_unicode_funcs_create", LIBS);
  gidLink(hb_unicode_funcs_destroy, "hb_unicode_funcs_destroy", LIBS);
  gidLink(hb_unicode_funcs_get_default, "hb_unicode_funcs_get_default", LIBS);
  gidLink(hb_unicode_funcs_get_empty, "hb_unicode_funcs_get_empty", LIBS);
  gidLink(hb_unicode_funcs_get_parent, "hb_unicode_funcs_get_parent", LIBS);
  gidLink(hb_unicode_funcs_get_user_data, "hb_unicode_funcs_get_user_data", LIBS);
  gidLink(hb_unicode_funcs_is_immutable, "hb_unicode_funcs_is_immutable", LIBS);
  gidLink(hb_unicode_funcs_make_immutable, "hb_unicode_funcs_make_immutable", LIBS);
  gidLink(hb_unicode_funcs_reference, "hb_unicode_funcs_reference", LIBS);
  gidLink(hb_unicode_funcs_set_combining_class_func, "hb_unicode_funcs_set_combining_class_func", LIBS);
  gidLink(hb_unicode_funcs_set_compose_func, "hb_unicode_funcs_set_compose_func", LIBS);
  gidLink(hb_unicode_funcs_set_decompose_compatibility_func, "hb_unicode_funcs_set_decompose_compatibility_func", LIBS);
  gidLink(hb_unicode_funcs_set_decompose_func, "hb_unicode_funcs_set_decompose_func", LIBS);
  gidLink(hb_unicode_funcs_set_eastasian_width_func, "hb_unicode_funcs_set_eastasian_width_func", LIBS);
  gidLink(hb_unicode_funcs_set_general_category_func, "hb_unicode_funcs_set_general_category_func", LIBS);
  gidLink(hb_unicode_funcs_set_mirroring_func, "hb_unicode_funcs_set_mirroring_func", LIBS);
  gidLink(hb_unicode_funcs_set_script_func, "hb_unicode_funcs_set_script_func", LIBS);
  gidLink(hb_unicode_funcs_set_user_data, "hb_unicode_funcs_set_user_data", LIBS);
  gidLink(hb_unicode_general_category, "hb_unicode_general_category", LIBS);
  gidLink(hb_unicode_mirroring, "hb_unicode_mirroring", LIBS);
  gidLink(hb_unicode_script, "hb_unicode_script", LIBS);
  gidLink(hb_variation_from_string, "hb_variation_from_string", LIBS);
  gidLink(hb_variation_to_string, "hb_variation_to_string", LIBS);

  // GlyphInfo
  gidLink(hb_gobject_glyph_info_get_type, "hb_gobject_glyph_info_get_type", LIBS);

  // GlyphPosition
  gidLink(hb_gobject_glyph_position_get_type, "hb_gobject_glyph_position_get_type", LIBS);

  // HBFace
  gidLink(hb_gobject_face_get_type, "hb_gobject_face_get_type", LIBS);

  // Map
  gidLink(hb_gobject_map_get_type, "hb_gobject_map_get_type", LIBS);

  // OtMathGlyphPart
  gidLink(hb_gobject_ot_math_glyph_part_get_type, "hb_gobject_ot_math_glyph_part_get_type", LIBS);

  // OtMathGlyphVariant
  gidLink(hb_gobject_ot_math_glyph_variant_get_type, "hb_gobject_ot_math_glyph_variant_get_type", LIBS);

  // OtVarAxisInfo
  gidLink(hb_gobject_ot_var_axis_info_get_type, "hb_gobject_ot_var_axis_info_get_type", LIBS);

  // PaintFuncs
  gidLink(hb_gobject_paint_funcs_get_type, "hb_gobject_paint_funcs_get_type", LIBS);

  // SegmentProperties
  gidLink(hb_gobject_segment_properties_get_type, "hb_gobject_segment_properties_get_type", LIBS);

  // Set
  gidLink(hb_gobject_set_get_type, "hb_gobject_set_get_type", LIBS);

  // ShapePlan
  gidLink(hb_gobject_shape_plan_get_type, "hb_gobject_shape_plan_get_type", LIBS);

  // UnicodeFuncs
  gidLink(hb_gobject_unicode_funcs_get_type, "hb_gobject_unicode_funcs_get_type", LIBS);

  // UserDataKey
  gidLink(hb_gobject_user_data_key_get_type, "hb_gobject_user_data_key_get_type", LIBS);
}
