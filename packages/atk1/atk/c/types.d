...
enum AtkRelationType
{
   ...
   * AtkObject in a sequential way, $(LPAREN)for instance text-flow$(RPAREN).
   */
  FlowsTo = 7,

  /**
   * Indicates that the object has content that flows logically from
   * another AtkObject in a sequential way, $(LPAREN)for instance text-flow$(RPAREN).
   */
  FlowsFrom = 8,
   ...
   * object provides descriptive information about the target object$(LPAREN)s$(RPAREN). See also
   ...
   * object$(LPAREN)s$(RPAREN). This relation type is most appropriate for information that is sufficiently
   ...
   * provides a detailed or extended description about the target object$(LPAREN)s$(RPAREN). See also
   ...
   * object$(LPAREN)s$(RPAREN). Objects that have this relation type should also contain %ATK_STATE_INVALID_ENTRY
   ...
   * contains an error message describing an invalid condition in the target object$(LPAREN)s$(RPAREN). @Since:
   * ATK_2.26.
   */
  ErrorFor = 20,
...
enum AtkRole
{
  ...
  /**
   * An object that presents a series of panels $(LPAREN)or page tabs$(RPAREN), one at a time, through some mechanism provided by the object
   */
  PageTabList = 37,
  ...
  /**
   * An object that represents an accessible terminal.  $(LPAREN)Since: 0.6$(RPAREN)
   */
  Terminal = 59,
  ...
  /**
   * An object capable of expanding and collapsing rows as well as showing multiple columns of data.   $(LPAREN)Since: 0.7$(RPAREN)
   */
  TreeTable = 65,
  ...
  /**
   * An object that serves as a document header. $(LPAREN)Since: 1.1.1$(RPAREN)
   */
  Header = 69,

  /**
   * An object that serves as a document footer.  $(LPAREN)Since: 1.1.1$(RPAREN)
   */
  Footer = 70,

  /**
   * An object which is contains a paragraph of text content.   $(LPAREN)Since: 1.1.1$(RPAREN)
   */
  Paragraph = 71,

  /**
   * An object which describes margins and tab stops, etc. for text objects which it controls $(LPAREN)should have CONTROLLER_FOR relation to such$(RPAREN).   $(LPAREN)Since: 1.1.1$(RPAREN)
   */
  Ruler = 72,

  /**
   * The object is an application object, which may contain @ATK_ROLE_FRAME objects or other types of accessibles.  The root accessible of any application's ATK hierarchy should have ATK_ROLE_APPLICATION.   $(LPAREN)Since: 1.1.4$(RPAREN)
   */
  Application = 73,

  /**
   * The object is a dialog or list containing items for insertion into an entry widget, for instance a list of words for completion of a text entry.   $(LPAREN)Since: 1.3$(RPAREN)
   */
  Autocomplete = 74,

  /**
   * The object is an editable text object in a toolbar.  $(LPAREN)Since: 1.5$(RPAREN)
   */
  EditBar = 75,

  /**
   * The object is an embedded container within a document or panel.  This role is a grouping "hint" indicating that the contained objects share a context.  $(LPAREN)Since: 1.7.2$(RPAREN)
   */
  Embedded = 76,

  /**
   * The object is a component whose textual content may be entered or modified by the user, provided @ATK_STATE_EDITABLE is present.   $(LPAREN)Since: 1.11$(RPAREN)
   */
  Entry = 77,

  /**
   * The object is a graphical depiction of quantitative data. It may contain multiple subelements whose attributes and/or description may be queried to obtain both the quantitative data and information about how the data is being presented. The LABELLED_BY relation is particularly important in interpreting objects of this type, as is the accessible-description property.  $(LPAREN)Since: 1.11$(RPAREN)
   */
  Chart = 78,

  /**
   * The object contains descriptive information, usually textual, about another user interface element such as a table, chart, or image.  $(LPAREN)Since: 1.11$(RPAREN)
   */
  Caption = 79,

  /**
   * The object is a visual frame or container which contains a view of document content. Document frames may occur within another Document instance, in which case the second document may be said to be embedded in the containing instance. HTML frames are often ROLE_DOCUMENT_FRAME. Either this object, or a singleton descendant, should implement the Document interface.  $(LPAREN)Since: 1.11$(RPAREN)
   */
  DocumentFrame = 80,
  ...
  /**
   * The object is a containing instance which encapsulates a page of information. @ATK_ROLE_PAGE is used in documents and content which support a paginated navigation model.  $(LPAREN)Since: 1.11$(RPAREN)
   */
  Page = 82,

  /**
   * The object is a containing instance of document content which constitutes a particular 'logical' section of the document. The type of content within a section, and the nature of the section division itself, may be obtained by querying the object's attributes. Sections may be nested. $(LPAREN)Since: 1.11$(RPAREN)
   */
  Section = 83,

  /**
   * The object is redundant with another object in the hierarchy, and is exposed for purely technical reasons.  Objects of this role should normally be ignored by clients. $(LPAREN)Since: 1.11$(RPAREN)
   */
  RedundantObject = 84,
   ...
   * always have ATK_ROLE_FORM. $(LPAREN)Since: 1.12.0$(RPAREN)
   */
  Form = 85,
   ...
   * an inline or embedded object lies.  $(LPAREN)Since: 1.12.1$(RPAREN)
   */
  Link = 86,
   ...
   * in other words it is an "input method window." $(LPAREN)Since: 1.12.1$(RPAREN)
   */
  InputMethodWindow = 87,

  /**
   * A row in a table.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  TableRow = 88,

  /**
   * An object that represents an element of a tree.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  TreeItem = 89,

  /**
   * A document frame which contains a spreadsheet.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  DocumentSpreadsheet = 90,

  /**
   * A document frame which contains a presentation or slide content.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  DocumentPresentation = 91,

  /**
   * A document frame which contains textual content, such as found in a word processing application.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  DocumentText = 92,

  /**
   * A document frame which contains HTML or other markup suitable for display in a web browser.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  DocumentWeb = 93,

  /**
   * A document frame which contains email content to be displayed or composed either in plain text or HTML.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  DocumentEmail = 94,

  /**
   * An object found within a document and designed to present a comment, note, or other annotation. In some cases, this object might not be visible until activated.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  Comment = 95,

  /**
   * A non-collapsible list of choices the user can select from. $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  ListBox = 96,

  /**
   * A group of related widgets. This group typically has a label. $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  Grouping = 97,

  /**
   * An image map object. Usually a graphic with multiple hotspots, where each hotspot can be activated resulting in the loading of another document or section of a document. $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  ImageMap = 98,

  /**
   * A transitory object designed to present a message to the user, typically at the desktop level rather than inside a particular application.  $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  Notification = 99,

  /**
   * An object designed to present a message to the user within an existing window. $(LPAREN)Since: 2.1.0$(RPAREN)
   */
  InfoBar = 100,

  /**
   * A bar that serves as a level indicator to, for instance, show the strength of a password or the state of a battery.  $(LPAREN)Since: 2.7.3$(RPAREN)
   */
  LevelBar = 101,

  /**
   * A bar that serves as the title of a window or a
   * dialog. $(LPAREN)Since: 2.12$(RPAREN)
   */
  TitleBar = 102,

  /**
   * An object which contains a text section
   * that is quoted from another source. $(LPAREN)Since: 2.12$(RPAREN)
   */
  BlockQuote = 103,

  /**
   * An object which represents an audio element. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Audio = 104,

  /**
   * An object which represents a video element. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Video = 105,

  /**
   * A definition of a term or concept. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Definition = 106,
   ...
   * site. Examples: A blog entry, a news story, a forum post. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Article = 107,
   ...
   * document. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Landmark = 108,
   ...
   * points. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Log = 109,
   ...
   * important content changes. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Marquee = 110,

  /**
   * A text widget or container that holds a mathematical
   * expression. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Math = 111,
   ...
   * AtkValue. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Rating = 112,
   ...
   * remaining until an end point. $(LPAREN)Since: 2.12$(RPAREN)
   */
  Timer = 113,
   ...
   * $(LPAREN)ATK_ROLE_DESCRIPTION_TERM$(RPAREN) followed by one or more values
   * $(LPAREN)ATK_ROLE_DESCRIPTION_VALUE$(RPAREN). For each list, there should not be
   * more than one group with the same term name. $(LPAREN)Since: 2.12$(RPAREN)
   */
  DescriptionList = 114,

  /**
   * An object that represents a term or phrase
   * with a corresponding definition. $(LPAREN)Since: 2.12$(RPAREN)
   */
  DescriptionTerm = 115,

  /**
   * An object that represents the
   * description, definition or value of a term. $(LPAREN)Since: 2.12$(RPAREN)
   */
   ...
   * role is not known by the implementor, see %ATK_ROLE_UNKNOWN. $(LPAREN)Since: 2.16$(RPAREN)
   */
  Static = 117,

  /**
   * An object that represents a mathematical fraction.
   * $(LPAREN)Since: 2.16$(RPAREN)
   */
  MathFraction = 118,

  /**
   * An object that represents a mathematical expression
   * displayed with a radical. $(LPAREN)Since: 2.16$(RPAREN)
   */
  MathRoot = 119,

  /**
   * An object that contains text that is displayed as a
   * subscript. $(LPAREN)Since: 2.16$(RPAREN)
   */
  Subscript = 120,

  /**
   * An object that contains text that is displayed as a
   * superscript. $(LPAREN)Since: 2.16$(RPAREN)
   */
  Superscript = 121,

  /**
   * An object that contains the text of a footnote. $(LPAREN)Since: 2.26$(RPAREN)
   */
  Footnote = 122,
   ...
   * from reviewers. $(LPAREN)Since: 2.34$(RPAREN)
   */
  ContentDeletion = 123,
   ...
   * to point back to the mark. $(LPAREN)Since: 2.36$(RPAREN)
   */
  Mark = 125,
   ...
   * actual change is. $(LPAREN)Since: 2.36$(RPAREN)
   */
  Suggestion = 126,

  /**
   * A specialized push button to open a menu.
   * $(LPAREN)Since: 2.46$(RPAREN)
   */
  PushButtonMenu = 127,
...
enum AtkStateType
{
  ...
  /**
   * Indicates that this object no longer has a valid backing widget $(LPAREN)for instance, if its peer object has been destroyed$(RPAREN)
   */
  Defunct = 5,
  ...
  /**
   * Indicates this $(LPAREN)text$(RPAREN) object can contain multiple lines of text
   */
  MultiLine = 15,
  ...
  /**
   * Indicates this $(LPAREN)text$(RPAREN) object can contain only a single line of text
   */
  SingleLine = 24,
   ...
   * the index associated with this object has changed since the user accessed the object $(LPAREN)in lieu of
   * "index-in-parent-changed" events$(RPAREN).
   */
  Stale = 25,
   ...
   * is sent when children become 'active' $(LPAREN)i.e. are selected or navigated to onscreen$(RPAREN).
   ...
   * data set in which the total number of items in that set is unknown $(LPAREN)e.g. 1 of
   * 999+$(RPAREN), implementors should expose the currently-known set size $(LPAREN)999$(RPAREN) along
  ...
  /**
   * Indicates that the object $(LPAREN)typically a hyperlink$(RPAREN) has already been 'activated', and/or its backing data has already been downloaded, rendered, or otherwise "visited".
   */
  Visited = 38,
...
enum AtkTextAttribute
{
  ...
  /**
   * Pixels of blank space to leave between wrapped lines inside the same newline-terminated line $(LPAREN)paragraph$(RPAREN).
   */
  PixelsInsideWrap = 8,
...
enum AtkTextBoundary
{
   ...
   * $(LPAREN)including non-printing characters$(RPAREN)
   */
  Char = 0,

  /**
   * Boundary is the start $(LPAREN)i.e. first character$(RPAREN) of a word.
   */
  WordStart = 1,

  /**
   * Boundary is the end $(LPAREN)i.e. last
   * character$(RPAREN) of a word.
   */
  WordEnd = 2,
  ...
  /**
   * Boundary is the last $(LPAREN)terminal$(RPAREN)
 ...
 * selectable lists.
 * Note that other types of "selection" $(LPAREN)for instance text selection$(RPAREN)
 ...
 * which may implement other interfaces $(LPAREN)#AtkText, #AtkImage, etc.$(RPAREN) as
 * appropriate.  #AtkTable summaries may themselves be $(LPAREN)simplified$(RPAREN)
 * #AtkTables, etc.
...
struct AtkValueIface
{
   ...
   * text alternative $(LPAREN)if available$(RPAREN) of this object. Since 2.12.
   */
   ...
   * description $(LPAREN)if available$(RPAREN) of this object. Returns NULL if there
