...
{
  // Allocator
  gidLink(g_allocator_free, "g_allocator_free", LIBS);
  gidLink(g_allocator_new, "g_allocator_new", LIBS);

  // Array
  gidLink(g_array_get_type, "g_array_get_type", LIBS);
  gidLink(g_array_append_vals, "g_array_append_vals", LIBS);
  gidLink(g_array_binary_search, "g_array_binary_search", LIBS);
  gidLink(g_array_copy, "g_array_copy", LIBS);
  gidLink(g_array_free, "g_array_free", LIBS);
  gidLink(g_array_get_element_size, "g_array_get_element_size", LIBS);
  gidLink(g_array_insert_vals, "g_array_insert_vals", LIBS);
  gidLink(g_array_new, "g_array_new", LIBS);
  gidLink(g_array_new_take, "g_array_new_take", LIBS);
  gidLink(g_array_new_take_zero_terminated, "g_array_new_take_zero_terminated", LIBS);
  gidLink(g_array_prepend_vals, "g_array_prepend_vals", LIBS);
  gidLink(g_array_ref, "g_array_ref", LIBS);
  gidLink(g_array_remove_index, "g_array_remove_index", LIBS);
  gidLink(g_array_remove_index_fast, "g_array_remove_index_fast", LIBS);
  gidLink(g_array_remove_range, "g_array_remove_range", LIBS);
  gidLink(g_array_set_clear_func, "g_array_set_clear_func", LIBS);
  gidLink(g_array_set_size, "g_array_set_size", LIBS);
  gidLink(g_array_sized_new, "g_array_sized_new", LIBS);
  gidLink(g_array_sort, "g_array_sort", LIBS);
  gidLink(g_array_sort_with_data, "g_array_sort_with_data", LIBS);
  gidLink(g_array_steal, "g_array_steal", LIBS);
  gidLink(g_array_unref, "g_array_unref", LIBS);

  // AsyncQueue
  gidLink(g_async_queue_length, "g_async_queue_length", LIBS);
  gidLink(g_async_queue_length_unlocked, "g_async_queue_length_unlocked", LIBS);
  gidLink(g_async_queue_lock, "g_async_queue_lock", LIBS);
  gidLink(g_async_queue_pop, "g_async_queue_pop", LIBS);
  gidLink(g_async_queue_pop_unlocked, "g_async_queue_pop_unlocked", LIBS);
  gidLink(g_async_queue_push, "g_async_queue_push", LIBS);
  gidLink(g_async_queue_push_front, "g_async_queue_push_front", LIBS);
  gidLink(g_async_queue_push_front_unlocked, "g_async_queue_push_front_unlocked", LIBS);
  gidLink(g_async_queue_push_sorted, "g_async_queue_push_sorted", LIBS);
  gidLink(g_async_queue_push_sorted_unlocked, "g_async_queue_push_sorted_unlocked", LIBS);
  gidLink(g_async_queue_push_unlocked, "g_async_queue_push_unlocked", LIBS);
  gidLink(g_async_queue_ref, "g_async_queue_ref", LIBS);
  gidLink(g_async_queue_ref_unlocked, "g_async_queue_ref_unlocked", LIBS);
  gidLink(g_async_queue_remove, "g_async_queue_remove", LIBS);
  gidLink(g_async_queue_remove_unlocked, "g_async_queue_remove_unlocked", LIBS);
  gidLink(g_async_queue_sort, "g_async_queue_sort", LIBS);
  gidLink(g_async_queue_sort_unlocked, "g_async_queue_sort_unlocked", LIBS);
  gidLink(g_async_queue_timed_pop, "g_async_queue_timed_pop", LIBS);
  gidLink(g_async_queue_timed_pop_unlocked, "g_async_queue_timed_pop_unlocked", LIBS);
  gidLink(g_async_queue_timeout_pop, "g_async_queue_timeout_pop", LIBS);
  gidLink(g_async_queue_timeout_pop_unlocked, "g_async_queue_timeout_pop_unlocked", LIBS);
  gidLink(g_async_queue_try_pop, "g_async_queue_try_pop", LIBS);
  gidLink(g_async_queue_try_pop_unlocked, "g_async_queue_try_pop_unlocked", LIBS);
  gidLink(g_async_queue_unlock, "g_async_queue_unlock", LIBS);
  gidLink(g_async_queue_unref, "g_async_queue_unref", LIBS);
  gidLink(g_async_queue_unref_and_unlock, "g_async_queue_unref_and_unlock", LIBS);
  gidLink(g_async_queue_new, "g_async_queue_new", LIBS);
  gidLink(g_async_queue_new_full, "g_async_queue_new_full", LIBS);

  // BookmarkFile
  gidLink(g_bookmark_file_get_type, "g_bookmark_file_get_type", LIBS);
  gidLink(g_bookmark_file_new, "g_bookmark_file_new", LIBS);
  gidLink(g_bookmark_file_add_application, "g_bookmark_file_add_application", LIBS);
  gidLink(g_bookmark_file_add_group, "g_bookmark_file_add_group", LIBS);
  gidLink(g_bookmark_file_copy, "g_bookmark_file_copy", LIBS);
  gidLink(g_bookmark_file_free, "g_bookmark_file_free", LIBS);
  gidLink(g_bookmark_file_get_added, "g_bookmark_file_get_added", LIBS);
  gidLink(g_bookmark_file_get_added_date_time, "g_bookmark_file_get_added_date_time", LIBS);
  gidLink(g_bookmark_file_get_app_info, "g_bookmark_file_get_app_info", LIBS);
  gidLink(g_bookmark_file_get_application_info, "g_bookmark_file_get_application_info", LIBS);
  gidLink(g_bookmark_file_get_applications, "g_bookmark_file_get_applications", LIBS);
  gidLink(g_bookmark_file_get_description, "g_bookmark_file_get_description", LIBS);
  gidLink(g_bookmark_file_get_groups, "g_bookmark_file_get_groups", LIBS);
  gidLink(g_bookmark_file_get_icon, "g_bookmark_file_get_icon", LIBS);
  gidLink(g_bookmark_file_get_is_private, "g_bookmark_file_get_is_private", LIBS);
  gidLink(g_bookmark_file_get_mime_type, "g_bookmark_file_get_mime_type", LIBS);
  gidLink(g_bookmark_file_get_modified, "g_bookmark_file_get_modified", LIBS);
  gidLink(g_bookmark_file_get_modified_date_time, "g_bookmark_file_get_modified_date_time", LIBS);
  gidLink(g_bookmark_file_get_size, "g_bookmark_file_get_size", LIBS);
  gidLink(g_bookmark_file_get_title, "g_bookmark_file_get_title", LIBS);
  gidLink(g_bookmark_file_get_uris, "g_bookmark_file_get_uris", LIBS);
  gidLink(g_bookmark_file_get_visited, "g_bookmark_file_get_visited", LIBS);
  gidLink(g_bookmark_file_get_visited_date_time, "g_bookmark_file_get_visited_date_time", LIBS);
  gidLink(g_bookmark_file_has_application, "g_bookmark_file_has_application", LIBS);
  gidLink(g_bookmark_file_has_group, "g_bookmark_file_has_group", LIBS);
  gidLink(g_bookmark_file_has_item, "g_bookmark_file_has_item", LIBS);
  gidLink(g_bookmark_file_load_from_data, "g_bookmark_file_load_from_data", LIBS);
  gidLink(g_bookmark_file_load_from_data_dirs, "g_bookmark_file_load_from_data_dirs", LIBS);
  gidLink(g_bookmark_file_load_from_file, "g_bookmark_file_load_from_file", LIBS);
  gidLink(g_bookmark_file_move_item, "g_bookmark_file_move_item", LIBS);
  gidLink(g_bookmark_file_remove_application, "g_bookmark_file_remove_application", LIBS);
  gidLink(g_bookmark_file_remove_group, "g_bookmark_file_remove_group", LIBS);
  gidLink(g_bookmark_file_remove_item, "g_bookmark_file_remove_item", LIBS);
  gidLink(g_bookmark_file_set_added, "g_bookmark_file_set_added", LIBS);
  gidLink(g_bookmark_file_set_added_date_time, "g_bookmark_file_set_added_date_time", LIBS);
  gidLink(g_bookmark_file_set_app_info, "g_bookmark_file_set_app_info", LIBS);
  gidLink(g_bookmark_file_set_application_info, "g_bookmark_file_set_application_info", LIBS);
  gidLink(g_bookmark_file_set_description, "g_bookmark_file_set_description", LIBS);
  gidLink(g_bookmark_file_set_groups, "g_bookmark_file_set_groups", LIBS);
  gidLink(g_bookmark_file_set_icon, "g_bookmark_file_set_icon", LIBS);
  gidLink(g_bookmark_file_set_is_private, "g_bookmark_file_set_is_private", LIBS);
  gidLink(g_bookmark_file_set_mime_type, "g_bookmark_file_set_mime_type", LIBS);
  gidLink(g_bookmark_file_set_modified, "g_bookmark_file_set_modified", LIBS);
  gidLink(g_bookmark_file_set_modified_date_time, "g_bookmark_file_set_modified_date_time", LIBS);
  gidLink(g_bookmark_file_set_title, "g_bookmark_file_set_title", LIBS);
  gidLink(g_bookmark_file_set_visited, "g_bookmark_file_set_visited", LIBS);
  gidLink(g_bookmark_file_set_visited_date_time, "g_bookmark_file_set_visited_date_time", LIBS);
  gidLink(g_bookmark_file_to_data, "g_bookmark_file_to_data", LIBS);
  gidLink(g_bookmark_file_to_file, "g_bookmark_file_to_file", LIBS);
  gidLink(g_bookmark_file_error_quark, "g_bookmark_file_error_quark", LIBS);

  // ByteArray
  gidLink(g_byte_array_get_type, "g_byte_array_get_type", LIBS);
  gidLink(g_byte_array_append, "g_byte_array_append", LIBS);
  gidLink(g_byte_array_free, "g_byte_array_free", LIBS);
  gidLink(g_byte_array_free_to_bytes, "g_byte_array_free_to_bytes", LIBS);
  gidLink(g_byte_array_new, "g_byte_array_new", LIBS);
  gidLink(g_byte_array_new_take, "g_byte_array_new_take", LIBS);
  gidLink(g_byte_array_prepend, "g_byte_array_prepend", LIBS);
  gidLink(g_byte_array_ref, "g_byte_array_ref", LIBS);
  gidLink(g_byte_array_remove_index, "g_byte_array_remove_index", LIBS);
  gidLink(g_byte_array_remove_index_fast, "g_byte_array_remove_index_fast", LIBS);
  gidLink(g_byte_array_remove_range, "g_byte_array_remove_range", LIBS);
  gidLink(g_byte_array_set_size, "g_byte_array_set_size", LIBS);
  gidLink(g_byte_array_sized_new, "g_byte_array_sized_new", LIBS);
  gidLink(g_byte_array_sort, "g_byte_array_sort", LIBS);
  gidLink(g_byte_array_sort_with_data, "g_byte_array_sort_with_data", LIBS);
  gidLink(g_byte_array_steal, "g_byte_array_steal", LIBS);
  gidLink(g_byte_array_unref, "g_byte_array_unref", LIBS);

  // Bytes
  gidLink(g_bytes_get_type, "g_bytes_get_type", LIBS);
  gidLink(g_bytes_new, "g_bytes_new", LIBS);
  gidLink(g_bytes_new_static, "g_bytes_new_static", LIBS);
  gidLink(g_bytes_new_take, "g_bytes_new_take", LIBS);
  gidLink(g_bytes_new_with_free_func, "g_bytes_new_with_free_func", LIBS);
  gidLink(g_bytes_compare, "g_bytes_compare", LIBS);
  gidLink(g_bytes_equal, "g_bytes_equal", LIBS);
  gidLink(g_bytes_get_data, "g_bytes_get_data", LIBS);
  gidLink(g_bytes_get_region, "g_bytes_get_region", LIBS);
  gidLink(g_bytes_get_size, "g_bytes_get_size", LIBS);
  gidLink(g_bytes_hash, "g_bytes_hash", LIBS);
  gidLink(g_bytes_new_from_bytes, "g_bytes_new_from_bytes", LIBS);
  gidLink(g_bytes_ref, "g_bytes_ref", LIBS);
  gidLink(g_bytes_unref, "g_bytes_unref", LIBS);
  gidLink(g_bytes_unref_to_array, "g_bytes_unref_to_array", LIBS);
  gidLink(g_bytes_unref_to_data, "g_bytes_unref_to_data", LIBS);

  // Cache
  gidLink(g_cache_destroy, "g_cache_destroy", LIBS);
  gidLink(g_cache_insert, "g_cache_insert", LIBS);
  gidLink(g_cache_key_foreach, "g_cache_key_foreach", LIBS);
  gidLink(g_cache_remove, "g_cache_remove", LIBS);
  gidLink(g_cache_value_foreach, "g_cache_value_foreach", LIBS);
  gidLink(g_cache_new, "g_cache_new", LIBS);

  // Checksum
  gidLink(g_checksum_get_type, "g_checksum_get_type", LIBS);
  gidLink(g_checksum_new, "g_checksum_new", LIBS);
  gidLink(g_checksum_copy, "g_checksum_copy", LIBS);
  gidLink(g_checksum_free, "g_checksum_free", LIBS);
  gidLink(g_checksum_get_digest, "g_checksum_get_digest", LIBS);
  gidLink(g_checksum_get_string, "g_checksum_get_string", LIBS);
  gidLink(g_checksum_reset, "g_checksum_reset", LIBS);
  gidLink(g_checksum_update, "g_checksum_update", LIBS);
  gidLink(g_checksum_type_get_length, "g_checksum_type_get_length", LIBS);

  // Completion
  gidLink(g_completion_add_items, "g_completion_add_items", LIBS);
  gidLink(g_completion_clear_items, "g_completion_clear_items", LIBS);
  gidLink(g_completion_complete, "g_completion_complete", LIBS);
  gidLink(g_completion_complete_utf8, "g_completion_complete_utf8", LIBS);
  gidLink(g_completion_free, "g_completion_free", LIBS);
  gidLink(g_completion_remove_items, "g_completion_remove_items", LIBS);
  gidLink(g_completion_set_compare, "g_completion_set_compare", LIBS);
  gidLink(g_completion_new, "g_completion_new", LIBS);

  // Cond
  gidLink(g_cond_broadcast, "g_cond_broadcast", LIBS);
  gidLink(g_cond_clear, "g_cond_clear", LIBS);
  gidLink(g_cond_free, "g_cond_free", LIBS);
  gidLink(g_cond_init, "g_cond_init", LIBS);
  gidLink(g_cond_signal, "g_cond_signal", LIBS);
  gidLink(g_cond_timed_wait, "g_cond_timed_wait", LIBS);
  gidLink(g_cond_wait, "g_cond_wait", LIBS);
  gidLink(g_cond_wait_until, "g_cond_wait_until", LIBS);
  gidLink(g_cond_new, "g_cond_new", LIBS);

  // Date
  gidLink(g_date_get_type, "g_date_get_type", LIBS);
  gidLink(g_date_new, "g_date_new", LIBS);
  gidLink(g_date_new_dmy, "g_date_new_dmy", LIBS);
  gidLink(g_date_new_julian, "g_date_new_julian", LIBS);
  gidLink(g_date_add_days, "g_date_add_days", LIBS);
  gidLink(g_date_add_months, "g_date_add_months", LIBS);
  gidLink(g_date_add_years, "g_date_add_years", LIBS);
  gidLink(g_date_clamp, "g_date_clamp", LIBS);
  gidLink(g_date_clear, "g_date_clear", LIBS);
  gidLink(g_date_compare, "g_date_compare", LIBS);
  gidLink(g_date_copy, "g_date_copy", LIBS);
  gidLink(g_date_days_between, "g_date_days_between", LIBS);
  gidLink(g_date_free, "g_date_free", LIBS);
  gidLink(g_date_get_day, "g_date_get_day", LIBS);
  gidLink(g_date_get_day_of_year, "g_date_get_day_of_year", LIBS);
  gidLink(g_date_get_iso8601_week_of_year, "g_date_get_iso8601_week_of_year", LIBS);
  gidLink(g_date_get_julian, "g_date_get_julian", LIBS);
  gidLink(g_date_get_monday_week_of_year, "g_date_get_monday_week_of_year", LIBS);
  gidLink(g_date_get_month, "g_date_get_month", LIBS);
  gidLink(g_date_get_sunday_week_of_year, "g_date_get_sunday_week_of_year", LIBS);
  gidLink(g_date_get_weekday, "g_date_get_weekday", LIBS);
  gidLink(g_date_get_year, "g_date_get_year", LIBS);
  gidLink(g_date_is_first_of_month, "g_date_is_first_of_month", LIBS);
  gidLink(g_date_is_last_of_month, "g_date_is_last_of_month", LIBS);
  gidLink(g_date_order, "g_date_order", LIBS);
  gidLink(g_date_set_day, "g_date_set_day", LIBS);
  gidLink(g_date_set_dmy, "g_date_set_dmy", LIBS);
  gidLink(g_date_set_julian, "g_date_set_julian", LIBS);
  gidLink(g_date_set_month, "g_date_set_month", LIBS);
  gidLink(g_date_set_parse, "g_date_set_parse", LIBS);
  gidLink(g_date_set_time, "g_date_set_time", LIBS);
  gidLink(g_date_set_time_t, "g_date_set_time_t", LIBS);
  gidLink(g_date_set_time_val, "g_date_set_time_val", LIBS);
  gidLink(g_date_set_year, "g_date_set_year", LIBS);
  gidLink(g_date_subtract_days, "g_date_subtract_days", LIBS);
  gidLink(g_date_subtract_months, "g_date_subtract_months", LIBS);
  gidLink(g_date_subtract_years, "g_date_subtract_years", LIBS);
  gidLink(g_date_to_struct_tm, "g_date_to_struct_tm", LIBS);
  gidLink(g_date_valid, "g_date_valid", LIBS);
  gidLink(g_date_get_days_in_month, "g_date_get_days_in_month", LIBS);
  gidLink(g_date_get_monday_weeks_in_year, "g_date_get_monday_weeks_in_year", LIBS);
  gidLink(g_date_get_sunday_weeks_in_year, "g_date_get_sunday_weeks_in_year", LIBS);
  gidLink(g_date_is_leap_year, "g_date_is_leap_year", LIBS);
  gidLink(g_date_strftime, "g_date_strftime", LIBS);
  gidLink(g_date_valid_day, "g_date_valid_day", LIBS);
  gidLink(g_date_valid_dmy, "g_date_valid_dmy", LIBS);
  gidLink(g_date_valid_julian, "g_date_valid_julian", LIBS);
  gidLink(g_date_valid_month, "g_date_valid_month", LIBS);
  gidLink(g_date_valid_weekday, "g_date_valid_weekday", LIBS);
  gidLink(g_date_valid_year, "g_date_valid_year", LIBS);

  // DateTime
  gidLink(g_date_time_get_type, "g_date_time_get_type", LIBS);
  gidLink(g_date_time_new, "g_date_time_new", LIBS);
  gidLink(g_date_time_new_from_iso8601, "g_date_time_new_from_iso8601", LIBS);
  gidLink(g_date_time_new_from_timeval_local, "g_date_time_new_from_timeval_local", LIBS);
  gidLink(g_date_time_new_from_timeval_utc, "g_date_time_new_from_timeval_utc", LIBS);
  gidLink(g_date_time_new_from_unix_local, "g_date_time_new_from_unix_local", LIBS);
  gidLink(g_date_time_new_from_unix_local_usec, "g_date_time_new_from_unix_local_usec", LIBS);
  gidLink(g_date_time_new_from_unix_utc, "g_date_time_new_from_unix_utc", LIBS);
  gidLink(g_date_time_new_from_unix_utc_usec, "g_date_time_new_from_unix_utc_usec", LIBS);
  gidLink(g_date_time_new_local, "g_date_time_new_local", LIBS);
  gidLink(g_date_time_new_now, "g_date_time_new_now", LIBS);
  gidLink(g_date_time_new_now_local, "g_date_time_new_now_local", LIBS);
  gidLink(g_date_time_new_now_utc, "g_date_time_new_now_utc", LIBS);
  gidLink(g_date_time_new_utc, "g_date_time_new_utc", LIBS);
  gidLink(g_date_time_add, "g_date_time_add", LIBS);
  gidLink(g_date_time_add_days, "g_date_time_add_days", LIBS);
  gidLink(g_date_time_add_full, "g_date_time_add_full", LIBS);
  gidLink(g_date_time_add_hours, "g_date_time_add_hours", LIBS);
  gidLink(g_date_time_add_minutes, "g_date_time_add_minutes", LIBS);
  gidLink(g_date_time_add_months, "g_date_time_add_months", LIBS);
  gidLink(g_date_time_add_seconds, "g_date_time_add_seconds", LIBS);
  gidLink(g_date_time_add_weeks, "g_date_time_add_weeks", LIBS);
  gidLink(g_date_time_add_years, "g_date_time_add_years", LIBS);
  gidLink(g_date_time_compare, "g_date_time_compare", LIBS);
  gidLink(g_date_time_difference, "g_date_time_difference", LIBS);
  gidLink(g_date_time_equal, "g_date_time_equal", LIBS);
  gidLink(g_date_time_format, "g_date_time_format", LIBS);
  gidLink(g_date_time_format_iso8601, "g_date_time_format_iso8601", LIBS);
  gidLink(g_date_time_get_day_of_month, "g_date_time_get_day_of_month", LIBS);
  gidLink(g_date_time_get_day_of_week, "g_date_time_get_day_of_week", LIBS);
  gidLink(g_date_time_get_day_of_year, "g_date_time_get_day_of_year", LIBS);
  gidLink(g_date_time_get_hour, "g_date_time_get_hour", LIBS);
  gidLink(g_date_time_get_microsecond, "g_date_time_get_microsecond", LIBS);
  gidLink(g_date_time_get_minute, "g_date_time_get_minute", LIBS);
  gidLink(g_date_time_get_month, "g_date_time_get_month", LIBS);
  gidLink(g_date_time_get_second, "g_date_time_get_second", LIBS);
  gidLink(g_date_time_get_seconds, "g_date_time_get_seconds", LIBS);
  gidLink(g_date_time_get_timezone, "g_date_time_get_timezone", LIBS);
  gidLink(g_date_time_get_timezone_abbreviation, "g_date_time_get_timezone_abbreviation", LIBS);
  gidLink(g_date_time_get_utc_offset, "g_date_time_get_utc_offset", LIBS);
  gidLink(g_date_time_get_week_numbering_year, "g_date_time_get_week_numbering_year", LIBS);
  gidLink(g_date_time_get_week_of_year, "g_date_time_get_week_of_year", LIBS);
  gidLink(g_date_time_get_year, "g_date_time_get_year", LIBS);
  gidLink(g_date_time_get_ymd, "g_date_time_get_ymd", LIBS);
  gidLink(g_date_time_hash, "g_date_time_hash", LIBS);
  gidLink(g_date_time_is_daylight_savings, "g_date_time_is_daylight_savings", LIBS);
  gidLink(g_date_time_ref, "g_date_time_ref", LIBS);
  gidLink(g_date_time_to_local, "g_date_time_to_local", LIBS);
  gidLink(g_date_time_to_timeval, "g_date_time_to_timeval", LIBS);
  gidLink(g_date_time_to_timezone, "g_date_time_to_timezone", LIBS);
  gidLink(g_date_time_to_unix, "g_date_time_to_unix", LIBS);
  gidLink(g_date_time_to_unix_usec, "g_date_time_to_unix_usec", LIBS);
  gidLink(g_date_time_to_utc, "g_date_time_to_utc", LIBS);
  gidLink(g_date_time_unref, "g_date_time_unref", LIBS);

  // Dir
  gidLink(g_dir_get_type, "g_dir_get_type", LIBS);
  gidLink(g_dir_open, "g_dir_open", LIBS);
  gidLink(g_dir_close, "g_dir_close", LIBS);
  gidLink(g_dir_read_name, "g_dir_read_name", LIBS);
  gidLink(g_dir_ref, "g_dir_ref", LIBS);
  gidLink(g_dir_rewind, "g_dir_rewind", LIBS);
  gidLink(g_dir_unref, "g_dir_unref", LIBS);
  gidLink(g_dir_make_tmp, "g_dir_make_tmp", LIBS);

  // ErrorG
  gidLink(g_error_get_type, "g_error_get_type", LIBS);
  gidLink(g_error_new, "g_error_new", LIBS);
  gidLink(g_error_new_literal, "g_error_new_literal", LIBS);
  gidLink(g_error_new_valist, "g_error_new_valist", LIBS);
  gidLink(g_error_copy, "g_error_copy", LIBS);
  gidLink(g_error_free, "g_error_free", LIBS);
  gidLink(g_error_matches, "g_error_matches", LIBS);
  gidLink(g_error_domain_register, "g_error_domain_register", LIBS);
  gidLink(g_error_domain_register_static, "g_error_domain_register_static", LIBS);

  // Global
  gidLink(g_access, "g_access", LIBS);
  gidLink(g_aligned_alloc, "g_aligned_alloc", LIBS);
  gidLink(g_aligned_alloc0, "g_aligned_alloc0", LIBS);
  gidLink(g_aligned_free, "g_aligned_free", LIBS);
  gidLink(g_aligned_free_sized, "g_aligned_free_sized", LIBS);
  gidLink(g_ascii_digit_value, "g_ascii_digit_value", LIBS);
  gidLink(g_ascii_dtostr, "g_ascii_dtostr", LIBS);
  gidLink(g_ascii_formatd, "g_ascii_formatd", LIBS);
  gidLink(g_ascii_strcasecmp, "g_ascii_strcasecmp", LIBS);
  gidLink(g_ascii_strdown, "g_ascii_strdown", LIBS);
  gidLink(g_ascii_string_to_signed, "g_ascii_string_to_signed", LIBS);
  gidLink(g_ascii_string_to_unsigned, "g_ascii_string_to_unsigned", LIBS);
  gidLink(g_ascii_strncasecmp, "g_ascii_strncasecmp", LIBS);
  gidLink(g_ascii_strtod, "g_ascii_strtod", LIBS);
  gidLink(g_ascii_strtoll, "g_ascii_strtoll", LIBS);
  gidLink(g_ascii_strtoull, "g_ascii_strtoull", LIBS);
  gidLink(g_ascii_strup, "g_ascii_strup", LIBS);
  gidLink(g_ascii_tolower, "g_ascii_tolower", LIBS);
  gidLink(g_ascii_toupper, "g_ascii_toupper", LIBS);
  gidLink(g_ascii_xdigit_value, "g_ascii_xdigit_value", LIBS);
  gidLink(g_assert_warning, "g_assert_warning", LIBS);
  gidLink(g_assertion_message, "g_assertion_message", LIBS);
  gidLink(g_assertion_message_cmpint, "g_assertion_message_cmpint", LIBS);
  gidLink(g_assertion_message_cmpnum, "g_assertion_message_cmpnum", LIBS);
  gidLink(g_assertion_message_cmpstr, "g_assertion_message_cmpstr", LIBS);
  gidLink(g_assertion_message_cmpstrv, "g_assertion_message_cmpstrv", LIBS);
  gidLink(g_assertion_message_error, "g_assertion_message_error", LIBS);
  gidLink(g_assertion_message_expr, "g_assertion_message_expr", LIBS);
  gidLink(g_atexit, "g_atexit", LIBS);
  gidLink(g_atomic_int_add, "g_atomic_int_add", LIBS);
  gidLink(g_atomic_int_and, "g_atomic_int_and", LIBS);
  gidLink(g_atomic_int_compare_and_exchange, "g_atomic_int_compare_and_exchange", LIBS);
  gidLink(g_atomic_int_compare_and_exchange_full, "g_atomic_int_compare_and_exchange_full", LIBS);
  gidLink(g_atomic_int_dec_and_test, "g_atomic_int_dec_and_test", LIBS);
  gidLink(g_atomic_int_exchange, "g_atomic_int_exchange", LIBS);
  gidLink(g_atomic_int_exchange_and_add, "g_atomic_int_exchange_and_add", LIBS);
  gidLink(g_atomic_int_get, "g_atomic_int_get", LIBS);
  gidLink(g_atomic_int_inc, "g_atomic_int_inc", LIBS);
  gidLink(g_atomic_int_or, "g_atomic_int_or", LIBS);
  gidLink(g_atomic_int_set, "g_atomic_int_set", LIBS);
  gidLink(g_atomic_int_xor, "g_atomic_int_xor", LIBS);
  gidLink(g_atomic_pointer_add, "g_atomic_pointer_add", LIBS);
  gidLink(g_atomic_pointer_and, "g_atomic_pointer_and", LIBS);
  gidLink(g_atomic_pointer_compare_and_exchange, "g_atomic_pointer_compare_and_exchange", LIBS);
  gidLink(g_atomic_pointer_compare_and_exchange_full, "g_atomic_pointer_compare_and_exchange_full", LIBS);
  gidLink(g_atomic_pointer_exchange, "g_atomic_pointer_exchange", LIBS);
  gidLink(g_atomic_pointer_get, "g_atomic_pointer_get", LIBS);
  gidLink(g_atomic_pointer_or, "g_atomic_pointer_or", LIBS);
  gidLink(g_atomic_pointer_set, "g_atomic_pointer_set", LIBS);
  gidLink(g_atomic_pointer_xor, "g_atomic_pointer_xor", LIBS);
  gidLink(g_atomic_rc_box_acquire, "g_atomic_rc_box_acquire", LIBS);
  gidLink(g_atomic_rc_box_alloc, "g_atomic_rc_box_alloc", LIBS);
  gidLink(g_atomic_rc_box_alloc0, "g_atomic_rc_box_alloc0", LIBS);
  gidLink(g_atomic_rc_box_dup, "g_atomic_rc_box_dup", LIBS);
  gidLink(g_atomic_rc_box_get_size, "g_atomic_rc_box_get_size", LIBS);
  gidLink(g_atomic_rc_box_release, "g_atomic_rc_box_release", LIBS);
  gidLink(g_atomic_rc_box_release_full, "g_atomic_rc_box_release_full", LIBS);
  gidLink(g_atomic_ref_count_compare, "g_atomic_ref_count_compare", LIBS);
  gidLink(g_atomic_ref_count_dec, "g_atomic_ref_count_dec", LIBS);
  gidLink(g_atomic_ref_count_inc, "g_atomic_ref_count_inc", LIBS);
  gidLink(g_atomic_ref_count_init, "g_atomic_ref_count_init", LIBS);
  gidLink(g_base64_decode, "g_base64_decode", LIBS);
  gidLink(g_base64_decode_inplace, "g_base64_decode_inplace", LIBS);
  gidLink(g_base64_decode_step, "g_base64_decode_step", LIBS);
  gidLink(g_base64_encode, "g_base64_encode", LIBS);
  gidLink(g_base64_encode_close, "g_base64_encode_close", LIBS);
  gidLink(g_base64_encode_step, "g_base64_encode_step", LIBS);
  gidLink(g_basename, "g_basename", LIBS);
  gidLink(g_bit_lock, "g_bit_lock", LIBS);
  gidLink(g_bit_nth_lsf, "g_bit_nth_lsf", LIBS);
  gidLink(g_bit_nth_msf, "g_bit_nth_msf", LIBS);
  gidLink(g_bit_storage, "g_bit_storage", LIBS);
  gidLink(g_bit_trylock, "g_bit_trylock", LIBS);
  gidLink(g_bit_unlock, "g_bit_unlock", LIBS);
  gidLink(g_blow_chunks, "g_blow_chunks", LIBS);
  gidLink(g_build_filename, "g_build_filename", LIBS);
  gidLink(g_build_filename_valist, "g_build_filename_valist", LIBS);
  gidLink(g_build_filenamev, "g_build_filenamev", LIBS);
  gidLink(g_build_path, "g_build_path", LIBS);
  gidLink(g_build_pathv, "g_build_pathv", LIBS);
  gidLink(g_canonicalize_filename, "g_canonicalize_filename", LIBS);
  gidLink(g_chdir, "g_chdir", LIBS);
  gidLink(glib_check_version, "glib_check_version", LIBS);
  gidLink(g_child_watch_add, "g_child_watch_add", LIBS);
  gidLink(g_child_watch_add_full, "g_child_watch_add_full", LIBS);
  gidLink(g_child_watch_source_new, "g_child_watch_source_new", LIBS);
  gidLink(g_chmod, "g_chmod", LIBS);
  gidLink(g_clear_error, "g_clear_error", LIBS);
  gidLink(g_clear_handle_id, "g_clear_handle_id", LIBS);
  gidLink(g_clear_list, "g_clear_list", LIBS);
  gidLink(g_clear_pointer, "g_clear_pointer", LIBS);
  gidLink(g_clear_slist, "g_clear_slist", LIBS);
  gidLink(g_close, "g_close", LIBS);
  gidLink(g_closefrom, "g_closefrom", LIBS);
  gidLink(g_compute_checksum_for_bytes, "g_compute_checksum_for_bytes", LIBS);
  gidLink(g_compute_checksum_for_data, "g_compute_checksum_for_data", LIBS);
  gidLink(g_compute_checksum_for_string, "g_compute_checksum_for_string", LIBS);
  gidLink(g_compute_hmac_for_bytes, "g_compute_hmac_for_bytes", LIBS);
  gidLink(g_compute_hmac_for_data, "g_compute_hmac_for_data", LIBS);
  gidLink(g_compute_hmac_for_string, "g_compute_hmac_for_string", LIBS);
  gidLink(g_convert, "g_convert", LIBS);
  gidLink(g_convert_error_quark, "g_convert_error_quark", LIBS);
  gidLink(g_convert_with_fallback, "g_convert_with_fallback", LIBS);
  gidLink(g_convert_with_iconv, "g_convert_with_iconv", LIBS);
  gidLink(g_creat, "g_creat", LIBS);
  gidLink(g_datalist_clear, "g_datalist_clear", LIBS);
  gidLink(g_datalist_foreach, "g_datalist_foreach", LIBS);
  gidLink(g_datalist_get_data, "g_datalist_get_data", LIBS);
  gidLink(g_datalist_get_flags, "g_datalist_get_flags", LIBS);
  gidLink(g_datalist_id_dup_data, "g_datalist_id_dup_data", LIBS);
  gidLink(g_datalist_id_get_data, "g_datalist_id_get_data", LIBS);
  gidLink(g_datalist_id_remove_multiple, "g_datalist_id_remove_multiple", LIBS);
  gidLink(g_datalist_id_remove_no_notify, "g_datalist_id_remove_no_notify", LIBS);
  gidLink(g_datalist_id_replace_data, "g_datalist_id_replace_data", LIBS);
  gidLink(g_datalist_id_set_data_full, "g_datalist_id_set_data_full", LIBS);
  gidLink(g_datalist_init, "g_datalist_init", LIBS);
  gidLink(g_datalist_set_flags, "g_datalist_set_flags", LIBS);
  gidLink(g_datalist_unset_flags, "g_datalist_unset_flags", LIBS);
  gidLink(g_dataset_destroy, "g_dataset_destroy", LIBS);
  gidLink(g_dataset_foreach, "g_dataset_foreach", LIBS);
  gidLink(g_dataset_id_get_data, "g_dataset_id_get_data", LIBS);
  gidLink(g_dataset_id_remove_no_notify, "g_dataset_id_remove_no_notify", LIBS);
  gidLink(g_dataset_id_set_data_full, "g_dataset_id_set_data_full", LIBS);
  gidLink(g_dcgettext, "g_dcgettext", LIBS);
  gidLink(g_dgettext, "g_dgettext", LIBS);
  gidLink(g_direct_equal, "g_direct_equal", LIBS);
  gidLink(g_direct_hash, "g_direct_hash", LIBS);
  gidLink(g_dngettext, "g_dngettext", LIBS);
  gidLink(g_double_equal, "g_double_equal", LIBS);
  gidLink(g_double_hash, "g_double_hash", LIBS);
  gidLink(g_dpgettext, "g_dpgettext", LIBS);
  gidLink(g_dpgettext2, "g_dpgettext2", LIBS);
  gidLink(g_environ_getenv, "g_environ_getenv", LIBS);
  gidLink(g_environ_setenv, "g_environ_setenv", LIBS);
  gidLink(g_environ_unsetenv, "g_environ_unsetenv", LIBS);
  gidLink(g_fdwalk_set_cloexec, "g_fdwalk_set_cloexec", LIBS);
  gidLink(g_file_error_from_errno, "g_file_error_from_errno", LIBS);
  gidLink(g_file_error_quark, "g_file_error_quark", LIBS);
  gidLink(g_file_get_contents, "g_file_get_contents", LIBS);
  gidLink(g_file_open_tmp, "g_file_open_tmp", LIBS);
  gidLink(g_file_read_link, "g_file_read_link", LIBS);
  gidLink(g_file_set_contents, "g_file_set_contents", LIBS);
  gidLink(g_file_set_contents_full, "g_file_set_contents_full", LIBS);
  gidLink(g_file_test, "g_file_test", LIBS);
  gidLink(g_filename_display_basename, "g_filename_display_basename", LIBS);
  gidLink(g_filename_display_name, "g_filename_display_name", LIBS);
  gidLink(g_filename_from_uri, "g_filename_from_uri", LIBS);
  gidLink(g_filename_from_utf8, "g_filename_from_utf8", LIBS);
  gidLink(g_filename_to_uri, "g_filename_to_uri", LIBS);
  gidLink(g_filename_to_utf8, "g_filename_to_utf8", LIBS);
  gidLink(g_find_program_in_path, "g_find_program_in_path", LIBS);
  gidLink(g_fopen, "g_fopen", LIBS);
  gidLink(g_format_size, "g_format_size", LIBS);
  gidLink(g_format_size_for_display, "g_format_size_for_display", LIBS);
  gidLink(g_format_size_full, "g_format_size_full", LIBS);
  gidLink(g_fprintf, "g_fprintf", LIBS);
  gidLink(g_free, "g_free", LIBS);
  gidLink(g_free_sized, "g_free_sized", LIBS);
  gidLink(g_freopen, "g_freopen", LIBS);
  gidLink(g_fsync, "g_fsync", LIBS);
  gidLink(g_get_application_name, "g_get_application_name", LIBS);
  gidLink(g_get_charset, "g_get_charset", LIBS);
  gidLink(g_get_codeset, "g_get_codeset", LIBS);
  gidLink(g_get_console_charset, "g_get_console_charset", LIBS);
  gidLink(g_get_current_dir, "g_get_current_dir", LIBS);
  gidLink(g_get_current_time, "g_get_current_time", LIBS);
  gidLink(g_get_environ, "g_get_environ", LIBS);
  gidLink(g_get_filename_charsets, "g_get_filename_charsets", LIBS);
  gidLink(g_get_home_dir, "g_get_home_dir", LIBS);
  gidLink(g_get_host_name, "g_get_host_name", LIBS);
  gidLink(g_get_language_names, "g_get_language_names", LIBS);
  gidLink(g_get_language_names_with_category, "g_get_language_names_with_category", LIBS);
  gidLink(g_get_locale_variants, "g_get_locale_variants", LIBS);
  gidLink(g_get_monotonic_time, "g_get_monotonic_time", LIBS);
  gidLink(g_get_num_processors, "g_get_num_processors", LIBS);
  gidLink(g_get_os_info, "g_get_os_info", LIBS);
  gidLink(g_get_prgname, "g_get_prgname", LIBS);
  gidLink(g_get_real_name, "g_get_real_name", LIBS);
  gidLink(g_get_real_time, "g_get_real_time", LIBS);
  gidLink(g_get_system_config_dirs, "g_get_system_config_dirs", LIBS);
  gidLink(g_get_system_data_dirs, "g_get_system_data_dirs", LIBS);
  gidLink(g_get_tmp_dir, "g_get_tmp_dir", LIBS);
  gidLink(g_get_user_cache_dir, "g_get_user_cache_dir", LIBS);
  gidLink(g_get_user_config_dir, "g_get_user_config_dir", LIBS);
  gidLink(g_get_user_data_dir, "g_get_user_data_dir", LIBS);
  gidLink(g_get_user_name, "g_get_user_name", LIBS);
  gidLink(g_get_user_runtime_dir, "g_get_user_runtime_dir", LIBS);
  gidLink(g_get_user_special_dir, "g_get_user_special_dir", LIBS);
  gidLink(g_get_user_state_dir, "g_get_user_state_dir", LIBS);
  gidLink(g_getenv, "g_getenv", LIBS);
  gidLink(g_hostname_is_ascii_encoded, "g_hostname_is_ascii_encoded", LIBS);
  gidLink(g_hostname_is_ip_address, "g_hostname_is_ip_address", LIBS);
  gidLink(g_hostname_is_non_ascii, "g_hostname_is_non_ascii", LIBS);
  gidLink(g_hostname_to_ascii, "g_hostname_to_ascii", LIBS);
  gidLink(g_hostname_to_unicode, "g_hostname_to_unicode", LIBS);
  gidLink(g_iconv, "g_iconv", LIBS);
  gidLink(g_idle_add, "g_idle_add", LIBS);
  gidLink(g_idle_add_full, "g_idle_add_full", LIBS);
  gidLink(g_idle_add_once, "g_idle_add_once", LIBS);
  gidLink(g_idle_remove_by_data, "g_idle_remove_by_data", LIBS);
  gidLink(g_idle_source_new, "g_idle_source_new", LIBS);
  gidLink(g_int64_equal, "g_int64_equal", LIBS);
  gidLink(g_int64_hash, "g_int64_hash", LIBS);
  gidLink(g_int_equal, "g_int_equal", LIBS);
  gidLink(g_int_hash, "g_int_hash", LIBS);
  gidLink(g_intern_static_string, "g_intern_static_string", LIBS);
  gidLink(g_intern_string, "g_intern_string", LIBS);
  gidLink(g_io_add_watch, "g_io_add_watch", LIBS);
  gidLink(g_io_add_watch_full, "g_io_add_watch_full", LIBS);
  gidLink(g_io_create_watch, "g_io_create_watch", LIBS);
  gidLink(g_listenv, "g_listenv", LIBS);
  gidLink(g_locale_from_utf8, "g_locale_from_utf8", LIBS);
  gidLink(g_locale_to_utf8, "g_locale_to_utf8", LIBS);
  gidLink(g_log, "g_log", LIBS);
  gidLink(g_log_default_handler, "g_log_default_handler", LIBS);
  gidLink(g_log_get_debug_enabled, "g_log_get_debug_enabled", LIBS);
  gidLink(g_log_remove_handler, "g_log_remove_handler", LIBS);
  gidLink(g_log_set_always_fatal, "g_log_set_always_fatal", LIBS);
  gidLink(g_log_set_debug_enabled, "g_log_set_debug_enabled", LIBS);
  gidLink(g_log_set_default_handler, "g_log_set_default_handler", LIBS);
  gidLink(g_log_set_fatal_mask, "g_log_set_fatal_mask", LIBS);
  gidLink(g_log_set_handler, "g_log_set_handler", LIBS);
  gidLink(g_log_set_handler_full, "g_log_set_handler_full", LIBS);
  gidLink(g_log_set_writer_func, "g_log_set_writer_func", LIBS);
  gidLink(g_log_structured, "g_log_structured", LIBS);
  gidLink(g_log_structured_array, "g_log_structured_array", LIBS);
  gidLink(g_log_structured_standard, "g_log_structured_standard", LIBS);
  gidLink(g_log_variant, "g_log_variant", LIBS);
  gidLink(g_log_writer_default, "g_log_writer_default", LIBS);
  gidLink(g_log_writer_default_set_debug_domains, "g_log_writer_default_set_debug_domains", LIBS);
  gidLink(g_log_writer_default_set_use_stderr, "g_log_writer_default_set_use_stderr", LIBS);
  gidLink(g_log_writer_default_would_drop, "g_log_writer_default_would_drop", LIBS);
  gidLink(g_log_writer_format_fields, "g_log_writer_format_fields", LIBS);
  gidLink(g_log_writer_is_journald, "g_log_writer_is_journald", LIBS);
  gidLink(g_log_writer_journald, "g_log_writer_journald", LIBS);
  gidLink(g_log_writer_standard_streams, "g_log_writer_standard_streams", LIBS);
  gidLink(g_log_writer_supports_color, "g_log_writer_supports_color", LIBS);
  gidLink(g_log_writer_syslog, "g_log_writer_syslog", LIBS);
  gidLink(g_logv, "g_logv", LIBS);
  gidLink(g_lstat, "g_lstat", LIBS);
  gidLink(g_main_current_source, "g_main_current_source", LIBS);
  gidLink(g_main_depth, "g_main_depth", LIBS);
  gidLink(g_malloc, "g_malloc", LIBS);
  gidLink(g_malloc0, "g_malloc0", LIBS);
  gidLink(g_malloc0_n, "g_malloc0_n", LIBS);
  gidLink(g_malloc_n, "g_malloc_n", LIBS);
  gidLink(g_markup_collect_attributes, "g_markup_collect_attributes", LIBS);
  gidLink(g_markup_error_quark, "g_markup_error_quark", LIBS);
  gidLink(g_markup_escape_text, "g_markup_escape_text", LIBS);
  gidLink(g_markup_printf_escaped, "g_markup_printf_escaped", LIBS);
  gidLink(g_markup_vprintf_escaped, "g_markup_vprintf_escaped", LIBS);
  gidLink(g_mem_is_system_malloc, "g_mem_is_system_malloc", LIBS);
  gidLink(g_mem_profile, "g_mem_profile", LIBS);
  gidLink(g_mem_set_vtable, "g_mem_set_vtable", LIBS);
  gidLink(g_memdup, "g_memdup", LIBS);
  gidLink(g_memdup2, "g_memdup2", LIBS);
  gidLink(g_mkdir, "g_mkdir", LIBS);
  gidLink(g_mkdir_with_parents, "g_mkdir_with_parents", LIBS);
  gidLink(g_mkdtemp, "g_mkdtemp", LIBS);
  gidLink(g_mkdtemp_full, "g_mkdtemp_full", LIBS);
  gidLink(g_mkstemp, "g_mkstemp", LIBS);
  gidLink(g_mkstemp_full, "g_mkstemp_full", LIBS);
  gidLink(g_nullify_pointer, "g_nullify_pointer", LIBS);
  gidLink(g_number_parser_error_quark, "g_number_parser_error_quark", LIBS);
  gidLink(g_on_error_query, "g_on_error_query", LIBS);
  gidLink(g_on_error_stack_trace, "g_on_error_stack_trace", LIBS);
  gidLink(g_open, "g_open", LIBS);
  gidLink(g_option_error_quark, "g_option_error_quark", LIBS);
  gidLink(g_parse_debug_string, "g_parse_debug_string", LIBS);
  gidLink(g_path_get_basename, "g_path_get_basename", LIBS);
  gidLink(g_path_get_dirname, "g_path_get_dirname", LIBS);
  gidLink(g_path_is_absolute, "g_path_is_absolute", LIBS);
  gidLink(g_path_skip_root, "g_path_skip_root", LIBS);
  gidLink(g_pattern_match, "g_pattern_match", LIBS);
  gidLink(g_pattern_match_simple, "g_pattern_match_simple", LIBS);
  gidLink(g_pattern_match_string, "g_pattern_match_string", LIBS);
  gidLink(g_pointer_bit_lock, "g_pointer_bit_lock", LIBS);
  gidLink(g_pointer_bit_lock_and_get, "g_pointer_bit_lock_and_get", LIBS);
  gidLink(g_pointer_bit_lock_mask_ptr, "g_pointer_bit_lock_mask_ptr", LIBS);
  gidLink(g_pointer_bit_trylock, "g_pointer_bit_trylock", LIBS);
  gidLink(g_pointer_bit_unlock, "g_pointer_bit_unlock", LIBS);
  gidLink(g_pointer_bit_unlock_and_set, "g_pointer_bit_unlock_and_set", LIBS);
  gidLink(g_poll, "g_poll", LIBS);
  gidLink(g_prefix_error, "g_prefix_error", LIBS);
  gidLink(g_prefix_error_literal, "g_prefix_error_literal", LIBS);
  gidLink(g_print, "g_print", LIBS);
  gidLink(g_printerr, "g_printerr", LIBS);
  gidLink(g_printf, "g_printf", LIBS);
  gidLink(g_printf_string_upper_bound, "g_printf_string_upper_bound", LIBS);
  gidLink(g_propagate_error, "g_propagate_error", LIBS);
  gidLink(g_propagate_prefixed_error, "g_propagate_prefixed_error", LIBS);
  gidLink(g_qsort_with_data, "g_qsort_with_data", LIBS);
  gidLink(g_quark_from_static_string, "g_quark_from_static_string", LIBS);
  gidLink(g_quark_from_string, "g_quark_from_string", LIBS);
  gidLink(g_quark_to_string, "g_quark_to_string", LIBS);
  gidLink(g_quark_try_string, "g_quark_try_string", LIBS);
  gidLink(g_random_double, "g_random_double", LIBS);
  gidLink(g_random_double_range, "g_random_double_range", LIBS);
  gidLink(g_random_int, "g_random_int", LIBS);
  gidLink(g_random_int_range, "g_random_int_range", LIBS);
  gidLink(g_random_set_seed, "g_random_set_seed", LIBS);
  gidLink(g_rc_box_acquire, "g_rc_box_acquire", LIBS);
  gidLink(g_rc_box_alloc, "g_rc_box_alloc", LIBS);
  gidLink(g_rc_box_alloc0, "g_rc_box_alloc0", LIBS);
  gidLink(g_rc_box_dup, "g_rc_box_dup", LIBS);
  gidLink(g_rc_box_get_size, "g_rc_box_get_size", LIBS);
  gidLink(g_rc_box_release, "g_rc_box_release", LIBS);
  gidLink(g_rc_box_release_full, "g_rc_box_release_full", LIBS);
  gidLink(g_realloc, "g_realloc", LIBS);
  gidLink(g_realloc_n, "g_realloc_n", LIBS);
  gidLink(g_ref_count_compare, "g_ref_count_compare", LIBS);
  gidLink(g_ref_count_dec, "g_ref_count_dec", LIBS);
  gidLink(g_ref_count_inc, "g_ref_count_inc", LIBS);
  gidLink(g_ref_count_init, "g_ref_count_init", LIBS);
  gidLink(g_ref_string_acquire, "g_ref_string_acquire", LIBS);
  gidLink(g_ref_string_length, "g_ref_string_length", LIBS);
  gidLink(g_ref_string_new, "g_ref_string_new", LIBS);
  gidLink(g_ref_string_new_intern, "g_ref_string_new_intern", LIBS);
  gidLink(g_ref_string_new_len, "g_ref_string_new_len", LIBS);
  gidLink(g_ref_string_release, "g_ref_string_release", LIBS);
  gidLink(g_reload_user_special_dirs_cache, "g_reload_user_special_dirs_cache", LIBS);
  gidLink(g_remove, "g_remove", LIBS);
  gidLink(g_rename, "g_rename", LIBS);
  gidLink(g_return_if_fail_warning, "g_return_if_fail_warning", LIBS);
  gidLink(g_rmdir, "g_rmdir", LIBS);
  gidLink(g_set_application_name, "g_set_application_name", LIBS);
  gidLink(g_set_error, "g_set_error", LIBS);
  gidLink(g_set_error_literal, "g_set_error_literal", LIBS);
  gidLink(g_set_prgname, "g_set_prgname", LIBS);
  gidLink(g_set_print_handler, "g_set_print_handler", LIBS);
  gidLink(g_set_printerr_handler, "g_set_printerr_handler", LIBS);
  gidLink(g_setenv, "g_setenv", LIBS);
  gidLink(g_shell_error_quark, "g_shell_error_quark", LIBS);
  gidLink(g_shell_parse_argv, "g_shell_parse_argv", LIBS);
  gidLink(g_shell_quote, "g_shell_quote", LIBS);
  gidLink(g_shell_unquote, "g_shell_unquote", LIBS);
  gidLink(g_slice_alloc, "g_slice_alloc", LIBS);
  gidLink(g_slice_alloc0, "g_slice_alloc0", LIBS);
  gidLink(g_slice_copy, "g_slice_copy", LIBS);
  gidLink(g_slice_free1, "g_slice_free1", LIBS);
  gidLink(g_slice_free_chain_with_offset, "g_slice_free_chain_with_offset", LIBS);
  gidLink(g_slice_get_config, "g_slice_get_config", LIBS);
  gidLink(g_slice_get_config_state, "g_slice_get_config_state", LIBS);
  gidLink(g_slice_set_config, "g_slice_set_config", LIBS);
  gidLink(g_snprintf, "g_snprintf", LIBS);
  gidLink(g_spaced_primes_closest, "g_spaced_primes_closest", LIBS);
  gidLink(g_spawn_async, "g_spawn_async", LIBS);
  gidLink(g_spawn_async_with_fds, "g_spawn_async_with_fds", LIBS);
  gidLink(g_spawn_async_with_pipes, "g_spawn_async_with_pipes", LIBS);
  gidLink(g_spawn_async_with_pipes_and_fds, "g_spawn_async_with_pipes_and_fds", LIBS);
  gidLink(g_spawn_check_exit_status, "g_spawn_check_exit_status", LIBS);
  gidLink(g_spawn_check_wait_status, "g_spawn_check_wait_status", LIBS);
  gidLink(g_spawn_close_pid, "g_spawn_close_pid", LIBS);
  gidLink(g_spawn_command_line_async, "g_spawn_command_line_async", LIBS);
  gidLink(g_spawn_command_line_sync, "g_spawn_command_line_sync", LIBS);
  gidLink(g_spawn_error_quark, "g_spawn_error_quark", LIBS);
  gidLink(g_spawn_exit_error_quark, "g_spawn_exit_error_quark", LIBS);
  gidLink(g_spawn_sync, "g_spawn_sync", LIBS);
  gidLink(g_sprintf, "g_sprintf", LIBS);
  gidLink(g_stat, "g_stat", LIBS);
  gidLink(g_stpcpy, "g_stpcpy", LIBS);
  gidLink(g_str_equal, "g_str_equal", LIBS);
  gidLink(g_str_has_prefix, "g_str_has_prefix", LIBS);
  gidLink(g_str_has_suffix, "g_str_has_suffix", LIBS);
  gidLink(g_str_hash, "g_str_hash", LIBS);
  gidLink(g_str_is_ascii, "g_str_is_ascii", LIBS);
  gidLink(g_str_match_string, "g_str_match_string", LIBS);
  gidLink(g_str_to_ascii, "g_str_to_ascii", LIBS);
  gidLink(g_str_tokenize_and_fold, "g_str_tokenize_and_fold", LIBS);
  gidLink(g_strcanon, "g_strcanon", LIBS);
  gidLink(g_strcasecmp, "g_strcasecmp", LIBS);
  gidLink(g_strchomp, "g_strchomp", LIBS);
  gidLink(g_strchug, "g_strchug", LIBS);
  gidLink(g_strcmp0, "g_strcmp0", LIBS);
  gidLink(g_strcompress, "g_strcompress", LIBS);
  gidLink(g_strconcat, "g_strconcat", LIBS);
  gidLink(g_strdelimit, "g_strdelimit", LIBS);
  gidLink(g_strdown, "g_strdown", LIBS);
  gidLink(g_strdup, "g_strdup", LIBS);
  gidLink(g_strdup_printf, "g_strdup_printf", LIBS);
  gidLink(g_strdup_vprintf, "g_strdup_vprintf", LIBS);
  gidLink(g_strdupv, "g_strdupv", LIBS);
  gidLink(g_strerror, "g_strerror", LIBS);
  gidLink(g_strescape, "g_strescape", LIBS);
  gidLink(g_strfreev, "g_strfreev", LIBS);
  gidLink(g_strip_context, "g_strip_context", LIBS);
  gidLink(g_strjoin, "g_strjoin", LIBS);
  gidLink(g_strjoinv, "g_strjoinv", LIBS);
  gidLink(g_strlcat, "g_strlcat", LIBS);
  gidLink(g_strlcpy, "g_strlcpy", LIBS);
  gidLink(g_strncasecmp, "g_strncasecmp", LIBS);
  gidLink(g_strndup, "g_strndup", LIBS);
  gidLink(g_strnfill, "g_strnfill", LIBS);
  gidLink(g_strreverse, "g_strreverse", LIBS);
  gidLink(g_strrstr, "g_strrstr", LIBS);
  gidLink(g_strrstr_len, "g_strrstr_len", LIBS);
  gidLink(g_strsignal, "g_strsignal", LIBS);
  gidLink(g_strsplit, "g_strsplit", LIBS);
  gidLink(g_strsplit_set, "g_strsplit_set", LIBS);
  gidLink(g_strstr_len, "g_strstr_len", LIBS);
  gidLink(g_strtod, "g_strtod", LIBS);
  gidLink(g_strup, "g_strup", LIBS);
  gidLink(g_strv_contains, "g_strv_contains", LIBS);
  gidLink(g_strv_equal, "g_strv_equal", LIBS);
  gidLink(g_strv_get_type, "g_strv_get_type", LIBS);
  gidLink(g_strv_length, "g_strv_length", LIBS);
  gidLink(g_test_add_data_func, "g_test_add_data_func", LIBS);
  gidLink(g_test_add_data_func_full, "g_test_add_data_func_full", LIBS);
  gidLink(g_test_add_func, "g_test_add_func", LIBS);
  gidLink(g_test_add_vtable, "g_test_add_vtable", LIBS);
  gidLink(g_test_assert_expected_messages_internal, "g_test_assert_expected_messages_internal", LIBS);
  gidLink(g_test_bug, "g_test_bug", LIBS);
  gidLink(g_test_bug_base, "g_test_bug_base", LIBS);
  gidLink(g_test_build_filename, "g_test_build_filename", LIBS);
  gidLink(g_test_create_case, "g_test_create_case", LIBS);
  gidLink(g_test_create_suite, "g_test_create_suite", LIBS);
  gidLink(g_test_disable_crash_reporting, "g_test_disable_crash_reporting", LIBS);
  gidLink(g_test_expect_message, "g_test_expect_message", LIBS);
  gidLink(g_test_fail, "g_test_fail", LIBS);
  gidLink(g_test_fail_printf, "g_test_fail_printf", LIBS);
  gidLink(g_test_failed, "g_test_failed", LIBS);
  gidLink(g_test_get_dir, "g_test_get_dir", LIBS);
  gidLink(g_test_get_filename, "g_test_get_filename", LIBS);
  gidLink(g_test_get_path, "g_test_get_path", LIBS);
  gidLink(g_test_get_root, "g_test_get_root", LIBS);
  gidLink(g_test_incomplete, "g_test_incomplete", LIBS);
  gidLink(g_test_incomplete_printf, "g_test_incomplete_printf", LIBS);
  gidLink(g_test_init, "g_test_init", LIBS);
  gidLink(g_test_log_set_fatal_handler, "g_test_log_set_fatal_handler", LIBS);
  gidLink(g_test_log_type_name, "g_test_log_type_name", LIBS);
  gidLink(g_test_maximized_result, "g_test_maximized_result", LIBS);
  gidLink(g_test_message, "g_test_message", LIBS);
  gidLink(g_test_minimized_result, "g_test_minimized_result", LIBS);
  gidLink(g_test_queue_destroy, "g_test_queue_destroy", LIBS);
  gidLink(g_test_queue_free, "g_test_queue_free", LIBS);
  gidLink(g_test_rand_double, "g_test_rand_double", LIBS);
  gidLink(g_test_rand_double_range, "g_test_rand_double_range", LIBS);
  gidLink(g_test_rand_int, "g_test_rand_int", LIBS);
  gidLink(g_test_rand_int_range, "g_test_rand_int_range", LIBS);
  gidLink(g_test_run, "g_test_run", LIBS);
  gidLink(g_test_run_suite, "g_test_run_suite", LIBS);
  gidLink(g_test_set_nonfatal_assertions, "g_test_set_nonfatal_assertions", LIBS);
  gidLink(g_test_skip, "g_test_skip", LIBS);
  gidLink(g_test_skip_printf, "g_test_skip_printf", LIBS);
  gidLink(g_test_subprocess, "g_test_subprocess", LIBS);
  gidLink(g_test_summary, "g_test_summary", LIBS);
  gidLink(g_test_timer_elapsed, "g_test_timer_elapsed", LIBS);
  gidLink(g_test_timer_last, "g_test_timer_last", LIBS);
  gidLink(g_test_timer_start, "g_test_timer_start", LIBS);
  gidLink(g_test_trap_assertions, "g_test_trap_assertions", LIBS);
  gidLink(g_test_trap_fork, "g_test_trap_fork", LIBS);
  gidLink(g_test_trap_has_passed, "g_test_trap_has_passed", LIBS);
  gidLink(g_test_trap_reached_timeout, "g_test_trap_reached_timeout", LIBS);
  gidLink(g_test_trap_subprocess, "g_test_trap_subprocess", LIBS);
  gidLink(g_test_trap_subprocess_with_envp, "g_test_trap_subprocess_with_envp", LIBS);
  gidLink(g_timeout_add, "g_timeout_add", LIBS);
  gidLink(g_timeout_add_full, "g_timeout_add_full", LIBS);
  gidLink(g_timeout_add_once, "g_timeout_add_once", LIBS);
  gidLink(g_timeout_add_seconds, "g_timeout_add_seconds", LIBS);
  gidLink(g_timeout_add_seconds_full, "g_timeout_add_seconds_full", LIBS);
  gidLink(g_timeout_add_seconds_once, "g_timeout_add_seconds_once", LIBS);
  gidLink(g_timeout_source_new, "g_timeout_source_new", LIBS);
  gidLink(g_timeout_source_new_seconds, "g_timeout_source_new_seconds", LIBS);
  gidLink(g_try_malloc, "g_try_malloc", LIBS);
  gidLink(g_try_malloc0, "g_try_malloc0", LIBS);
  gidLink(g_try_malloc0_n, "g_try_malloc0_n", LIBS);
  gidLink(g_try_malloc_n, "g_try_malloc_n", LIBS);
  gidLink(g_try_realloc, "g_try_realloc", LIBS);
  gidLink(g_try_realloc_n, "g_try_realloc_n", LIBS);
  gidLink(g_ucs4_to_utf16, "g_ucs4_to_utf16", LIBS);
  gidLink(g_ucs4_to_utf8, "g_ucs4_to_utf8", LIBS);
  gidLink(g_unichar_break_type, "g_unichar_break_type", LIBS);
  gidLink(g_unichar_combining_class, "g_unichar_combining_class", LIBS);
  gidLink(g_unichar_compose, "g_unichar_compose", LIBS);
  gidLink(g_unichar_decompose, "g_unichar_decompose", LIBS);
  gidLink(g_unichar_digit_value, "g_unichar_digit_value", LIBS);
  gidLink(g_unichar_fully_decompose, "g_unichar_fully_decompose", LIBS);
  gidLink(g_unichar_get_mirror_char, "g_unichar_get_mirror_char", LIBS);
  gidLink(g_unichar_get_script, "g_unichar_get_script", LIBS);
  gidLink(g_unichar_isalnum, "g_unichar_isalnum", LIBS);
  gidLink(g_unichar_isalpha, "g_unichar_isalpha", LIBS);
  gidLink(g_unichar_iscntrl, "g_unichar_iscntrl", LIBS);
  gidLink(g_unichar_isdefined, "g_unichar_isdefined", LIBS);
  gidLink(g_unichar_isdigit, "g_unichar_isdigit", LIBS);
  gidLink(g_unichar_isgraph, "g_unichar_isgraph", LIBS);
  gidLink(g_unichar_islower, "g_unichar_islower", LIBS);
  gidLink(g_unichar_ismark, "g_unichar_ismark", LIBS);
  gidLink(g_unichar_isprint, "g_unichar_isprint", LIBS);
  gidLink(g_unichar_ispunct, "g_unichar_ispunct", LIBS);
  gidLink(g_unichar_isspace, "g_unichar_isspace", LIBS);
  gidLink(g_unichar_istitle, "g_unichar_istitle", LIBS);
  gidLink(g_unichar_isupper, "g_unichar_isupper", LIBS);
  gidLink(g_unichar_iswide, "g_unichar_iswide", LIBS);
  gidLink(g_unichar_iswide_cjk, "g_unichar_iswide_cjk", LIBS);
  gidLink(g_unichar_isxdigit, "g_unichar_isxdigit", LIBS);
  gidLink(g_unichar_iszerowidth, "g_unichar_iszerowidth", LIBS);
  gidLink(g_unichar_to_utf8, "g_unichar_to_utf8", LIBS);
  gidLink(g_unichar_tolower, "g_unichar_tolower", LIBS);
  gidLink(g_unichar_totitle, "g_unichar_totitle", LIBS);
  gidLink(g_unichar_toupper, "g_unichar_toupper", LIBS);
  gidLink(g_unichar_type, "g_unichar_type", LIBS);
  gidLink(g_unichar_validate, "g_unichar_validate", LIBS);
  gidLink(g_unichar_xdigit_value, "g_unichar_xdigit_value", LIBS);
  gidLink(g_unicode_canonical_decomposition, "g_unicode_canonical_decomposition", LIBS);
  gidLink(g_unicode_canonical_ordering, "g_unicode_canonical_ordering", LIBS);
  gidLink(g_unix_error_quark, "g_unix_error_quark", LIBS);
  gidLink(g_unix_fd_add, "g_unix_fd_add", LIBS);
  gidLink(g_unix_fd_add_full, "g_unix_fd_add_full", LIBS);
  gidLink(g_unix_fd_source_new, "g_unix_fd_source_new", LIBS);
  gidLink(g_unix_get_passwd_entry, "g_unix_get_passwd_entry", LIBS);
  gidLink(g_unix_open_pipe, "g_unix_open_pipe", LIBS);
  gidLink(g_unix_set_fd_nonblocking, "g_unix_set_fd_nonblocking", LIBS);
  gidLink(g_unix_signal_add, "g_unix_signal_add", LIBS);
  gidLink(g_unix_signal_add_full, "g_unix_signal_add_full", LIBS);
  gidLink(g_unix_signal_source_new, "g_unix_signal_source_new", LIBS);
  gidLink(g_unlink, "g_unlink", LIBS);
  gidLink(g_unsetenv, "g_unsetenv", LIBS);
  gidLink(g_usleep, "g_usleep", LIBS);
  gidLink(g_utf16_to_ucs4, "g_utf16_to_ucs4", LIBS);
  gidLink(g_utf16_to_utf8, "g_utf16_to_utf8", LIBS);
  gidLink(g_utf8_casefold, "g_utf8_casefold", LIBS);
  gidLink(g_utf8_collate, "g_utf8_collate", LIBS);
  gidLink(g_utf8_collate_key, "g_utf8_collate_key", LIBS);
  gidLink(g_utf8_collate_key_for_filename, "g_utf8_collate_key_for_filename", LIBS);
  gidLink(g_utf8_find_next_char, "g_utf8_find_next_char", LIBS);
  gidLink(g_utf8_find_prev_char, "g_utf8_find_prev_char", LIBS);
  gidLink(g_utf8_get_char, "g_utf8_get_char", LIBS);
  gidLink(g_utf8_get_char_validated, "g_utf8_get_char_validated", LIBS);
  gidLink(g_utf8_make_valid, "g_utf8_make_valid", LIBS);
  gidLink(g_utf8_normalize, "g_utf8_normalize", LIBS);
  gidLink(g_utf8_offset_to_pointer, "g_utf8_offset_to_pointer", LIBS);
  gidLink(g_utf8_pointer_to_offset, "g_utf8_pointer_to_offset", LIBS);
  gidLink(g_utf8_prev_char, "g_utf8_prev_char", LIBS);
  gidLink(g_utf8_strchr, "g_utf8_strchr", LIBS);
  gidLink(g_utf8_strdown, "g_utf8_strdown", LIBS);
  gidLink(g_utf8_strlen, "g_utf8_strlen", LIBS);
  gidLink(g_utf8_strncpy, "g_utf8_strncpy", LIBS);
  gidLink(g_utf8_strrchr, "g_utf8_strrchr", LIBS);
  gidLink(g_utf8_strreverse, "g_utf8_strreverse", LIBS);
  gidLink(g_utf8_strup, "g_utf8_strup", LIBS);
  gidLink(g_utf8_substring, "g_utf8_substring", LIBS);
  gidLink(g_utf8_to_ucs4, "g_utf8_to_ucs4", LIBS);
  gidLink(g_utf8_to_ucs4_fast, "g_utf8_to_ucs4_fast", LIBS);
  gidLink(g_utf8_to_utf16, "g_utf8_to_utf16", LIBS);
  gidLink(g_utf8_truncate_middle, "g_utf8_truncate_middle", LIBS);
  gidLink(g_utf8_validate, "g_utf8_validate", LIBS);
  gidLink(g_utf8_validate_len, "g_utf8_validate_len", LIBS);
  gidLink(g_uuid_string_is_valid, "g_uuid_string_is_valid", LIBS);
  gidLink(g_uuid_string_random, "g_uuid_string_random", LIBS);
  gidLink(g_variant_get_gtype, "g_variant_get_gtype", LIBS);
  gidLink(g_vasprintf, "g_vasprintf", LIBS);
  gidLink(g_vfprintf, "g_vfprintf", LIBS);
  gidLink(g_vprintf, "g_vprintf", LIBS);
  gidLink(g_vsnprintf, "g_vsnprintf", LIBS);
  gidLink(g_vsprintf, "g_vsprintf", LIBS);
  gidLink(g_warn_message, "g_warn_message", LIBS);

  // HashTable
  gidLink(g_hash_table_get_type, "g_hash_table_get_type", LIBS);
  gidLink(g_hash_table_add, "g_hash_table_add", LIBS);
  gidLink(g_hash_table_contains, "g_hash_table_contains", LIBS);
  gidLink(g_hash_table_destroy, "g_hash_table_destroy", LIBS);
  gidLink(g_hash_table_find, "g_hash_table_find", LIBS);
  gidLink(g_hash_table_foreach, "g_hash_table_foreach", LIBS);
  gidLink(g_hash_table_foreach_remove, "g_hash_table_foreach_remove", LIBS);
  gidLink(g_hash_table_foreach_steal, "g_hash_table_foreach_steal", LIBS);
  gidLink(g_hash_table_get_keys, "g_hash_table_get_keys", LIBS);
  gidLink(g_hash_table_get_keys_as_array, "g_hash_table_get_keys_as_array", LIBS);
  gidLink(g_hash_table_get_keys_as_ptr_array, "g_hash_table_get_keys_as_ptr_array", LIBS);
  gidLink(g_hash_table_get_values, "g_hash_table_get_values", LIBS);
  gidLink(g_hash_table_get_values_as_ptr_array, "g_hash_table_get_values_as_ptr_array", LIBS);
  gidLink(g_hash_table_insert, "g_hash_table_insert", LIBS);
  gidLink(g_hash_table_lookup, "g_hash_table_lookup", LIBS);
  gidLink(g_hash_table_lookup_extended, "g_hash_table_lookup_extended", LIBS);
  gidLink(g_hash_table_new, "g_hash_table_new", LIBS);
  gidLink(g_hash_table_new_full, "g_hash_table_new_full", LIBS);
  gidLink(g_hash_table_new_similar, "g_hash_table_new_similar", LIBS);
  gidLink(g_hash_table_ref, "g_hash_table_ref", LIBS);
  gidLink(g_hash_table_remove, "g_hash_table_remove", LIBS);
  gidLink(g_hash_table_remove_all, "g_hash_table_remove_all", LIBS);
  gidLink(g_hash_table_replace, "g_hash_table_replace", LIBS);
  gidLink(g_hash_table_size, "g_hash_table_size", LIBS);
  gidLink(g_hash_table_steal, "g_hash_table_steal", LIBS);
  gidLink(g_hash_table_steal_all, "g_hash_table_steal_all", LIBS);
  gidLink(g_hash_table_steal_all_keys, "g_hash_table_steal_all_keys", LIBS);
  gidLink(g_hash_table_steal_all_values, "g_hash_table_steal_all_values", LIBS);
  gidLink(g_hash_table_steal_extended, "g_hash_table_steal_extended", LIBS);
  gidLink(g_hash_table_unref, "g_hash_table_unref", LIBS);

  // HashTableIter
  gidLink(g_hash_table_iter_get_hash_table, "g_hash_table_iter_get_hash_table", LIBS);
  gidLink(g_hash_table_iter_init, "g_hash_table_iter_init", LIBS);
  gidLink(g_hash_table_iter_next, "g_hash_table_iter_next", LIBS);
  gidLink(g_hash_table_iter_remove, "g_hash_table_iter_remove", LIBS);
  gidLink(g_hash_table_iter_replace, "g_hash_table_iter_replace", LIBS);
  gidLink(g_hash_table_iter_steal, "g_hash_table_iter_steal", LIBS);

  // Hmac
  gidLink(g_hmac_get_type, "g_hmac_get_type", LIBS);
  gidLink(g_hmac_new, "g_hmac_new", LIBS);
  gidLink(g_hmac_copy, "g_hmac_copy", LIBS);
  gidLink(g_hmac_get_digest, "g_hmac_get_digest", LIBS);
  gidLink(g_hmac_get_string, "g_hmac_get_string", LIBS);
  gidLink(g_hmac_ref, "g_hmac_ref", LIBS);
  gidLink(g_hmac_unref, "g_hmac_unref", LIBS);
  gidLink(g_hmac_update, "g_hmac_update", LIBS);

  // Hook
  gidLink(g_hook_compare_ids, "g_hook_compare_ids", LIBS);
  gidLink(g_hook_alloc, "g_hook_alloc", LIBS);
  gidLink(g_hook_destroy, "g_hook_destroy", LIBS);
  gidLink(g_hook_destroy_link, "g_hook_destroy_link", LIBS);
  gidLink(g_hook_find, "g_hook_find", LIBS);
  gidLink(g_hook_find_data, "g_hook_find_data", LIBS);
  gidLink(g_hook_find_func, "g_hook_find_func", LIBS);
  gidLink(g_hook_find_func_data, "g_hook_find_func_data", LIBS);
  gidLink(g_hook_first_valid, "g_hook_first_valid", LIBS);
  gidLink(g_hook_free, "g_hook_free", LIBS);
  gidLink(g_hook_get, "g_hook_get", LIBS);
  gidLink(g_hook_insert_before, "g_hook_insert_before", LIBS);
  gidLink(g_hook_insert_sorted, "g_hook_insert_sorted", LIBS);
  gidLink(g_hook_next_valid, "g_hook_next_valid", LIBS);
  gidLink(g_hook_prepend, "g_hook_prepend", LIBS);
  gidLink(g_hook_ref, "g_hook_ref", LIBS);
  gidLink(g_hook_unref, "g_hook_unref", LIBS);

  // HookList
  gidLink(g_hook_list_clear, "g_hook_list_clear", LIBS);
  gidLink(g_hook_list_init, "g_hook_list_init", LIBS);
  gidLink(g_hook_list_invoke, "g_hook_list_invoke", LIBS);
  gidLink(g_hook_list_invoke_check, "g_hook_list_invoke_check", LIBS);
  gidLink(g_hook_list_marshal, "g_hook_list_marshal", LIBS);
  gidLink(g_hook_list_marshal_check, "g_hook_list_marshal_check", LIBS);

  // IOChannel
  gidLink(g_io_channel_get_type, "g_io_channel_get_type", LIBS);
  gidLink(g_io_channel_new_file, "g_io_channel_new_file", LIBS);
  gidLink(g_io_channel_unix_new, "g_io_channel_unix_new", LIBS);
  gidLink(g_io_channel_close, "g_io_channel_close", LIBS);
  gidLink(g_io_channel_flush, "g_io_channel_flush", LIBS);
  gidLink(g_io_channel_get_buffer_condition, "g_io_channel_get_buffer_condition", LIBS);
  gidLink(g_io_channel_get_buffer_size, "g_io_channel_get_buffer_size", LIBS);
  gidLink(g_io_channel_get_buffered, "g_io_channel_get_buffered", LIBS);
  gidLink(g_io_channel_get_close_on_unref, "g_io_channel_get_close_on_unref", LIBS);
  gidLink(g_io_channel_get_encoding, "g_io_channel_get_encoding", LIBS);
  gidLink(g_io_channel_get_flags, "g_io_channel_get_flags", LIBS);
  gidLink(g_io_channel_get_line_term, "g_io_channel_get_line_term", LIBS);
  gidLink(g_io_channel_init, "g_io_channel_init", LIBS);
  gidLink(g_io_channel_read, "g_io_channel_read", LIBS);
  gidLink(g_io_channel_read_chars, "g_io_channel_read_chars", LIBS);
  gidLink(g_io_channel_read_line, "g_io_channel_read_line", LIBS);
  gidLink(g_io_channel_read_line_string, "g_io_channel_read_line_string", LIBS);
  gidLink(g_io_channel_read_to_end, "g_io_channel_read_to_end", LIBS);
  gidLink(g_io_channel_read_unichar, "g_io_channel_read_unichar", LIBS);
  gidLink(g_io_channel_ref, "g_io_channel_ref", LIBS);
  gidLink(g_io_channel_seek, "g_io_channel_seek", LIBS);
  gidLink(g_io_channel_seek_position, "g_io_channel_seek_position", LIBS);
  gidLink(g_io_channel_set_buffer_size, "g_io_channel_set_buffer_size", LIBS);
  gidLink(g_io_channel_set_buffered, "g_io_channel_set_buffered", LIBS);
  gidLink(g_io_channel_set_close_on_unref, "g_io_channel_set_close_on_unref", LIBS);
  gidLink(g_io_channel_set_encoding, "g_io_channel_set_encoding", LIBS);
  gidLink(g_io_channel_set_flags, "g_io_channel_set_flags", LIBS);
  gidLink(g_io_channel_set_line_term, "g_io_channel_set_line_term", LIBS);
  gidLink(g_io_channel_shutdown, "g_io_channel_shutdown", LIBS);
  gidLink(g_io_channel_unix_get_fd, "g_io_channel_unix_get_fd", LIBS);
  gidLink(g_io_channel_unref, "g_io_channel_unref", LIBS);
  gidLink(g_io_channel_write, "g_io_channel_write", LIBS);
  gidLink(g_io_channel_write_chars, "g_io_channel_write_chars", LIBS);
  gidLink(g_io_channel_write_unichar, "g_io_channel_write_unichar", LIBS);
  gidLink(g_io_channel_error_from_errno, "g_io_channel_error_from_errno", LIBS);
  gidLink(g_io_channel_error_quark, "g_io_channel_error_quark", LIBS);

  // KeyFile
  gidLink(g_key_file_get_type, "g_key_file_get_type", LIBS);
  gidLink(g_key_file_new, "g_key_file_new", LIBS);
  gidLink(g_key_file_free, "g_key_file_free", LIBS);
  gidLink(g_key_file_get_boolean, "g_key_file_get_boolean", LIBS);
  gidLink(g_key_file_get_boolean_list, "g_key_file_get_boolean_list", LIBS);
  gidLink(g_key_file_get_comment, "g_key_file_get_comment", LIBS);
  gidLink(g_key_file_get_double, "g_key_file_get_double", LIBS);
  gidLink(g_key_file_get_double_list, "g_key_file_get_double_list", LIBS);
  gidLink(g_key_file_get_groups, "g_key_file_get_groups", LIBS);
  gidLink(g_key_file_get_int64, "g_key_file_get_int64", LIBS);
  gidLink(g_key_file_get_integer, "g_key_file_get_integer", LIBS);
  gidLink(g_key_file_get_integer_list, "g_key_file_get_integer_list", LIBS);
  gidLink(g_key_file_get_keys, "g_key_file_get_keys", LIBS);
  gidLink(g_key_file_get_locale_for_key, "g_key_file_get_locale_for_key", LIBS);
  gidLink(g_key_file_get_locale_string, "g_key_file_get_locale_string", LIBS);
  gidLink(g_key_file_get_locale_string_list, "g_key_file_get_locale_string_list", LIBS);
  gidLink(g_key_file_get_start_group, "g_key_file_get_start_group", LIBS);
  gidLink(g_key_file_get_string, "g_key_file_get_string", LIBS);
  gidLink(g_key_file_get_string_list, "g_key_file_get_string_list", LIBS);
  gidLink(g_key_file_get_uint64, "g_key_file_get_uint64", LIBS);
  gidLink(g_key_file_get_value, "g_key_file_get_value", LIBS);
  gidLink(g_key_file_has_group, "g_key_file_has_group", LIBS);
  gidLink(g_key_file_has_key, "g_key_file_has_key", LIBS);
  gidLink(g_key_file_load_from_bytes, "g_key_file_load_from_bytes", LIBS);
  gidLink(g_key_file_load_from_data, "g_key_file_load_from_data", LIBS);
  gidLink(g_key_file_load_from_data_dirs, "g_key_file_load_from_data_dirs", LIBS);
  gidLink(g_key_file_load_from_dirs, "g_key_file_load_from_dirs", LIBS);
  gidLink(g_key_file_load_from_file, "g_key_file_load_from_file", LIBS);
  gidLink(g_key_file_ref, "g_key_file_ref", LIBS);
  gidLink(g_key_file_remove_comment, "g_key_file_remove_comment", LIBS);
  gidLink(g_key_file_remove_group, "g_key_file_remove_group", LIBS);
  gidLink(g_key_file_remove_key, "g_key_file_remove_key", LIBS);
  gidLink(g_key_file_save_to_file, "g_key_file_save_to_file", LIBS);
  gidLink(g_key_file_set_boolean, "g_key_file_set_boolean", LIBS);
  gidLink(g_key_file_set_boolean_list, "g_key_file_set_boolean_list", LIBS);
  gidLink(g_key_file_set_comment, "g_key_file_set_comment", LIBS);
  gidLink(g_key_file_set_double, "g_key_file_set_double", LIBS);
  gidLink(g_key_file_set_double_list, "g_key_file_set_double_list", LIBS);
  gidLink(g_key_file_set_int64, "g_key_file_set_int64", LIBS);
  gidLink(g_key_file_set_integer, "g_key_file_set_integer", LIBS);
  gidLink(g_key_file_set_integer_list, "g_key_file_set_integer_list", LIBS);
  gidLink(g_key_file_set_list_separator, "g_key_file_set_list_separator", LIBS);
  gidLink(g_key_file_set_locale_string, "g_key_file_set_locale_string", LIBS);
  gidLink(g_key_file_set_locale_string_list, "g_key_file_set_locale_string_list", LIBS);
  gidLink(g_key_file_set_string, "g_key_file_set_string", LIBS);
  gidLink(g_key_file_set_string_list, "g_key_file_set_string_list", LIBS);
  gidLink(g_key_file_set_uint64, "g_key_file_set_uint64", LIBS);
  gidLink(g_key_file_set_value, "g_key_file_set_value", LIBS);
  gidLink(g_key_file_to_data, "g_key_file_to_data", LIBS);
  gidLink(g_key_file_unref, "g_key_file_unref", LIBS);
  gidLink(g_key_file_error_quark, "g_key_file_error_quark", LIBS);

  // List
  gidLink(g_list_alloc, "g_list_alloc", LIBS);
  gidLink(g_list_append, "g_list_append", LIBS);
  gidLink(g_list_concat, "g_list_concat", LIBS);
  gidLink(g_list_copy, "g_list_copy", LIBS);
  gidLink(g_list_copy_deep, "g_list_copy_deep", LIBS);
  gidLink(g_list_delete_link, "g_list_delete_link", LIBS);
  gidLink(g_list_find, "g_list_find", LIBS);
  gidLink(g_list_find_custom, "g_list_find_custom", LIBS);
  gidLink(g_list_first, "g_list_first", LIBS);
  gidLink(g_list_foreach, "g_list_foreach", LIBS);
  gidLink(g_list_free, "g_list_free", LIBS);
  gidLink(g_list_free_1, "g_list_free_1", LIBS);
  gidLink(g_list_free_full, "g_list_free_full", LIBS);
  gidLink(g_list_index, "g_list_index", LIBS);
  gidLink(g_list_insert, "g_list_insert", LIBS);
  gidLink(g_list_insert_before, "g_list_insert_before", LIBS);
  gidLink(g_list_insert_before_link, "g_list_insert_before_link", LIBS);
  gidLink(g_list_insert_sorted, "g_list_insert_sorted", LIBS);
  gidLink(g_list_insert_sorted_with_data, "g_list_insert_sorted_with_data", LIBS);
  gidLink(g_list_last, "g_list_last", LIBS);
  gidLink(g_list_length, "g_list_length", LIBS);
  gidLink(g_list_nth, "g_list_nth", LIBS);
  gidLink(g_list_nth_data, "g_list_nth_data", LIBS);
  gidLink(g_list_nth_prev, "g_list_nth_prev", LIBS);
  gidLink(g_list_pop_allocator, "g_list_pop_allocator", LIBS);
  gidLink(g_list_position, "g_list_position", LIBS);
  gidLink(g_list_prepend, "g_list_prepend", LIBS);
  gidLink(g_list_push_allocator, "g_list_push_allocator", LIBS);
  gidLink(g_list_remove, "g_list_remove", LIBS);
  gidLink(g_list_remove_all, "g_list_remove_all", LIBS);
  gidLink(g_list_remove_link, "g_list_remove_link", LIBS);
  gidLink(g_list_reverse, "g_list_reverse", LIBS);
  gidLink(g_list_sort, "g_list_sort", LIBS);
  gidLink(g_list_sort_with_data, "g_list_sort_with_data", LIBS);

  // MainContext
  gidLink(g_main_context_get_type, "g_main_context_get_type", LIBS);
  gidLink(g_main_context_new, "g_main_context_new", LIBS);
  gidLink(g_main_context_new_with_flags, "g_main_context_new_with_flags", LIBS);
  gidLink(g_main_context_acquire, "g_main_context_acquire", LIBS);
  gidLink(g_main_context_add_poll, "g_main_context_add_poll", LIBS);
  gidLink(g_main_context_check, "g_main_context_check", LIBS);
  gidLink(g_main_context_dispatch, "g_main_context_dispatch", LIBS);
  gidLink(g_main_context_find_source_by_funcs_user_data, "g_main_context_find_source_by_funcs_user_data", LIBS);
  gidLink(g_main_context_find_source_by_id, "g_main_context_find_source_by_id", LIBS);
  gidLink(g_main_context_find_source_by_user_data, "g_main_context_find_source_by_user_data", LIBS);
  gidLink(g_main_context_get_poll_func, "g_main_context_get_poll_func", LIBS);
  gidLink(g_main_context_invoke, "g_main_context_invoke", LIBS);
  gidLink(g_main_context_invoke_full, "g_main_context_invoke_full", LIBS);
  gidLink(g_main_context_is_owner, "g_main_context_is_owner", LIBS);
  gidLink(g_main_context_iteration, "g_main_context_iteration", LIBS);
  gidLink(g_main_context_pending, "g_main_context_pending", LIBS);
  gidLink(g_main_context_pop_thread_default, "g_main_context_pop_thread_default", LIBS);
  gidLink(g_main_context_prepare, "g_main_context_prepare", LIBS);
  gidLink(g_main_context_push_thread_default, "g_main_context_push_thread_default", LIBS);
  gidLink(g_main_context_query, "g_main_context_query", LIBS);
  gidLink(g_main_context_ref, "g_main_context_ref", LIBS);
  gidLink(g_main_context_release, "g_main_context_release", LIBS);
  gidLink(g_main_context_remove_poll, "g_main_context_remove_poll", LIBS);
  gidLink(g_main_context_set_poll_func, "g_main_context_set_poll_func", LIBS);
  gidLink(g_main_context_unref, "g_main_context_unref", LIBS);
  gidLink(g_main_context_wait, "g_main_context_wait", LIBS);
  gidLink(g_main_context_wakeup, "g_main_context_wakeup", LIBS);
  gidLink(g_main_context_default, "g_main_context_default", LIBS);
  gidLink(g_main_context_get_thread_default, "g_main_context_get_thread_default", LIBS);
  gidLink(g_main_context_ref_thread_default, "g_main_context_ref_thread_default", LIBS);

  // MainLoop
  gidLink(g_main_loop_get_type, "g_main_loop_get_type", LIBS);
  gidLink(g_main_loop_new, "g_main_loop_new", LIBS);
  gidLink(g_main_loop_get_context, "g_main_loop_get_context", LIBS);
  gidLink(g_main_loop_is_running, "g_main_loop_is_running", LIBS);
  gidLink(g_main_loop_quit, "g_main_loop_quit", LIBS);
  gidLink(g_main_loop_ref, "g_main_loop_ref", LIBS);
  gidLink(g_main_loop_run, "g_main_loop_run", LIBS);
  gidLink(g_main_loop_unref, "g_main_loop_unref", LIBS);

  // MappedFile
  gidLink(g_mapped_file_get_type, "g_mapped_file_get_type", LIBS);
  gidLink(g_mapped_file_new, "g_mapped_file_new", LIBS);
  gidLink(g_mapped_file_new_from_fd, "g_mapped_file_new_from_fd", LIBS);
  gidLink(g_mapped_file_free, "g_mapped_file_free", LIBS);
  gidLink(g_mapped_file_get_bytes, "g_mapped_file_get_bytes", LIBS);
  gidLink(g_mapped_file_get_contents, "g_mapped_file_get_contents", LIBS);
  gidLink(g_mapped_file_get_length, "g_mapped_file_get_length", LIBS);
  gidLink(g_mapped_file_ref, "g_mapped_file_ref", LIBS);
  gidLink(g_mapped_file_unref, "g_mapped_file_unref", LIBS);

  // MarkupParseContext
  gidLink(g_markup_parse_context_get_type, "g_markup_parse_context_get_type", LIBS);
  gidLink(g_markup_parse_context_new, "g_markup_parse_context_new", LIBS);
  gidLink(g_markup_parse_context_end_parse, "g_markup_parse_context_end_parse", LIBS);
  gidLink(g_markup_parse_context_free, "g_markup_parse_context_free", LIBS);
  gidLink(g_markup_parse_context_get_element, "g_markup_parse_context_get_element", LIBS);
  gidLink(g_markup_parse_context_get_element_stack, "g_markup_parse_context_get_element_stack", LIBS);
  gidLink(g_markup_parse_context_get_position, "g_markup_parse_context_get_position", LIBS);
  gidLink(g_markup_parse_context_get_user_data, "g_markup_parse_context_get_user_data", LIBS);
  gidLink(g_markup_parse_context_parse, "g_markup_parse_context_parse", LIBS);
  gidLink(g_markup_parse_context_pop, "g_markup_parse_context_pop", LIBS);
  gidLink(g_markup_parse_context_push, "g_markup_parse_context_push", LIBS);
  gidLink(g_markup_parse_context_ref, "g_markup_parse_context_ref", LIBS);
  gidLink(g_markup_parse_context_unref, "g_markup_parse_context_unref", LIBS);

  // MatchInfo
  gidLink(g_match_info_get_type, "g_match_info_get_type", LIBS);
  gidLink(g_match_info_expand_references, "g_match_info_expand_references", LIBS);
  gidLink(g_match_info_fetch, "g_match_info_fetch", LIBS);
  gidLink(g_match_info_fetch_all, "g_match_info_fetch_all", LIBS);
  gidLink(g_match_info_fetch_named, "g_match_info_fetch_named", LIBS);
  gidLink(g_match_info_fetch_named_pos, "g_match_info_fetch_named_pos", LIBS);
  gidLink(g_match_info_fetch_pos, "g_match_info_fetch_pos", LIBS);
  gidLink(g_match_info_free, "g_match_info_free", LIBS);
  gidLink(g_match_info_get_match_count, "g_match_info_get_match_count", LIBS);
  gidLink(g_match_info_get_regex, "g_match_info_get_regex", LIBS);
  gidLink(g_match_info_get_string, "g_match_info_get_string", LIBS);
  gidLink(g_match_info_is_partial_match, "g_match_info_is_partial_match", LIBS);
  gidLink(g_match_info_matches, "g_match_info_matches", LIBS);
  gidLink(g_match_info_next, "g_match_info_next", LIBS);
  gidLink(g_match_info_ref, "g_match_info_ref", LIBS);
  gidLink(g_match_info_unref, "g_match_info_unref", LIBS);

  // MemChunk
  gidLink(g_mem_chunk_alloc, "g_mem_chunk_alloc", LIBS);
  gidLink(g_mem_chunk_alloc0, "g_mem_chunk_alloc0", LIBS);
  gidLink(g_mem_chunk_clean, "g_mem_chunk_clean", LIBS);
  gidLink(g_mem_chunk_destroy, "g_mem_chunk_destroy", LIBS);
  gidLink(g_mem_chunk_free, "g_mem_chunk_free", LIBS);
  gidLink(g_mem_chunk_print, "g_mem_chunk_print", LIBS);
  gidLink(g_mem_chunk_reset, "g_mem_chunk_reset", LIBS);
  gidLink(g_mem_chunk_info, "g_mem_chunk_info", LIBS);
  gidLink(g_mem_chunk_new, "g_mem_chunk_new", LIBS);

  // Mutex
  gidLink(g_mutex_clear, "g_mutex_clear", LIBS);
  gidLink(g_mutex_free, "g_mutex_free", LIBS);
  gidLink(g_mutex_init, "g_mutex_init", LIBS);
  gidLink(g_mutex_lock, "g_mutex_lock", LIBS);
  gidLink(g_mutex_trylock, "g_mutex_trylock", LIBS);
  gidLink(g_mutex_unlock, "g_mutex_unlock", LIBS);
  gidLink(g_mutex_new, "g_mutex_new", LIBS);

  // Node
  gidLink(g_node_child_index, "g_node_child_index", LIBS);
  gidLink(g_node_child_position, "g_node_child_position", LIBS);
  gidLink(g_node_children_foreach, "g_node_children_foreach", LIBS);
  gidLink(g_node_copy, "g_node_copy", LIBS);
  gidLink(g_node_copy_deep, "g_node_copy_deep", LIBS);
  gidLink(g_node_depth, "g_node_depth", LIBS);
  gidLink(g_node_destroy, "g_node_destroy", LIBS);
  gidLink(g_node_find, "g_node_find", LIBS);
  gidLink(g_node_find_child, "g_node_find_child", LIBS);
  gidLink(g_node_first_sibling, "g_node_first_sibling", LIBS);
  gidLink(g_node_get_root, "g_node_get_root", LIBS);
  gidLink(g_node_insert, "g_node_insert", LIBS);
  gidLink(g_node_insert_after, "g_node_insert_after", LIBS);
  gidLink(g_node_insert_before, "g_node_insert_before", LIBS);
  gidLink(g_node_is_ancestor, "g_node_is_ancestor", LIBS);
  gidLink(g_node_last_child, "g_node_last_child", LIBS);
  gidLink(g_node_last_sibling, "g_node_last_sibling", LIBS);
  gidLink(g_node_max_height, "g_node_max_height", LIBS);
  gidLink(g_node_n_children, "g_node_n_children", LIBS);
  gidLink(g_node_n_nodes, "g_node_n_nodes", LIBS);
  gidLink(g_node_nth_child, "g_node_nth_child", LIBS);
  gidLink(g_node_prepend, "g_node_prepend", LIBS);
  gidLink(g_node_reverse_children, "g_node_reverse_children", LIBS);
  gidLink(g_node_traverse, "g_node_traverse", LIBS);
  gidLink(g_node_unlink, "g_node_unlink", LIBS);
  gidLink(g_node_new, "g_node_new", LIBS);
  gidLink(g_node_pop_allocator, "g_node_pop_allocator", LIBS);
  gidLink(g_node_push_allocator, "g_node_push_allocator", LIBS);

  // Once
  gidLink(g_once_impl, "g_once_impl", LIBS);
  gidLink(g_once_init_enter, "g_once_init_enter", LIBS);
  gidLink(g_once_init_enter_impl, "g_once_init_enter_impl", LIBS);
  gidLink(g_once_init_enter_pointer, "g_once_init_enter_pointer", LIBS);
  gidLink(g_once_init_leave, "g_once_init_leave", LIBS);
  gidLink(g_once_init_leave_pointer, "g_once_init_leave_pointer", LIBS);

  // OptionContext
  gidLink(g_option_context_add_group, "g_option_context_add_group", LIBS);
  gidLink(g_option_context_add_main_entries, "g_option_context_add_main_entries", LIBS);
  gidLink(g_option_context_free, "g_option_context_free", LIBS);
  gidLink(g_option_context_get_description, "g_option_context_get_description", LIBS);
  gidLink(g_option_context_get_help, "g_option_context_get_help", LIBS);
  gidLink(g_option_context_get_help_enabled, "g_option_context_get_help_enabled", LIBS);
  gidLink(g_option_context_get_ignore_unknown_options, "g_option_context_get_ignore_unknown_options", LIBS);
  gidLink(g_option_context_get_main_group, "g_option_context_get_main_group", LIBS);
  gidLink(g_option_context_get_strict_posix, "g_option_context_get_strict_posix", LIBS);
  gidLink(g_option_context_get_summary, "g_option_context_get_summary", LIBS);
  gidLink(g_option_context_parse, "g_option_context_parse", LIBS);
  gidLink(g_option_context_parse_strv, "g_option_context_parse_strv", LIBS);
  gidLink(g_option_context_set_description, "g_option_context_set_description", LIBS);
  gidLink(g_option_context_set_help_enabled, "g_option_context_set_help_enabled", LIBS);
  gidLink(g_option_context_set_ignore_unknown_options, "g_option_context_set_ignore_unknown_options", LIBS);
  gidLink(g_option_context_set_main_group, "g_option_context_set_main_group", LIBS);
  gidLink(g_option_context_set_strict_posix, "g_option_context_set_strict_posix", LIBS);
  gidLink(g_option_context_set_summary, "g_option_context_set_summary", LIBS);
  gidLink(g_option_context_set_translate_func, "g_option_context_set_translate_func", LIBS);
  gidLink(g_option_context_set_translation_domain, "g_option_context_set_translation_domain", LIBS);
  gidLink(g_option_context_new, "g_option_context_new", LIBS);

  // OptionGroup
  gidLink(g_option_group_get_type, "g_option_group_get_type", LIBS);
  gidLink(g_option_group_new, "g_option_group_new", LIBS);
  gidLink(g_option_group_add_entries, "g_option_group_add_entries", LIBS);
  gidLink(g_option_group_free, "g_option_group_free", LIBS);
  gidLink(g_option_group_ref, "g_option_group_ref", LIBS);
  gidLink(g_option_group_set_error_hook, "g_option_group_set_error_hook", LIBS);
  gidLink(g_option_group_set_parse_hooks, "g_option_group_set_parse_hooks", LIBS);
  gidLink(g_option_group_set_translate_func, "g_option_group_set_translate_func", LIBS);
  gidLink(g_option_group_set_translation_domain, "g_option_group_set_translation_domain", LIBS);
  gidLink(g_option_group_unref, "g_option_group_unref", LIBS);

  // PathBuf
  gidLink(g_path_buf_clear, "g_path_buf_clear", LIBS);
  gidLink(g_path_buf_clear_to_path, "g_path_buf_clear_to_path", LIBS);
  gidLink(g_path_buf_copy, "g_path_buf_copy", LIBS);
  gidLink(g_path_buf_free, "g_path_buf_free", LIBS);
  gidLink(g_path_buf_free_to_path, "g_path_buf_free_to_path", LIBS);
  gidLink(g_path_buf_init, "g_path_buf_init", LIBS);
  gidLink(g_path_buf_init_from_path, "g_path_buf_init_from_path", LIBS);
  gidLink(g_path_buf_pop, "g_path_buf_pop", LIBS);
  gidLink(g_path_buf_push, "g_path_buf_push", LIBS);
  gidLink(g_path_buf_set_extension, "g_path_buf_set_extension", LIBS);
  gidLink(g_path_buf_set_filename, "g_path_buf_set_filename", LIBS);
  gidLink(g_path_buf_to_path, "g_path_buf_to_path", LIBS);
  gidLink(g_path_buf_equal, "g_path_buf_equal", LIBS);
  gidLink(g_path_buf_new, "g_path_buf_new", LIBS);
  gidLink(g_path_buf_new_from_path, "g_path_buf_new_from_path", LIBS);

  // PatternSpec
  gidLink(g_pattern_spec_get_type, "g_pattern_spec_get_type", LIBS);
  gidLink(g_pattern_spec_new, "g_pattern_spec_new", LIBS);
  gidLink(g_pattern_spec_copy, "g_pattern_spec_copy", LIBS);
  gidLink(g_pattern_spec_equal, "g_pattern_spec_equal", LIBS);
  gidLink(g_pattern_spec_free, "g_pattern_spec_free", LIBS);
  gidLink(g_pattern_spec_match, "g_pattern_spec_match", LIBS);
  gidLink(g_pattern_spec_match_string, "g_pattern_spec_match_string", LIBS);

  // PollFD
  gidLink(g_pollfd_get_type, "g_pollfd_get_type", LIBS);

  // Private
  gidLink(g_private_get, "g_private_get", LIBS);
  gidLink(g_private_replace, "g_private_replace", LIBS);
  gidLink(g_private_set, "g_private_set", LIBS);
  gidLink(g_private_new, "g_private_new", LIBS);

  // PtrArray
  gidLink(g_ptr_array_get_type, "g_ptr_array_get_type", LIBS);
  gidLink(g_ptr_array_add, "g_ptr_array_add", LIBS);
  gidLink(g_ptr_array_copy, "g_ptr_array_copy", LIBS);
  gidLink(g_ptr_array_extend, "g_ptr_array_extend", LIBS);
  gidLink(g_ptr_array_extend_and_steal, "g_ptr_array_extend_and_steal", LIBS);
  gidLink(g_ptr_array_find, "g_ptr_array_find", LIBS);
  gidLink(g_ptr_array_find_with_equal_func, "g_ptr_array_find_with_equal_func", LIBS);
  gidLink(g_ptr_array_foreach, "g_ptr_array_foreach", LIBS);
  gidLink(g_ptr_array_free, "g_ptr_array_free", LIBS);
  gidLink(g_ptr_array_insert, "g_ptr_array_insert", LIBS);
  gidLink(g_ptr_array_is_null_terminated, "g_ptr_array_is_null_terminated", LIBS);
  gidLink(g_ptr_array_new, "g_ptr_array_new", LIBS);
  gidLink(g_ptr_array_new_from_array, "g_ptr_array_new_from_array", LIBS);
  gidLink(g_ptr_array_new_from_null_terminated_array, "g_ptr_array_new_from_null_terminated_array", LIBS);
  gidLink(g_ptr_array_new_full, "g_ptr_array_new_full", LIBS);
  gidLink(g_ptr_array_new_null_terminated, "g_ptr_array_new_null_terminated", LIBS);
  gidLink(g_ptr_array_new_take, "g_ptr_array_new_take", LIBS);
  gidLink(g_ptr_array_new_take_null_terminated, "g_ptr_array_new_take_null_terminated", LIBS);
  gidLink(g_ptr_array_new_with_free_func, "g_ptr_array_new_with_free_func", LIBS);
  gidLink(g_ptr_array_ref, "g_ptr_array_ref", LIBS);
  gidLink(g_ptr_array_remove, "g_ptr_array_remove", LIBS);
  gidLink(g_ptr_array_remove_fast, "g_ptr_array_remove_fast", LIBS);
  gidLink(g_ptr_array_remove_index, "g_ptr_array_remove_index", LIBS);
  gidLink(g_ptr_array_remove_index_fast, "g_ptr_array_remove_index_fast", LIBS);
  gidLink(g_ptr_array_remove_range, "g_ptr_array_remove_range", LIBS);
  gidLink(g_ptr_array_set_free_func, "g_ptr_array_set_free_func", LIBS);
  gidLink(g_ptr_array_set_size, "g_ptr_array_set_size", LIBS);
  gidLink(g_ptr_array_sized_new, "g_ptr_array_sized_new", LIBS);
  gidLink(g_ptr_array_sort, "g_ptr_array_sort", LIBS);
  gidLink(g_ptr_array_sort_values, "g_ptr_array_sort_values", LIBS);
  gidLink(g_ptr_array_sort_values_with_data, "g_ptr_array_sort_values_with_data", LIBS);
  gidLink(g_ptr_array_sort_with_data, "g_ptr_array_sort_with_data", LIBS);
  gidLink(g_ptr_array_steal, "g_ptr_array_steal", LIBS);
  gidLink(g_ptr_array_steal_index, "g_ptr_array_steal_index", LIBS);
  gidLink(g_ptr_array_steal_index_fast, "g_ptr_array_steal_index_fast", LIBS);
  gidLink(g_ptr_array_unref, "g_ptr_array_unref", LIBS);

  // Queue
  gidLink(g_queue_clear, "g_queue_clear", LIBS);
  gidLink(g_queue_clear_full, "g_queue_clear_full", LIBS);
  gidLink(g_queue_copy, "g_queue_copy", LIBS);
  gidLink(g_queue_delete_link, "g_queue_delete_link", LIBS);
  gidLink(g_queue_find, "g_queue_find", LIBS);
  gidLink(g_queue_find_custom, "g_queue_find_custom", LIBS);
  gidLink(g_queue_foreach, "g_queue_foreach", LIBS);
  gidLink(g_queue_free, "g_queue_free", LIBS);
  gidLink(g_queue_free_full, "g_queue_free_full", LIBS);
  gidLink(g_queue_get_length, "g_queue_get_length", LIBS);
  gidLink(g_queue_index, "g_queue_index", LIBS);
  gidLink(g_queue_init, "g_queue_init", LIBS);
  gidLink(g_queue_insert_after, "g_queue_insert_after", LIBS);
  gidLink(g_queue_insert_after_link, "g_queue_insert_after_link", LIBS);
  gidLink(g_queue_insert_before, "g_queue_insert_before", LIBS);
  gidLink(g_queue_insert_before_link, "g_queue_insert_before_link", LIBS);
  gidLink(g_queue_insert_sorted, "g_queue_insert_sorted", LIBS);
  gidLink(g_queue_is_empty, "g_queue_is_empty", LIBS);
  gidLink(g_queue_link_index, "g_queue_link_index", LIBS);
  gidLink(g_queue_peek_head, "g_queue_peek_head", LIBS);
  gidLink(g_queue_peek_head_link, "g_queue_peek_head_link", LIBS);
  gidLink(g_queue_peek_nth, "g_queue_peek_nth", LIBS);
  gidLink(g_queue_peek_nth_link, "g_queue_peek_nth_link", LIBS);
  gidLink(g_queue_peek_tail, "g_queue_peek_tail", LIBS);
  gidLink(g_queue_peek_tail_link, "g_queue_peek_tail_link", LIBS);
  gidLink(g_queue_pop_head, "g_queue_pop_head", LIBS);
  gidLink(g_queue_pop_head_link, "g_queue_pop_head_link", LIBS);
  gidLink(g_queue_pop_nth, "g_queue_pop_nth", LIBS);
  gidLink(g_queue_pop_nth_link, "g_queue_pop_nth_link", LIBS);
  gidLink(g_queue_pop_tail, "g_queue_pop_tail", LIBS);
  gidLink(g_queue_pop_tail_link, "g_queue_pop_tail_link", LIBS);
  gidLink(g_queue_push_head, "g_queue_push_head", LIBS);
  gidLink(g_queue_push_head_link, "g_queue_push_head_link", LIBS);
  gidLink(g_queue_push_nth, "g_queue_push_nth", LIBS);
  gidLink(g_queue_push_nth_link, "g_queue_push_nth_link", LIBS);
  gidLink(g_queue_push_tail, "g_queue_push_tail", LIBS);
  gidLink(g_queue_push_tail_link, "g_queue_push_tail_link", LIBS);
  gidLink(g_queue_remove, "g_queue_remove", LIBS);
  gidLink(g_queue_remove_all, "g_queue_remove_all", LIBS);
  gidLink(g_queue_reverse, "g_queue_reverse", LIBS);
  gidLink(g_queue_sort, "g_queue_sort", LIBS);
  gidLink(g_queue_unlink, "g_queue_unlink", LIBS);
  gidLink(g_queue_new, "g_queue_new", LIBS);

  // RWLock
  gidLink(g_rw_lock_clear, "g_rw_lock_clear", LIBS);
  gidLink(g_rw_lock_init, "g_rw_lock_init", LIBS);
  gidLink(g_rw_lock_reader_lock, "g_rw_lock_reader_lock", LIBS);
  gidLink(g_rw_lock_reader_trylock, "g_rw_lock_reader_trylock", LIBS);
  gidLink(g_rw_lock_reader_unlock, "g_rw_lock_reader_unlock", LIBS);
  gidLink(g_rw_lock_writer_lock, "g_rw_lock_writer_lock", LIBS);
  gidLink(g_rw_lock_writer_trylock, "g_rw_lock_writer_trylock", LIBS);
  gidLink(g_rw_lock_writer_unlock, "g_rw_lock_writer_unlock", LIBS);

  // Rand
  gidLink(g_rand_get_type, "g_rand_get_type", LIBS);
  gidLink(g_rand_new, "g_rand_new", LIBS);
  gidLink(g_rand_new_with_seed, "g_rand_new_with_seed", LIBS);
  gidLink(g_rand_new_with_seed_array, "g_rand_new_with_seed_array", LIBS);
  gidLink(g_rand_copy, "g_rand_copy", LIBS);
  gidLink(g_rand_double, "g_rand_double", LIBS);
  gidLink(g_rand_double_range, "g_rand_double_range", LIBS);
  gidLink(g_rand_free, "g_rand_free", LIBS);
  gidLink(g_rand_int, "g_rand_int", LIBS);
  gidLink(g_rand_int_range, "g_rand_int_range", LIBS);
  gidLink(g_rand_set_seed, "g_rand_set_seed", LIBS);
  gidLink(g_rand_set_seed_array, "g_rand_set_seed_array", LIBS);

  // RecMutex
  gidLink(g_rec_mutex_clear, "g_rec_mutex_clear", LIBS);
  gidLink(g_rec_mutex_init, "g_rec_mutex_init", LIBS);
  gidLink(g_rec_mutex_lock, "g_rec_mutex_lock", LIBS);
  gidLink(g_rec_mutex_trylock, "g_rec_mutex_trylock", LIBS);
  gidLink(g_rec_mutex_unlock, "g_rec_mutex_unlock", LIBS);

  // Regex
  gidLink(g_regex_get_type, "g_regex_get_type", LIBS);
  gidLink(g_regex_new, "g_regex_new", LIBS);
  gidLink(g_regex_get_capture_count, "g_regex_get_capture_count", LIBS);
  gidLink(g_regex_get_compile_flags, "g_regex_get_compile_flags", LIBS);
  gidLink(g_regex_get_has_cr_or_lf, "g_regex_get_has_cr_or_lf", LIBS);
  gidLink(g_regex_get_match_flags, "g_regex_get_match_flags", LIBS);
  gidLink(g_regex_get_max_backref, "g_regex_get_max_backref", LIBS);
  gidLink(g_regex_get_max_lookbehind, "g_regex_get_max_lookbehind", LIBS);
  gidLink(g_regex_get_pattern, "g_regex_get_pattern", LIBS);
  gidLink(g_regex_get_string_number, "g_regex_get_string_number", LIBS);
  gidLink(g_regex_match, "g_regex_match", LIBS);
  gidLink(g_regex_match_all, "g_regex_match_all", LIBS);
  gidLink(g_regex_match_all_full, "g_regex_match_all_full", LIBS);
  gidLink(g_regex_match_full, "g_regex_match_full", LIBS);
  gidLink(g_regex_ref, "g_regex_ref", LIBS);
  gidLink(g_regex_replace, "g_regex_replace", LIBS);
  gidLink(g_regex_replace_eval, "g_regex_replace_eval", LIBS);
  gidLink(g_regex_replace_literal, "g_regex_replace_literal", LIBS);
  gidLink(g_regex_split, "g_regex_split", LIBS);
  gidLink(g_regex_split_full, "g_regex_split_full", LIBS);
  gidLink(g_regex_unref, "g_regex_unref", LIBS);
  gidLink(g_regex_check_replacement, "g_regex_check_replacement", LIBS);
  gidLink(g_regex_error_quark, "g_regex_error_quark", LIBS);
  gidLink(g_regex_escape_nul, "g_regex_escape_nul", LIBS);
  gidLink(g_regex_escape_string, "g_regex_escape_string", LIBS);
  gidLink(g_regex_match_simple, "g_regex_match_simple", LIBS);
  gidLink(g_regex_split_simple, "g_regex_split_simple", LIBS);

  // Relation
  gidLink(g_relation_count, "g_relation_count", LIBS);
  gidLink(g_relation_delete, "g_relation_delete", LIBS);
  gidLink(g_relation_destroy, "g_relation_destroy", LIBS);
  gidLink(g_relation_exists, "g_relation_exists", LIBS);
  gidLink(g_relation_index, "g_relation_index", LIBS);
  gidLink(g_relation_insert, "g_relation_insert", LIBS);
  gidLink(g_relation_print, "g_relation_print", LIBS);
  gidLink(g_relation_select, "g_relation_select", LIBS);
  gidLink(g_relation_new, "g_relation_new", LIBS);

  // SList
  gidLink(g_slist_alloc, "g_slist_alloc", LIBS);
  gidLink(g_slist_append, "g_slist_append", LIBS);
  gidLink(g_slist_concat, "g_slist_concat", LIBS);
  gidLink(g_slist_copy, "g_slist_copy", LIBS);
  gidLink(g_slist_copy_deep, "g_slist_copy_deep", LIBS);
  gidLink(g_slist_delete_link, "g_slist_delete_link", LIBS);
  gidLink(g_slist_find, "g_slist_find", LIBS);
  gidLink(g_slist_find_custom, "g_slist_find_custom", LIBS);
  gidLink(g_slist_foreach, "g_slist_foreach", LIBS);
  gidLink(g_slist_free, "g_slist_free", LIBS);
  gidLink(g_slist_free_1, "g_slist_free_1", LIBS);
  gidLink(g_slist_free_full, "g_slist_free_full", LIBS);
  gidLink(g_slist_index, "g_slist_index", LIBS);
  gidLink(g_slist_insert, "g_slist_insert", LIBS);
  gidLink(g_slist_insert_before, "g_slist_insert_before", LIBS);
  gidLink(g_slist_insert_sorted, "g_slist_insert_sorted", LIBS);
  gidLink(g_slist_insert_sorted_with_data, "g_slist_insert_sorted_with_data", LIBS);
  gidLink(g_slist_last, "g_slist_last", LIBS);
  gidLink(g_slist_length, "g_slist_length", LIBS);
  gidLink(g_slist_nth, "g_slist_nth", LIBS);
  gidLink(g_slist_nth_data, "g_slist_nth_data", LIBS);
  gidLink(g_slist_pop_allocator, "g_slist_pop_allocator", LIBS);
  gidLink(g_slist_position, "g_slist_position", LIBS);
  gidLink(g_slist_prepend, "g_slist_prepend", LIBS);
  gidLink(g_slist_push_allocator, "g_slist_push_allocator", LIBS);
  gidLink(g_slist_remove, "g_slist_remove", LIBS);
  gidLink(g_slist_remove_all, "g_slist_remove_all", LIBS);
  gidLink(g_slist_remove_link, "g_slist_remove_link", LIBS);
  gidLink(g_slist_reverse, "g_slist_reverse", LIBS);
  gidLink(g_slist_sort, "g_slist_sort", LIBS);
  gidLink(g_slist_sort_with_data, "g_slist_sort_with_data", LIBS);

  // Scanner
  gidLink(g_scanner_cur_line, "g_scanner_cur_line", LIBS);
  gidLink(g_scanner_cur_position, "g_scanner_cur_position", LIBS);
  gidLink(g_scanner_cur_token, "g_scanner_cur_token", LIBS);
  gidLink(g_scanner_cur_value, "g_scanner_cur_value", LIBS);
  gidLink(g_scanner_destroy, "g_scanner_destroy", LIBS);
  gidLink(g_scanner_eof, "g_scanner_eof", LIBS);
  gidLink(g_scanner_error, "g_scanner_error", LIBS);
  gidLink(g_scanner_get_next_token, "g_scanner_get_next_token", LIBS);
  gidLink(g_scanner_input_file, "g_scanner_input_file", LIBS);
  gidLink(g_scanner_input_text, "g_scanner_input_text", LIBS);
  gidLink(g_scanner_lookup_symbol, "g_scanner_lookup_symbol", LIBS);
  gidLink(g_scanner_peek_next_token, "g_scanner_peek_next_token", LIBS);
  gidLink(g_scanner_scope_add_symbol, "g_scanner_scope_add_symbol", LIBS);
  gidLink(g_scanner_scope_foreach_symbol, "g_scanner_scope_foreach_symbol", LIBS);
  gidLink(g_scanner_scope_lookup_symbol, "g_scanner_scope_lookup_symbol", LIBS);
  gidLink(g_scanner_scope_remove_symbol, "g_scanner_scope_remove_symbol", LIBS);
  gidLink(g_scanner_set_scope, "g_scanner_set_scope", LIBS);
  gidLink(g_scanner_sync_file_offset, "g_scanner_sync_file_offset", LIBS);
  gidLink(g_scanner_unexp_token, "g_scanner_unexp_token", LIBS);
  gidLink(g_scanner_warn, "g_scanner_warn", LIBS);
  gidLink(g_scanner_new, "g_scanner_new", LIBS);

  // Sequence
  gidLink(g_sequence_append, "g_sequence_append", LIBS);
  gidLink(g_sequence_foreach, "g_sequence_foreach", LIBS);
  gidLink(g_sequence_free, "g_sequence_free", LIBS);
  gidLink(g_sequence_get_begin_iter, "g_sequence_get_begin_iter", LIBS);
  gidLink(g_sequence_get_end_iter, "g_sequence_get_end_iter", LIBS);
  gidLink(g_sequence_get_iter_at_pos, "g_sequence_get_iter_at_pos", LIBS);
  gidLink(g_sequence_get_length, "g_sequence_get_length", LIBS);
  gidLink(g_sequence_insert_sorted, "g_sequence_insert_sorted", LIBS);
  gidLink(g_sequence_insert_sorted_iter, "g_sequence_insert_sorted_iter", LIBS);
  gidLink(g_sequence_is_empty, "g_sequence_is_empty", LIBS);
  gidLink(g_sequence_lookup, "g_sequence_lookup", LIBS);
  gidLink(g_sequence_lookup_iter, "g_sequence_lookup_iter", LIBS);
  gidLink(g_sequence_prepend, "g_sequence_prepend", LIBS);
  gidLink(g_sequence_search, "g_sequence_search", LIBS);
  gidLink(g_sequence_search_iter, "g_sequence_search_iter", LIBS);
  gidLink(g_sequence_sort, "g_sequence_sort", LIBS);
  gidLink(g_sequence_sort_iter, "g_sequence_sort_iter", LIBS);
  gidLink(g_sequence_foreach_range, "g_sequence_foreach_range", LIBS);
  gidLink(g_sequence_get, "g_sequence_get", LIBS);
  gidLink(g_sequence_insert_before, "g_sequence_insert_before", LIBS);
  gidLink(g_sequence_move, "g_sequence_move", LIBS);
  gidLink(g_sequence_move_range, "g_sequence_move_range", LIBS);
  gidLink(g_sequence_new, "g_sequence_new", LIBS);
  gidLink(g_sequence_range_get_midpoint, "g_sequence_range_get_midpoint", LIBS);
  gidLink(g_sequence_remove, "g_sequence_remove", LIBS);
  gidLink(g_sequence_remove_range, "g_sequence_remove_range", LIBS);
  gidLink(g_sequence_set, "g_sequence_set", LIBS);
  gidLink(g_sequence_sort_changed, "g_sequence_sort_changed", LIBS);
  gidLink(g_sequence_sort_changed_iter, "g_sequence_sort_changed_iter", LIBS);
  gidLink(g_sequence_swap, "g_sequence_swap", LIBS);

  // SequenceIter
  gidLink(g_sequence_iter_compare, "g_sequence_iter_compare", LIBS);
  gidLink(g_sequence_iter_get_position, "g_sequence_iter_get_position", LIBS);
  gidLink(g_sequence_iter_get_sequence, "g_sequence_iter_get_sequence", LIBS);
  gidLink(g_sequence_iter_is_begin, "g_sequence_iter_is_begin", LIBS);
  gidLink(g_sequence_iter_is_end, "g_sequence_iter_is_end", LIBS);
  gidLink(g_sequence_iter_move, "g_sequence_iter_move", LIBS);
  gidLink(g_sequence_iter_next, "g_sequence_iter_next", LIBS);
  gidLink(g_sequence_iter_prev, "g_sequence_iter_prev", LIBS);

  // Source
  gidLink(g_source_get_type, "g_source_get_type", LIBS);
  gidLink(g_source_new, "g_source_new", LIBS);
  gidLink(g_source_add_child_source, "g_source_add_child_source", LIBS);
  gidLink(g_source_add_poll, "g_source_add_poll", LIBS);
  gidLink(g_source_add_unix_fd, "g_source_add_unix_fd", LIBS);
  gidLink(g_source_attach, "g_source_attach", LIBS);
  gidLink(g_source_destroy, "g_source_destroy", LIBS);
  gidLink(g_source_get_can_recurse, "g_source_get_can_recurse", LIBS);
  gidLink(g_source_get_context, "g_source_get_context", LIBS);
  gidLink(g_source_get_current_time, "g_source_get_current_time", LIBS);
  gidLink(g_source_get_id, "g_source_get_id", LIBS);
  gidLink(g_source_get_name, "g_source_get_name", LIBS);
  gidLink(g_source_get_priority, "g_source_get_priority", LIBS);
  gidLink(g_source_get_ready_time, "g_source_get_ready_time", LIBS);
  gidLink(g_source_get_time, "g_source_get_time", LIBS);
  gidLink(g_source_is_destroyed, "g_source_is_destroyed", LIBS);
  gidLink(g_source_modify_unix_fd, "g_source_modify_unix_fd", LIBS);
  gidLink(g_source_query_unix_fd, "g_source_query_unix_fd", LIBS);
  gidLink(g_source_ref, "g_source_ref", LIBS);
  gidLink(g_source_remove_child_source, "g_source_remove_child_source", LIBS);
  gidLink(g_source_remove_poll, "g_source_remove_poll", LIBS);
  gidLink(g_source_remove_unix_fd, "g_source_remove_unix_fd", LIBS);
  gidLink(g_source_set_callback, "g_source_set_callback", LIBS);
  gidLink(g_source_set_callback_indirect, "g_source_set_callback_indirect", LIBS);
  gidLink(g_source_set_can_recurse, "g_source_set_can_recurse", LIBS);
  gidLink(g_source_set_dispose_function, "g_source_set_dispose_function", LIBS);
  gidLink(g_source_set_funcs, "g_source_set_funcs", LIBS);
  gidLink(g_source_set_name, "g_source_set_name", LIBS);
  gidLink(g_source_set_priority, "g_source_set_priority", LIBS);
  gidLink(g_source_set_ready_time, "g_source_set_ready_time", LIBS);
  gidLink(g_source_set_static_name, "g_source_set_static_name", LIBS);
  gidLink(g_source_unref, "g_source_unref", LIBS);
  gidLink(g_source_remove, "g_source_remove", LIBS);
  gidLink(g_source_remove_by_funcs_user_data, "g_source_remove_by_funcs_user_data", LIBS);
  gidLink(g_source_remove_by_user_data, "g_source_remove_by_user_data", LIBS);
  gidLink(g_source_set_name_by_id, "g_source_set_name_by_id", LIBS);

  // StaticMutex
  gidLink(g_static_mutex_free, "g_static_mutex_free", LIBS);
  gidLink(g_static_mutex_get_mutex_impl, "g_static_mutex_get_mutex_impl", LIBS);
  gidLink(g_static_mutex_init, "g_static_mutex_init", LIBS);

  // StaticPrivate
  gidLink(g_static_private_free, "g_static_private_free", LIBS);
  gidLink(g_static_private_get, "g_static_private_get", LIBS);
  gidLink(g_static_private_init, "g_static_private_init", LIBS);
  gidLink(g_static_private_set, "g_static_private_set", LIBS);

  // StaticRWLock
  gidLink(g_static_rw_lock_free, "g_static_rw_lock_free", LIBS);
  gidLink(g_static_rw_lock_init, "g_static_rw_lock_init", LIBS);
  gidLink(g_static_rw_lock_reader_lock, "g_static_rw_lock_reader_lock", LIBS);
  gidLink(g_static_rw_lock_reader_trylock, "g_static_rw_lock_reader_trylock", LIBS);
  gidLink(g_static_rw_lock_reader_unlock, "g_static_rw_lock_reader_unlock", LIBS);
  gidLink(g_static_rw_lock_writer_lock, "g_static_rw_lock_writer_lock", LIBS);
  gidLink(g_static_rw_lock_writer_trylock, "g_static_rw_lock_writer_trylock", LIBS);
  gidLink(g_static_rw_lock_writer_unlock, "g_static_rw_lock_writer_unlock", LIBS);

  // StaticRecMutex
  gidLink(g_static_rec_mutex_free, "g_static_rec_mutex_free", LIBS);
  gidLink(g_static_rec_mutex_init, "g_static_rec_mutex_init", LIBS);
  gidLink(g_static_rec_mutex_lock, "g_static_rec_mutex_lock", LIBS);
  gidLink(g_static_rec_mutex_lock_full, "g_static_rec_mutex_lock_full", LIBS);
  gidLink(g_static_rec_mutex_trylock, "g_static_rec_mutex_trylock", LIBS);
  gidLink(g_static_rec_mutex_unlock, "g_static_rec_mutex_unlock", LIBS);
  gidLink(g_static_rec_mutex_unlock_full, "g_static_rec_mutex_unlock_full", LIBS);

  // String
  gidLink(g_gstring_get_type, "g_gstring_get_type", LIBS);
  gidLink(g_string_new, "g_string_new", LIBS);
  gidLink(g_string_new_len, "g_string_new_len", LIBS);
  gidLink(g_string_new_take, "g_string_new_take", LIBS);
  gidLink(g_string_sized_new, "g_string_sized_new", LIBS);
  gidLink(g_string_append, "g_string_append", LIBS);
  gidLink(g_string_append_c, "g_string_append_c", LIBS);
  gidLink(g_string_append_len, "g_string_append_len", LIBS);
  gidLink(g_string_append_printf, "g_string_append_printf", LIBS);
  gidLink(g_string_append_unichar, "g_string_append_unichar", LIBS);
  gidLink(g_string_append_uri_escaped, "g_string_append_uri_escaped", LIBS);
  gidLink(g_string_append_vprintf, "g_string_append_vprintf", LIBS);
  gidLink(g_string_ascii_down, "g_string_ascii_down", LIBS);
  gidLink(g_string_ascii_up, "g_string_ascii_up", LIBS);
  gidLink(g_string_assign, "g_string_assign", LIBS);
  gidLink(g_string_down, "g_string_down", LIBS);
  gidLink(g_string_equal, "g_string_equal", LIBS);
  gidLink(g_string_erase, "g_string_erase", LIBS);
  gidLink(g_string_free, "g_string_free", LIBS);
  gidLink(g_string_free_and_steal, "g_string_free_and_steal", LIBS);
  gidLink(g_string_free_to_bytes, "g_string_free_to_bytes", LIBS);
  gidLink(g_string_hash, "g_string_hash", LIBS);
  gidLink(g_string_insert, "g_string_insert", LIBS);
  gidLink(g_string_insert_c, "g_string_insert_c", LIBS);
  gidLink(g_string_insert_len, "g_string_insert_len", LIBS);
  gidLink(g_string_insert_unichar, "g_string_insert_unichar", LIBS);
  gidLink(g_string_overwrite, "g_string_overwrite", LIBS);
  gidLink(g_string_overwrite_len, "g_string_overwrite_len", LIBS);
  gidLink(g_string_prepend, "g_string_prepend", LIBS);
  gidLink(g_string_prepend_c, "g_string_prepend_c", LIBS);
  gidLink(g_string_prepend_len, "g_string_prepend_len", LIBS);
  gidLink(g_string_prepend_unichar, "g_string_prepend_unichar", LIBS);
  gidLink(g_string_printf, "g_string_printf", LIBS);
  gidLink(g_string_replace, "g_string_replace", LIBS);
  gidLink(g_string_set_size, "g_string_set_size", LIBS);
  gidLink(g_string_truncate, "g_string_truncate", LIBS);
  gidLink(g_string_up, "g_string_up", LIBS);
  gidLink(g_string_vprintf, "g_string_vprintf", LIBS);

  // StringChunk
  gidLink(g_string_chunk_clear, "g_string_chunk_clear", LIBS);
  gidLink(g_string_chunk_free, "g_string_chunk_free", LIBS);
  gidLink(g_string_chunk_insert, "g_string_chunk_insert", LIBS);
  gidLink(g_string_chunk_insert_const, "g_string_chunk_insert_const", LIBS);
  gidLink(g_string_chunk_insert_len, "g_string_chunk_insert_len", LIBS);
  gidLink(g_string_chunk_new, "g_string_chunk_new", LIBS);

  // StrvBuilder
  gidLink(g_strv_builder_get_type, "g_strv_builder_get_type", LIBS);
  gidLink(g_strv_builder_new, "g_strv_builder_new", LIBS);
  gidLink(g_strv_builder_add, "g_strv_builder_add", LIBS);
  gidLink(g_strv_builder_add_many, "g_strv_builder_add_many", LIBS);
  gidLink(g_strv_builder_addv, "g_strv_builder_addv", LIBS);
  gidLink(g_strv_builder_end, "g_strv_builder_end", LIBS);
  gidLink(g_strv_builder_ref, "g_strv_builder_ref", LIBS);
  gidLink(g_strv_builder_take, "g_strv_builder_take", LIBS);
  gidLink(g_strv_builder_unref, "g_strv_builder_unref", LIBS);

  // TestCase
  gidLink(g_test_case_free, "g_test_case_free", LIBS);

  // TestLogBuffer
  gidLink(g_test_log_buffer_free, "g_test_log_buffer_free", LIBS);
  gidLink(g_test_log_buffer_pop, "g_test_log_buffer_pop", LIBS);
  gidLink(g_test_log_buffer_push, "g_test_log_buffer_push", LIBS);
  gidLink(g_test_log_buffer_new, "g_test_log_buffer_new", LIBS);

  // TestLogMsg
  gidLink(g_test_log_msg_free, "g_test_log_msg_free", LIBS);

  // TestSuite
  gidLink(g_test_suite_add, "g_test_suite_add", LIBS);
  gidLink(g_test_suite_add_suite, "g_test_suite_add_suite", LIBS);
  gidLink(g_test_suite_free, "g_test_suite_free", LIBS);

  // Thread
  gidLink(g_thread_get_type, "g_thread_get_type", LIBS);
  gidLink(g_thread_new, "g_thread_new", LIBS);
  gidLink(g_thread_try_new, "g_thread_try_new", LIBS);
  gidLink(g_thread_join, "g_thread_join", LIBS);
  gidLink(g_thread_ref, "g_thread_ref", LIBS);
  gidLink(g_thread_set_priority, "g_thread_set_priority", LIBS);
  gidLink(g_thread_unref, "g_thread_unref", LIBS);
  gidLink(g_thread_create, "g_thread_create", LIBS);
  gidLink(g_thread_create_full, "g_thread_create_full", LIBS);
  gidLink(g_thread_error_quark, "g_thread_error_quark", LIBS);
  gidLink(g_thread_exit, "g_thread_exit", LIBS);
  gidLink(g_thread_foreach, "g_thread_foreach", LIBS);
  gidLink(g_thread_get_initialized, "g_thread_get_initialized", LIBS);
  gidLink(g_thread_init, "g_thread_init", LIBS);
  gidLink(g_thread_init_with_errorcheck_mutexes, "g_thread_init_with_errorcheck_mutexes", LIBS);
  gidLink(g_thread_self, "g_thread_self", LIBS);
  gidLink(g_thread_yield, "g_thread_yield", LIBS);

  // ThreadPool
  gidLink(g_thread_pool_free, "g_thread_pool_free", LIBS);
  gidLink(g_thread_pool_get_max_threads, "g_thread_pool_get_max_threads", LIBS);
  gidLink(g_thread_pool_get_num_threads, "g_thread_pool_get_num_threads", LIBS);
  gidLink(g_thread_pool_move_to_front, "g_thread_pool_move_to_front", LIBS);
  gidLink(g_thread_pool_push, "g_thread_pool_push", LIBS);
  gidLink(g_thread_pool_set_max_threads, "g_thread_pool_set_max_threads", LIBS);
  gidLink(g_thread_pool_set_sort_function, "g_thread_pool_set_sort_function", LIBS);
  gidLink(g_thread_pool_unprocessed, "g_thread_pool_unprocessed", LIBS);
  gidLink(g_thread_pool_get_max_idle_time, "g_thread_pool_get_max_idle_time", LIBS);
  gidLink(g_thread_pool_get_max_unused_threads, "g_thread_pool_get_max_unused_threads", LIBS);
  gidLink(g_thread_pool_get_num_unused_threads, "g_thread_pool_get_num_unused_threads", LIBS);
  gidLink(g_thread_pool_new, "g_thread_pool_new", LIBS);
  gidLink(g_thread_pool_new_full, "g_thread_pool_new_full", LIBS);
  gidLink(g_thread_pool_set_max_idle_time, "g_thread_pool_set_max_idle_time", LIBS);
  gidLink(g_thread_pool_set_max_unused_threads, "g_thread_pool_set_max_unused_threads", LIBS);
  gidLink(g_thread_pool_stop_unused_threads, "g_thread_pool_stop_unused_threads", LIBS);

  // TimeVal
  gidLink(g_time_val_add, "g_time_val_add", LIBS);
  gidLink(g_time_val_to_iso8601, "g_time_val_to_iso8601", LIBS);
  gidLink(g_time_val_from_iso8601, "g_time_val_from_iso8601", LIBS);

  // TimeZone
  gidLink(g_time_zone_get_type, "g_time_zone_get_type", LIBS);
  gidLink(g_time_zone_new, "g_time_zone_new", LIBS);
  gidLink(g_time_zone_new_identifier, "g_time_zone_new_identifier", LIBS);
  gidLink(g_time_zone_new_local, "g_time_zone_new_local", LIBS);
  gidLink(g_time_zone_new_offset, "g_time_zone_new_offset", LIBS);
  gidLink(g_time_zone_new_utc, "g_time_zone_new_utc", LIBS);
  gidLink(g_time_zone_adjust_time, "g_time_zone_adjust_time", LIBS);
  gidLink(g_time_zone_find_interval, "g_time_zone_find_interval", LIBS);
  gidLink(g_time_zone_get_abbreviation, "g_time_zone_get_abbreviation", LIBS);
  gidLink(g_time_zone_get_identifier, "g_time_zone_get_identifier", LIBS);
  gidLink(g_time_zone_get_offset, "g_time_zone_get_offset", LIBS);
  gidLink(g_time_zone_is_dst, "g_time_zone_is_dst", LIBS);
  gidLink(g_time_zone_ref, "g_time_zone_ref", LIBS);
  gidLink(g_time_zone_unref, "g_time_zone_unref", LIBS);

  // Timer
  gidLink(g_timer_continue, "g_timer_continue", LIBS);
  gidLink(g_timer_destroy, "g_timer_destroy", LIBS);
  gidLink(g_timer_elapsed, "g_timer_elapsed", LIBS);
  gidLink(g_timer_is_active, "g_timer_is_active", LIBS);
  gidLink(g_timer_reset, "g_timer_reset", LIBS);
  gidLink(g_timer_start, "g_timer_start", LIBS);
  gidLink(g_timer_stop, "g_timer_stop", LIBS);
  gidLink(g_timer_new, "g_timer_new", LIBS);

  // TrashStack
  gidLink(g_trash_stack_height, "g_trash_stack_height", LIBS);
  gidLink(g_trash_stack_peek, "g_trash_stack_peek", LIBS);
  gidLink(g_trash_stack_pop, "g_trash_stack_pop", LIBS);
  gidLink(g_trash_stack_push, "g_trash_stack_push", LIBS);

  // Tree
  gidLink(g_tree_get_type, "g_tree_get_type", LIBS);
  gidLink(g_tree_new, "g_tree_new", LIBS);
  gidLink(g_tree_new_full, "g_tree_new_full", LIBS);
  gidLink(g_tree_new_with_data, "g_tree_new_with_data", LIBS);
  gidLink(g_tree_destroy, "g_tree_destroy", LIBS);
  gidLink(g_tree_foreach, "g_tree_foreach", LIBS);
  gidLink(g_tree_foreach_node, "g_tree_foreach_node", LIBS);
  gidLink(g_tree_height, "g_tree_height", LIBS);
  gidLink(g_tree_insert, "g_tree_insert", LIBS);
  gidLink(g_tree_insert_node, "g_tree_insert_node", LIBS);
  gidLink(g_tree_lookup, "g_tree_lookup", LIBS);
  gidLink(g_tree_lookup_extended, "g_tree_lookup_extended", LIBS);
  gidLink(g_tree_lookup_node, "g_tree_lookup_node", LIBS);
  gidLink(g_tree_lower_bound, "g_tree_lower_bound", LIBS);
  gidLink(g_tree_nnodes, "g_tree_nnodes", LIBS);
  gidLink(g_tree_node_first, "g_tree_node_first", LIBS);
  gidLink(g_tree_node_last, "g_tree_node_last", LIBS);
  gidLink(g_tree_ref, "g_tree_ref", LIBS);
  gidLink(g_tree_remove, "g_tree_remove", LIBS);
  gidLink(g_tree_remove_all, "g_tree_remove_all", LIBS);
  gidLink(g_tree_replace, "g_tree_replace", LIBS);
  gidLink(g_tree_replace_node, "g_tree_replace_node", LIBS);
  gidLink(g_tree_search, "g_tree_search", LIBS);
  gidLink(g_tree_search_node, "g_tree_search_node", LIBS);
  gidLink(g_tree_steal, "g_tree_steal", LIBS);
  gidLink(g_tree_traverse, "g_tree_traverse", LIBS);
  gidLink(g_tree_unref, "g_tree_unref", LIBS);
  gidLink(g_tree_upper_bound, "g_tree_upper_bound", LIBS);

  // TreeNode
  gidLink(g_tree_node_key, "g_tree_node_key", LIBS);
  gidLink(g_tree_node_next, "g_tree_node_next", LIBS);
  gidLink(g_tree_node_previous, "g_tree_node_previous", LIBS);
  gidLink(g_tree_node_value, "g_tree_node_value", LIBS);

  // Tuples
  gidLink(g_tuples_destroy, "g_tuples_destroy", LIBS);
  gidLink(g_tuples_index, "g_tuples_index", LIBS);

  // Uri
  gidLink(g_uri_get_type, "g_uri_get_type", LIBS);
  gidLink(g_uri_get_auth_params, "g_uri_get_auth_params", LIBS);
  gidLink(g_uri_get_flags, "g_uri_get_flags", LIBS);
  gidLink(g_uri_get_fragment, "g_uri_get_fragment", LIBS);
  gidLink(g_uri_get_host, "g_uri_get_host", LIBS);
  gidLink(g_uri_get_password, "g_uri_get_password", LIBS);
  gidLink(g_uri_get_path, "g_uri_get_path", LIBS);
  gidLink(g_uri_get_port, "g_uri_get_port", LIBS);
  gidLink(g_uri_get_query, "g_uri_get_query", LIBS);
  gidLink(g_uri_get_scheme, "g_uri_get_scheme", LIBS);
  gidLink(g_uri_get_user, "g_uri_get_user", LIBS);
  gidLink(g_uri_get_userinfo, "g_uri_get_userinfo", LIBS);
  gidLink(g_uri_parse_relative, "g_uri_parse_relative", LIBS);
  gidLink(g_uri_ref, "g_uri_ref", LIBS);
  gidLink(g_uri_to_string, "g_uri_to_string", LIBS);
  gidLink(g_uri_to_string_partial, "g_uri_to_string_partial", LIBS);
  gidLink(g_uri_unref, "g_uri_unref", LIBS);
  gidLink(g_uri_build, "g_uri_build", LIBS);
  gidLink(g_uri_build_with_user, "g_uri_build_with_user", LIBS);
  gidLink(g_uri_error_quark, "g_uri_error_quark", LIBS);
  gidLink(g_uri_escape_bytes, "g_uri_escape_bytes", LIBS);
  gidLink(g_uri_escape_string, "g_uri_escape_string", LIBS);
  gidLink(g_uri_is_valid, "g_uri_is_valid", LIBS);
  gidLink(g_uri_join, "g_uri_join", LIBS);
  gidLink(g_uri_join_with_user, "g_uri_join_with_user", LIBS);
  gidLink(g_uri_list_extract_uris, "g_uri_list_extract_uris", LIBS);
  gidLink(g_uri_parse, "g_uri_parse", LIBS);
  gidLink(g_uri_parse_params, "g_uri_parse_params", LIBS);
  gidLink(g_uri_parse_scheme, "g_uri_parse_scheme", LIBS);
  gidLink(g_uri_peek_scheme, "g_uri_peek_scheme", LIBS);
  gidLink(g_uri_resolve_relative, "g_uri_resolve_relative", LIBS);
  gidLink(g_uri_split, "g_uri_split", LIBS);
  gidLink(g_uri_split_network, "g_uri_split_network", LIBS);
  gidLink(g_uri_split_with_user, "g_uri_split_with_user", LIBS);
  gidLink(g_uri_unescape_bytes, "g_uri_unescape_bytes", LIBS);
  gidLink(g_uri_unescape_segment, "g_uri_unescape_segment", LIBS);
  gidLink(g_uri_unescape_string, "g_uri_unescape_string", LIBS);

  // UriParamsIter
  gidLink(g_uri_params_iter_init, "g_uri_params_iter_init", LIBS);
  gidLink(g_uri_params_iter_next, "g_uri_params_iter_next", LIBS);

  // VariantBuilder
  gidLink(g_variant_builder_get_type, "g_variant_builder_get_type", LIBS);
  gidLink(g_variant_builder_new, "g_variant_builder_new", LIBS);
  gidLink(g_variant_builder_add, "g_variant_builder_add", LIBS);
  gidLink(g_variant_builder_add_parsed, "g_variant_builder_add_parsed", LIBS);
  gidLink(g_variant_builder_add_value, "g_variant_builder_add_value", LIBS);
  gidLink(g_variant_builder_clear, "g_variant_builder_clear", LIBS);
  gidLink(g_variant_builder_close, "g_variant_builder_close", LIBS);
  gidLink(g_variant_builder_end, "g_variant_builder_end", LIBS);
  gidLink(g_variant_builder_init, "g_variant_builder_init", LIBS);
  gidLink(g_variant_builder_open, "g_variant_builder_open", LIBS);
  gidLink(g_variant_builder_ref, "g_variant_builder_ref", LIBS);
  gidLink(g_variant_builder_unref, "g_variant_builder_unref", LIBS);

  // VariantDict
  gidLink(g_variant_dict_get_type, "g_variant_dict_get_type", LIBS);
  gidLink(g_variant_dict_new, "g_variant_dict_new", LIBS);
  gidLink(g_variant_dict_clear, "g_variant_dict_clear", LIBS);
  gidLink(g_variant_dict_contains, "g_variant_dict_contains", LIBS);
  gidLink(g_variant_dict_end, "g_variant_dict_end", LIBS);
  gidLink(g_variant_dict_init, "g_variant_dict_init", LIBS);
  gidLink(g_variant_dict_insert, "g_variant_dict_insert", LIBS);
  gidLink(g_variant_dict_insert_value, "g_variant_dict_insert_value", LIBS);
  gidLink(g_variant_dict_lookup, "g_variant_dict_lookup", LIBS);
  gidLink(g_variant_dict_lookup_value, "g_variant_dict_lookup_value", LIBS);
  gidLink(g_variant_dict_ref, "g_variant_dict_ref", LIBS);
  gidLink(g_variant_dict_remove, "g_variant_dict_remove", LIBS);
  gidLink(g_variant_dict_unref, "g_variant_dict_unref", LIBS);

  // VariantG
  gidLink(intern, "intern", LIBS);
  gidLink(g_variant_new, "g_variant_new", LIBS);
  gidLink(g_variant_new_array, "g_variant_new_array", LIBS);
  gidLink(g_variant_new_boolean, "g_variant_new_boolean", LIBS);
  gidLink(g_variant_new_byte, "g_variant_new_byte", LIBS);
  gidLink(g_variant_new_bytestring, "g_variant_new_bytestring", LIBS);
  gidLink(g_variant_new_bytestring_array, "g_variant_new_bytestring_array", LIBS);
  gidLink(g_variant_new_dict_entry, "g_variant_new_dict_entry", LIBS);
  gidLink(g_variant_new_double, "g_variant_new_double", LIBS);
  gidLink(g_variant_new_fixed_array, "g_variant_new_fixed_array", LIBS);
  gidLink(g_variant_new_from_bytes, "g_variant_new_from_bytes", LIBS);
  gidLink(g_variant_new_from_data, "g_variant_new_from_data", LIBS);
  gidLink(g_variant_new_handle, "g_variant_new_handle", LIBS);
  gidLink(g_variant_new_int16, "g_variant_new_int16", LIBS);
  gidLink(g_variant_new_int32, "g_variant_new_int32", LIBS);
  gidLink(g_variant_new_int64, "g_variant_new_int64", LIBS);
  gidLink(g_variant_new_maybe, "g_variant_new_maybe", LIBS);
  gidLink(g_variant_new_object_path, "g_variant_new_object_path", LIBS);
  gidLink(g_variant_new_objv, "g_variant_new_objv", LIBS);
  gidLink(g_variant_new_parsed, "g_variant_new_parsed", LIBS);
  gidLink(g_variant_new_parsed_va, "g_variant_new_parsed_va", LIBS);
  gidLink(g_variant_new_printf, "g_variant_new_printf", LIBS);
  gidLink(g_variant_new_signature, "g_variant_new_signature", LIBS);
  gidLink(g_variant_new_string, "g_variant_new_string", LIBS);
  gidLink(g_variant_new_strv, "g_variant_new_strv", LIBS);
  gidLink(g_variant_new_take_string, "g_variant_new_take_string", LIBS);
  gidLink(g_variant_new_tuple, "g_variant_new_tuple", LIBS);
  gidLink(g_variant_new_uint16, "g_variant_new_uint16", LIBS);
  gidLink(g_variant_new_uint32, "g_variant_new_uint32", LIBS);
  gidLink(g_variant_new_uint64, "g_variant_new_uint64", LIBS);
  gidLink(g_variant_new_va, "g_variant_new_va", LIBS);
  gidLink(g_variant_new_variant, "g_variant_new_variant", LIBS);
  gidLink(g_variant_byteswap, "g_variant_byteswap", LIBS);
  gidLink(g_variant_check_format_string, "g_variant_check_format_string", LIBS);
  gidLink(g_variant_classify, "g_variant_classify", LIBS);
  gidLink(g_variant_compare, "g_variant_compare", LIBS);
  gidLink(g_variant_dup_bytestring, "g_variant_dup_bytestring", LIBS);
  gidLink(g_variant_dup_bytestring_array, "g_variant_dup_bytestring_array", LIBS);
  gidLink(g_variant_dup_objv, "g_variant_dup_objv", LIBS);
  gidLink(g_variant_dup_string, "g_variant_dup_string", LIBS);
  gidLink(g_variant_dup_strv, "g_variant_dup_strv", LIBS);
  gidLink(g_variant_equal, "g_variant_equal", LIBS);
  gidLink(g_variant_get, "g_variant_get", LIBS);
  gidLink(g_variant_get_boolean, "g_variant_get_boolean", LIBS);
  gidLink(g_variant_get_byte, "g_variant_get_byte", LIBS);
  gidLink(g_variant_get_bytestring, "g_variant_get_bytestring", LIBS);
  gidLink(g_variant_get_bytestring_array, "g_variant_get_bytestring_array", LIBS);
  gidLink(g_variant_get_child, "g_variant_get_child", LIBS);
  gidLink(g_variant_get_child_value, "g_variant_get_child_value", LIBS);
  gidLink(g_variant_get_data, "g_variant_get_data", LIBS);
  gidLink(g_variant_get_data_as_bytes, "g_variant_get_data_as_bytes", LIBS);
  gidLink(g_variant_get_double, "g_variant_get_double", LIBS);
  gidLink(g_variant_get_fixed_array, "g_variant_get_fixed_array", LIBS);
  gidLink(g_variant_get_handle, "g_variant_get_handle", LIBS);
  gidLink(g_variant_get_int16, "g_variant_get_int16", LIBS);
  gidLink(g_variant_get_int32, "g_variant_get_int32", LIBS);
  gidLink(g_variant_get_int64, "g_variant_get_int64", LIBS);
  gidLink(g_variant_get_maybe, "g_variant_get_maybe", LIBS);
  gidLink(g_variant_get_normal_form, "g_variant_get_normal_form", LIBS);
  gidLink(g_variant_get_objv, "g_variant_get_objv", LIBS);
  gidLink(g_variant_get_size, "g_variant_get_size", LIBS);
  gidLink(g_variant_get_string, "g_variant_get_string", LIBS);
  gidLink(g_variant_get_strv, "g_variant_get_strv", LIBS);
  gidLink(g_variant_get_type, "g_variant_get_type", LIBS);
  gidLink(g_variant_get_type_string, "g_variant_get_type_string", LIBS);
  gidLink(g_variant_get_uint16, "g_variant_get_uint16", LIBS);
  gidLink(g_variant_get_uint32, "g_variant_get_uint32", LIBS);
  gidLink(g_variant_get_uint64, "g_variant_get_uint64", LIBS);
  gidLink(g_variant_get_va, "g_variant_get_va", LIBS);
  gidLink(g_variant_get_variant, "g_variant_get_variant", LIBS);
  gidLink(g_variant_hash, "g_variant_hash", LIBS);
  gidLink(g_variant_is_container, "g_variant_is_container", LIBS);
  gidLink(g_variant_is_floating, "g_variant_is_floating", LIBS);
  gidLink(g_variant_is_normal_form, "g_variant_is_normal_form", LIBS);
  gidLink(g_variant_is_of_type, "g_variant_is_of_type", LIBS);
  gidLink(g_variant_iter_new, "g_variant_iter_new", LIBS);
  gidLink(g_variant_lookup, "g_variant_lookup", LIBS);
  gidLink(g_variant_lookup_value, "g_variant_lookup_value", LIBS);
  gidLink(g_variant_n_children, "g_variant_n_children", LIBS);
  gidLink(g_variant_print, "g_variant_print", LIBS);
  gidLink(g_variant_print_string, "g_variant_print_string", LIBS);
  gidLink(g_variant_ref, "g_variant_ref", LIBS);
  gidLink(g_variant_ref_sink, "g_variant_ref_sink", LIBS);
  gidLink(g_variant_store, "g_variant_store", LIBS);
  gidLink(g_variant_take_ref, "g_variant_take_ref", LIBS);
  gidLink(g_variant_unref, "g_variant_unref", LIBS);
  gidLink(g_variant_is_object_path, "g_variant_is_object_path", LIBS);
  gidLink(g_variant_is_signature, "g_variant_is_signature", LIBS);
  gidLink(g_variant_parse, "g_variant_parse", LIBS);
  gidLink(g_variant_parse_error_print_context, "g_variant_parse_error_print_context", LIBS);
  gidLink(g_variant_parse_error_quark, "g_variant_parse_error_quark", LIBS);
  gidLink(g_variant_parser_get_error_quark, "g_variant_parser_get_error_quark", LIBS);

  // VariantIter
  gidLink(g_variant_iter_copy, "g_variant_iter_copy", LIBS);
  gidLink(g_variant_iter_free, "g_variant_iter_free", LIBS);
  gidLink(g_variant_iter_init, "g_variant_iter_init", LIBS);
  gidLink(g_variant_iter_loop, "g_variant_iter_loop", LIBS);
  gidLink(g_variant_iter_n_children, "g_variant_iter_n_children", LIBS);
  gidLink(g_variant_iter_next, "g_variant_iter_next", LIBS);
  gidLink(g_variant_iter_next_value, "g_variant_iter_next_value", LIBS);

  // VariantType
  gidLink(g_variant_type_get_gtype, "g_variant_type_get_gtype", LIBS);
  gidLink(g_variant_type_new, "g_variant_type_new", LIBS);
  gidLink(g_variant_type_new_array, "g_variant_type_new_array", LIBS);
  gidLink(g_variant_type_new_dict_entry, "g_variant_type_new_dict_entry", LIBS);
  gidLink(g_variant_type_new_maybe, "g_variant_type_new_maybe", LIBS);
  gidLink(g_variant_type_new_tuple, "g_variant_type_new_tuple", LIBS);
  gidLink(g_variant_type_copy, "g_variant_type_copy", LIBS);
  gidLink(g_variant_type_dup_string, "g_variant_type_dup_string", LIBS);
  gidLink(g_variant_type_element, "g_variant_type_element", LIBS);
  gidLink(g_variant_type_equal, "g_variant_type_equal", LIBS);
  gidLink(g_variant_type_first, "g_variant_type_first", LIBS);
  gidLink(g_variant_type_free, "g_variant_type_free", LIBS);
  gidLink(g_variant_type_get_string_length, "g_variant_type_get_string_length", LIBS);
  gidLink(g_variant_type_hash, "g_variant_type_hash", LIBS);
  gidLink(g_variant_type_is_array, "g_variant_type_is_array", LIBS);
  gidLink(g_variant_type_is_basic, "g_variant_type_is_basic", LIBS);
  gidLink(g_variant_type_is_container, "g_variant_type_is_container", LIBS);
  gidLink(g_variant_type_is_definite, "g_variant_type_is_definite", LIBS);
  gidLink(g_variant_type_is_dict_entry, "g_variant_type_is_dict_entry", LIBS);
  gidLink(g_variant_type_is_maybe, "g_variant_type_is_maybe", LIBS);
  gidLink(g_variant_type_is_subtype_of, "g_variant_type_is_subtype_of", LIBS);
  gidLink(g_variant_type_is_tuple, "g_variant_type_is_tuple", LIBS);
  gidLink(g_variant_type_is_variant, "g_variant_type_is_variant", LIBS);
  gidLink(g_variant_type_key, "g_variant_type_key", LIBS);
  gidLink(g_variant_type_n_items, "g_variant_type_n_items", LIBS);
  gidLink(g_variant_type_next, "g_variant_type_next", LIBS);
  gidLink(g_variant_type_peek_string, "g_variant_type_peek_string", LIBS);
  gidLink(g_variant_type_value, "g_variant_type_value", LIBS);
  gidLink(g_variant_type_checked_, "g_variant_type_checked_", LIBS);
  gidLink(g_variant_type_string_get_depth_, "g_variant_type_string_get_depth_", LIBS);
  gidLink(g_variant_type_string_is_valid, "g_variant_type_string_is_valid", LIBS);
  gidLink(g_variant_type_string_scan, "g_variant_type_string_scan", LIBS);
}
