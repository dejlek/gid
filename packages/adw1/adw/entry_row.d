...
class EntryRow : adw.preferences_row.PreferencesRow, gtk.editable.Editable
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B entryRow) the instance the signal is connected to
    )
  */
  alias ApplyCallbackDlg = void delegate(adw.entry_row.EntryRow entryRow);

  /** ditto */
  alias ApplyCallbackFunc = void function(adw.entry_row.EntryRow entryRow);
  ...
  */
  ...
  if (is(T : ApplyCallbackDlg) || is(T : ApplyCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto entryRow = getVal!(adw.entry_row.EntryRow)(_paramVals);
      _dClosure.dlg(entryRow);
    }
  ...
  */
  alias EntryActivatedCallbackDlg = void delegate(adw.entry_row.EntryRow entryRow);

  /** ditto */
  alias EntryActivatedCallbackFunc = void function(adw.entry_row.EntryRow entryRow);
  ...
  */
  ...
  if (is(T : EntryActivatedCallbackDlg) || is(T : EntryActivatedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
