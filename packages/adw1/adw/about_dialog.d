...
class AboutDialog : adw.dialog.Dialog
{
  ...
  */
  alias ActivateLinkCallbackDlg = bool delegate(string uri, adw.about_dialog.AboutDialog aboutDialog);

  /** ditto */
  alias ActivateLinkCallbackFunc = bool function(string uri, adw.about_dialog.AboutDialog aboutDialog);
  ...
  */
  ...
  if (is(T : ActivateLinkCallbackDlg) || is(T : ActivateLinkCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto aboutDialog = getVal!(adw.about_dialog.AboutDialog)(_paramVals);
