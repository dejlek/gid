...
class NavigationView : gtk.widget.Widget, adw.swipeable.Swipeable
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B navigationView) the instance the signal is connected to
    )
    Returns:     the page to push
  */
  alias GetNextPageCallbackDlg = adw.navigation_page.NavigationPage delegate(adw.navigation_view.NavigationView navigationView);

  /** ditto */
  alias GetNextPageCallbackFunc = adw.navigation_page.NavigationPage function(adw.navigation_view.NavigationView navigationView);
  ...
  */
  ...
  if (is(T : GetNextPageCallbackDlg) || is(T : GetNextPageCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto navigationView = getVal!(adw.navigation_view.NavigationView)(_paramVals);
      auto _retval = _dClosure.dlg(navigationView);
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B page)       the popped page
      * $(B navigationView) the instance the signal is connected to
    )
  */
  alias PoppedCallbackDlg = void delegate(adw.navigation_page.NavigationPage page, adw.navigation_view.NavigationView navigationView);

  /** ditto */
  alias PoppedCallbackFunc = void function(adw.navigation_page.NavigationPage page, adw.navigation_view.NavigationView navigationView);
  ...
  */
  ...
  if (is(T : PoppedCallbackDlg) || is(T : PoppedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto navigationView = getVal!(adw.navigation_view.NavigationView)(_paramVals);
      auto page = getVal!(adw.navigation_page.NavigationPage)(&_paramVals[1]);
      _dClosure.dlg(page, navigationView);
    }
  ...
  */
  alias PushedCallbackDlg = void delegate(adw.navigation_view.NavigationView navigationView);

  /** ditto */
  alias PushedCallbackFunc = void function(adw.navigation_view.NavigationView navigationView);
  ...
  */
  ...
  if (is(T : PushedCallbackDlg) || is(T : PushedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
  ...
  */
  alias ReplacedCallbackDlg = void delegate(adw.navigation_view.NavigationView navigationView);

  /** ditto */
  alias ReplacedCallbackFunc = void function(adw.navigation_view.NavigationView navigationView);
  ...
  */
  ...
  if (is(T : ReplacedCallbackDlg) || is(T : ReplacedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
