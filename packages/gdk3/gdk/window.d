...
class Window : gobject.object.ObjectG
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B width)       the width of the offscreen surface to create
      * $(B height)       the height of the offscreen surface to create
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B flippedRect)       the position of window after any possible
                       flipping or null if the backend can't obtain it
      * $(B finalRect)       the final position of window or null if the
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B x)       x coordinate in the window
      * $(B y)       y coordinate in the window
      * $(B window) the instance the signal is connected to
    )
