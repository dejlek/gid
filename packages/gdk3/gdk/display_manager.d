...
class DisplayManager : gobject.object.ObjectG
{
   ...
   * of the supported GDK backends to use $(LPAREN)in case GDK has been compiled
   * with multiple backends$(RPAREN). Applications can use [gdk.global.setAllowedBackends]
