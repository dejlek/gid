...
__gshared extern(C)
{
  ...
  // ColorBalance
  extern(C) GType function() c_gst_color_balance_get_type;
  ...
  // ColorBalanceChannel
  extern(C) GType function() c_gst_color_balance_channel_get_type;

  // Navigation
  extern(C) GType function() c_gst_navigation_get_type;
  ...
  extern(C) GType function() c_gst_video_aggregator_parallel_convert_pad_get_type;
  ...
  // VideoBufferPool
  extern(C) GType function() c_gst_video_buffer_pool_get_type;
  ...
  // VideoCodecFrame
  extern(C) GType function() c_gst_video_codec_frame_get_type;
  ...
  // VideoCodecState
  extern(C) GType function() c_gst_video_codec_state_get_type;
  ...
  // VideoDecoder
  extern(C) GType function() c_gst_video_decoder_get_type;
  ...
  // VideoDirection
  extern(C) GType function() c_gst_video_direction_get_type;
  ...
  // VideoEncoder
  extern(C) GType function() c_gst_video_encoder_get_type;
  ...
  // VideoFilter
  extern(C) GType function() c_gst_video_filter_get_type;
  ...
  // VideoInfo
  extern(C) GType function() c_gst_video_info_get_type;
  ...
  // VideoInfoDmaDrm
  extern(C) GType function() c_gst_video_info_dma_drm_get_type;
  ...
  extern(C) GType function() c_gst_video_multiview_flagset_get_type;

  // VideoOrientation
  extern(C) GType function() c_gst_video_orientation_get_type;
  ...
  // VideoOverlay
  extern(C) GType function() c_gst_video_overlay_get_type;
  ...
  extern(C) GType function() c_gst_video_overlay_composition_get_type;
  ...
  extern(C) GType function() c_gst_video_overlay_rectangle_get_type;
  ...
  // VideoSink
  extern(C) GType function() c_gst_video_sink_get_type;
  ...
  // VideoTimeCode
  extern(C) GType function() c_gst_video_time_code_get_type;
  ...
  extern(C) GType function() c_gst_video_time_code_interval_get_type;
  ...
  // VideoVBIEncoder
  extern(C) GType function() c_gst_video_vbi_encoder_get_type;
  ...
  // VideoVBIParser
  extern(C) GType function() c_gst_video_vbi_parser_get_type;
