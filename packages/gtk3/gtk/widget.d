...
class Widget : gobject.initially_unowned.InitiallyUnowned, atk.implementor_iface.ImplementorIface, gtk.buildable.Buildable
{
  ...
  /**
    ...
    $(LIST
      * $(B event)       the #GdkEventButton which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B signalId)       the ID of a signal installed on widget
      * $(B widget) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B childProperty)       the #GParamSpec of the changed child property
      * $(B widget) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventConfigure which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventExpose event
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
        false to propagate the event further.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the event which triggered this signal
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
        false to propagate the event further.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B previousDirection)       the previous text direction of widget
      * $(B widget) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B context)       the drag context
      * $(B data)       the #GtkSelectionData to be filled with the dragged data
      * $(B info)       the info that has been registered with the target in the
               #GtkTargetList
      * $(B time)       the timestamp at which the data was requested
      * $(B widget) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B context)       the drag context
      * $(B x)       where the drop happened
      * $(B y)       where the drop happened
      * $(B data)       the received data
      * $(B info)       the info that has been registered with the target in the
               #GtkTargetList
      * $(B time)       the timestamp at which the data was received
      * $(B widget) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B context)       the drag context
      * $(B x)       the x coordinate of the current cursor position
      * $(B y)       the y coordinate of the current cursor position
      * $(B time)       the timestamp of the motion event
      * $(B widget) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B context)       the drag context
      * $(B result)       the result of the drag operation
      * $(B widget) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B cr)       the cairo context to draw to
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
      false to propagate the event further.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventCrossing which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEvent which triggered this signal
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventFocus which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventFocus which triggered this
          signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventGrabBroken event
      * $(B widget) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B wasGrabbed)       false if the widget becomes shadowed, true
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B previousToplevel)       the previous toplevel ancestor, or null
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventKey which triggered this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
        false to propagate the event further.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B direction)       the direction of movement
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true if stopping keyboard navigation is fine, false
               if the emitting widget should try to handle the keyboard
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventAny which triggered this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
        false to propagate the event further.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B groupCycling)       true if there are other widgets with the same mnemonic
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
      false to propagate the event further.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventMotion which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B oldParent)       the previous parent, or null if the widget
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventProperty which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventProximity which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B x)       the x coordinate of the cursor position where the request has
            been emitted, relative to widget's left side
      * $(B y)       the y coordinate of the cursor position where the request has
            been emitted, relative to widget's top
      * $(B keyboardMode)       true if the tooltip was triggered using the keyboard
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B previousScreen)       the previous screen, or null if the
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventSelection which triggered
          this signal.
      * $(B widget) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the event.
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B flags)       The previous state flags.
      * $(B widget) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B previousStyle)       the previous style, or null if the widget
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventVisibility which
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B event)       the #GdkEventWindowState which
          triggered this signal.
      * $(B widget) the instance the signal is connected to
    )
