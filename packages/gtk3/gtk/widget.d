 ...
 * - #GtkWidgetClass.get_request_mode$(LPAREN)$(RPAREN)
 * - #GtkWidgetClass.get_preferred_width$(LPAREN)$(RPAREN)
 * - #GtkWidgetClass.get_preferred_height$(LPAREN)$(RPAREN)
 * - #GtkWidgetClass.get_preferred_height_for_width$(LPAREN)$(RPAREN)
 * - #GtkWidgetClass.get_preferred_width_for_height$(LPAREN)$(RPAREN)
 * - #GtkWidgetClass.get_preferred_height_and_baseline_for_width$(LPAREN)$(RPAREN)
 ...
 * $(LPAREN)unless [gtk.window.Window.setGeometryHints] is explicitly used instead$(RPAREN).
 * After the toplevel window has initially requested its size in both
 * dimensions it can go on to allocate itself a reasonable size $(LPAREN)or a size
 * previously specified with [gtk.window.Window.setDefaultSize]$(RPAREN). During the
 ...
 * will not expect to have #GtkWidgetClass.get_preferred_height$(LPAREN)$(RPAREN) called
 ...
 * generally deals with width-for-height requests, for #GtkWidgetClass.get_preferred_height$(LPAREN)$(RPAREN)
 * it will do:
 * |[<!-- language\="C" -->
 * static void
 * foo_widget_get_preferred_height $(LPAREN)GtkWidget *widget,
 * gint *min_height,
 * gint *nat_height$(RPAREN)
 * {
 * if $(LPAREN)i_am_in_height_for_width_mode$(RPAREN)
 * {
 * gint min_width, nat_width;
 * GTK_WIDGET_GET_CLASS $(LPAREN)widget$(RPAREN)->get_preferred_width $(LPAREN)widget,
 * &min_width,
 * &nat_width$(RPAREN);
 * GTK_WIDGET_GET_CLASS $(LPAREN)widget$(RPAREN)->get_preferred_height_for_width
 * $(LPAREN)widget,
 * min_width,
 * min_height,
 * nat_height$(RPAREN);
 ...
 * }
 * ]|
 * And in #GtkWidgetClass.get_preferred_width_for_height$(LPAREN)$(RPAREN) it will simply return
 * the minimum and natural width:
 * |[<!-- language\="C" -->
 * static void
 * foo_widget_get_preferred_width_for_height $(LPAREN)GtkWidget *widget,
 * gint for_height,
 * gint *min_width,
 * gint *nat_width$(RPAREN)
 * {
 * if $(LPAREN)i_am_in_height_for_width_mode$(RPAREN)
 * {
 * GTK_WIDGET_GET_CLASS $(LPAREN)widget$(RPAREN)->get_preferred_width $(LPAREN)widget,
 ...
 * width-for-height mode $(LPAREN)like a rotated GtkLabel$(RPAREN) it can go
 ...
 * and by the #GtkWidgetClass.adjust_size_request$(LPAREN)$(RPAREN) virtual method. If a
 ...
 * Baseline alignment support for a widget is done by the #GtkWidgetClass.get_preferred_height_and_baseline_for_width$(LPAREN)$(RPAREN)
 * virtual function. It allows you to report a baseline in combination with the
 * minimum and natural height. If there is no baseline you can return -1 to indicate
 * this. The default implementation of this virtual function calls into the
 * #GtkWidgetClass.get_preferred_height$(LPAREN)$(RPAREN) and #GtkWidgetClass.get_preferred_height_for_width$(LPAREN)$(RPAREN),
 * so if baselines are not supported it doesn’t need to be implemented.
 * If a widget ends up baseline aligned it will be allocated all the space in the parent
 * as if it was %GTK_ALIGN_FILL, but the selected baseline can be found via [gtk.widget.Widget.getAllocatedBaseline].
 ...
 * gtk_widget_class_bind_template_child_private$(LPAREN)$(RPAREN) with that name, e.g.
 * |[<!-- language\="C" -->
 * typedef struct {
 ...
 * }
 * ]|
 * You can also use gtk_widget_class_bind_template_callback$(LPAREN)$(RPAREN) to connect a signal
...
class Widget : gobject.initially_unowned.InitiallyUnowned, atk.implementor_iface.ImplementorIface, gtk.buildable.Buildable
{
   ...
   * container. Composite children aren’t treated differently by GTK+ $(LPAREN)but
   * see [gtk.container.Container.foreach_] vs. [gtk.container.Container.forall]$(RPAREN), but e.g. GUI
  ...
  {
    gtk_widget_add_events(cast(GtkWidget*)cPtr, events);
  }

  /**
   * Adds a widget to the list of mnemonic labels for
   * this widget. $(LPAREN)See [gtk.widget.Widget.listMnemonicLabels]$(RPAREN). Note the
   ...
   * called frequently $(LPAREN)usually at the frame rate of the output device
   * or as quickly as the application can be repainted, whichever is
   * slower$(RPAREN). For this reason, is most suitable for handling graphics
   * that change every frame or every few frames. The tick callback does
   * not automatically imply a relayout or repaint. If you want a
   * repaint or relayout, and aren’t changing widget properties that
   * would trigger that $(LPAREN)for example, changing the text of a #GtkLabel$(RPAREN),
  ...
  {
    bool _retval;
    _retval = gtk_widget_can_activate_accel(cast(GtkWidget*)cPtr, signalId);
    return _retval;
  }
   ...
   * what kind of motion is taking place $(LPAREN)up, down, left, right, tab
   * forward, tab backward$(RPAREN). [gtk.widget.Widget.childFocus] emits the
   ...
   * on widget.
   * This is the analogue of [gobject.object.ObjectG.notify] for child properties.
   ...
   * #GtkContainerClass.remove$(LPAREN)$(RPAREN) virtual function for that.
   * It's important to notice that [gtk.widget.Widget.destroy] will only cause
   * the widget to be finalized if no additional references, acquired
   * using [gobject.object.ObjectG.ref_], are held on it. In case additional references
  ...
  void destroy()
  {
    gtk_widget_destroy(cast(GtkWidget*)cPtr);
  }
   ...
   * Params:
   *   targets = The targets $(LPAREN)data formats$(RPAREN) in which the
   ...
   * $(LPAREN)remember to free the event with [gdk.event.Event.free] when you are done$(RPAREN).
  ...
  /**
   * Checks to see if a mouse drag starting at $(LPAREN)start_x, start_y$(RPAREN) and ending
   * at $(LPAREN)current_x, current_y$(RPAREN) has passed the GTK+ drag threshold, and thus
  ...
  {
    gtk_drag_dest_add_image_targets(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_drag_dest_add_text_targets(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_drag_dest_add_uri_targets(cast(GtkWidget*)cPtr);
  }
   ...
   *     gtk_drag_dest_get_target_list $(LPAREN)widget$(RPAREN).
  ...
  {
    bool _retval;
    _retval = gtk_drag_dest_get_track_motion(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * $(LPAREN)#GtkWidget::drag-motion, #GtkWidget::drag-drop, ...$(RPAREN). They all exist
   ...
   * |[<!-- language\="C" -->
   * static void
   * drag_motion $(LPAREN)GtkWidget *widget,
   ...
   * gdk_window_get_pointer $(LPAREN)gtk_widget_get_window $(LPAREN)widget$(RPAREN),
   * NULL, NULL, &mask$(RPAREN);
   * if $(LPAREN)mask & GDK_CONTROL_MASK$(RPAREN)
   * gdk_drag_status $(LPAREN)context, GDK_ACTION_COPY, time$(RPAREN);
   * else
   * gdk_drag_status $(LPAREN)context, GDK_ACTION_MOVE, time$(RPAREN);
   * }
   * ]|
   * Params:
  ...
  void dragDestSet(gtk.types.DestDefaults flags, gtk.target_entry.TargetEntry[] targets, gdk.types.DragAction actions)
  {
    ...
    gtk_drag_dest_set(cast(GtkWidget*)cPtr, flags, _targets, _nTargets, actions);
  }
   ...
   *     $(LPAREN)You can use gdk_drag_get_protocol$(LPAREN)$(RPAREN) to determine this$(RPAREN)
  ...
  {
    gtk_drag_dest_set_track_motion(cast(GtkWidget*)cPtr, trackMotion);
  }
  ...
  void dragDestUnset()
  {
    gtk_drag_dest_unset(cast(GtkWidget*)cPtr);
  }
   ...
   *   target = the target $(LPAREN)form of the data$(RPAREN) to retrieve
  ...
  void dragHighlight()
  {
    gtk_drag_highlight(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_drag_source_add_image_targets(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_drag_source_add_text_targets(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_drag_source_add_uri_targets(cast(GtkWidget*)cPtr);
  }
  ...
  void dragSourceSet(gdk.types.ModifierType startButtonMask, gtk.target_entry.TargetEntry[] targets, gdk.types.DragAction actions)
  {
    ...
    foreach (obj; targets)
      _tmptargets ~= *cast(GtkTargetEntry*)obj.cPtr;
    const(GtkTargetEntry)* _targets = _tmptargets.ptr;
    gtk_drag_source_set(cast(GtkWidget*)cPtr, startButtonMask, _targets, _nTargets, actions);
  }
  ...
  {
    gtk_drag_source_unset(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_drag_unhighlight(cast(GtkWidget*)cPtr);
  }
  ...
  /**
   * Ensures that widget has a style $(LPAREN)widget->style$(RPAREN).
  ...
  void ensureStyle()
  {
    gtk_widget_ensure_style(cast(GtkWidget*)cPtr);
  }
   ...
   * the event signals on a widget $(LPAREN)those signals should never
   * be emitted without using this function to do so$(RPAREN).
   ...
   * Params:
   *   event = a #GdkEvent
   * Returns: return from the event signal emission $(LPAREN)%TRUE if
   *   the event was handled$(RPAREN)
   */
  bool event(gdk.event.Event event)
  {
    bool _retval;
    _retval = gtk_widget_event(cast(GtkWidget*)cPtr, event ? cast(GdkEvent*)event.cPtr : null);
    return _retval;
  }
   ...
   * on widget.
   * This is the analogue of [gobject.object.ObjectG.freezeNotify] for child properties.
   */
  void freezeChildNotify()
  {
    gtk_widget_freeze_child_notify(cast(GtkWidget*)cPtr);
  }
   ...
   */
  atk.object.ObjectAtk getAccessible()
  {
    AtkObject* _cretval;
   ...
   * `gtk_widget_get_ancestor $(LPAREN)widget, GTK_TYPE_BOX$(RPAREN)` gets
  ...
  {
    bool _retval;
    _retval = gtk_widget_get_app_paintable(cast(GtkWidget*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_widget_get_can_default(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * geometry on the widget $(LPAREN)e.g. with [gtk.widget.Widget.setSizeRequest]$(RPAREN),
  ...
  {
    bool _retval;
    _retval = gtk_widget_get_double_buffered(cast(GtkWidget*)cPtr);
    return _retval;
  }

  /**
   * Returns the event mask $(LPAREN)see #GdkEventMask$(RPAREN) for the widget. These are the
  ...
  {
    int _retval;
    _retval = gtk_widget_get_events(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * frame$(RPAREN). [gtk.widget.Widget.queueDraw] will also end up requesting a frame
  ...
  {
    bool _retval;
    _retval = gtk_widget_get_has_window(cast(GtkWidget*)cPtr);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = gtk_widget_get_margin_left(cast(GtkWidget*)cPtr);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = gtk_widget_get_margin_right(cast(GtkWidget*)cPtr);
    return _retval;
  }
  ...
  gdk.types.ModifierType getModifierMask(gdk.types.ModifierIntent intent)
  {
    ...
    _cretval = gtk_widget_get_modifier_mask(cast(GtkWidget*)cPtr, intent);
    gdk.types.ModifierType _retval = cast(gdk.types.ModifierType)_cretval;
    return _retval;
  }

  /**
   * Returns the current modifier style for the widget. $(LPAREN)As set by
   * [gtk.widget.Widget.modifyStyle].$(RPAREN) If no style has previously set, a new
  ...
  {
    bool _retval;
    _retval = gtk_widget_get_no_show_all(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * the widget $(LPAREN)it can be used until the screen for the widget changes
   * or the widget is removed from its toplevel$(RPAREN), and will be updated to
  ...
  {
    gtk_widget_get_pointer(cast(GtkWidget*)cPtr, cast(int*)&x, cast(int*)&y);
  }
  ...
  {
    gtk_widget_get_preferred_height(cast(GtkWidget*)cPtr, cast(int*)&minimumHeight, cast(int*)&naturalHeight);
  }
  ...
  {
    gtk_widget_get_preferred_height_and_baseline_for_width(cast(GtkWidget*)cPtr, width, cast(int*)&minimumHeight, cast(int*)&naturalHeight, cast(int*)&minimumBaseline, cast(int*)&naturalBaseline);
  }
  ...
  {
    gtk_widget_get_preferred_height_for_width(cast(GtkWidget*)cPtr, width, cast(int*)&minimumHeight, cast(int*)&naturalHeight);
  }
  ...
  {
    gtk_widget_get_preferred_width(cast(GtkWidget*)cPtr, cast(int*)&minimumWidth, cast(int*)&naturalWidth);
  }
  ...
  {
    gtk_widget_get_preferred_width_for_height(cast(GtkWidget*)cPtr, height, cast(int*)&minimumWidth, cast(int*)&naturalWidth);
  }
   ...
   * changed after some internal state change $(LPAREN)so that they can call
   * [gtk.widget.Widget.queueResize] instead of [gtk.widget.Widget.queueDraw]$(RPAREN).
   ...
   * high density outputs, it can be a higher value $(LPAREN)typically 2$(RPAREN).
  ...
  /**
   * Returns the widget’s sensitivity $(LPAREN)in the sense of returning
   * the value that has been set using [gtk.widget.Widget.setSensitive]$(RPAREN).
  ...
  gtk.types.StateType getState()
  {
    ...
    _cretval = gtk_widget_get_state(cast(GtkWidget*)cPtr);
  ...
  {
    bool _retval;
    _retval = gtk_widget_get_support_multidevice(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * `gtk_widget_get_ancestor $(LPAREN)widget, GTK_TYPE_WINDOW$(RPAREN)`
   * would return
   ...
   * |[<!-- language\="C" -->
   * static const char *
   * get_widget_toplevel_title $(LPAREN)GtkWidget *widget$(RPAREN)
   * {
   * GtkWidget *toplevel \= gtk_widget_get_toplevel $(LPAREN)widget$(RPAREN);
   * if $(LPAREN)GTK_IS_WINDOW $(LPAREN)toplevel$(RPAREN)$(RPAREN)
   * {
   * return gtk_window_get_title $(LPAREN)GTK_WINDOW $(LPAREN)toplevel$(RPAREN)$(RPAREN);
   * }
   * return NULL;
   * }
   * ]|
   ...
   * `g_object_get $(LPAREN)widget, "valign", &value, NULL$(RPAREN)`, which will
  ...
  {
    GtkAlign _cretval;
    _cretval = gtk_widget_get_valign_with_baseline(cast(GtkWidget*)cPtr);
    gtk.types.Align _retval = cast(gtk.types.Align)_cretval;
    return _retval;
  }
  ...
  void grabAdd()
  {
    gtk_grab_add(cast(GtkWidget*)cPtr);
  }
  ...
  void grabDefault()
  {
    gtk_widget_grab_default(cast(GtkWidget*)cPtr);
  }
  ...
  void grabFocus()
  {
    gtk_widget_grab_focus(cast(GtkWidget*)cPtr);
  }
  ...
  void grabRemove()
  {
    gtk_grab_remove(cast(GtkWidget*)cPtr);
  }
   ...
   * is the only widget receiving input events $(LPAREN)keyboard and mouse$(RPAREN).
  ...
  {
    bool _retval;
    _retval = gtk_widget_has_grab(cast(GtkWidget*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_widget_has_rc_style(cast(GtkWidget*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_widget_has_screen(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * hidden $(LPAREN)invisible to the user$(RPAREN).
   */
  void hide()
  {
   ...
   * result is that clicking the close button for a window $(LPAREN)on the
   * window frame, top right corner usually$(RPAREN) will hide but not destroy
  ...
  {
    bool _retval;
    _retval = gtk_widget_hide_on_delete(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * initializers.
   * Another reason is that when calling [gobject.object.ObjectG.new_] on a widget with
   * composite templates, it’s important to build the composite widgets
   * before the construct properties are set. Properties passed to [gobject.object.ObjectG.new_]
   ...
   * window in its hierarchy $(LPAREN)as set by [gdk.window.Window.setComposited]$(RPAREN).
  ...
  {
    bool _retval;
    _retval = gtk_widget_is_composited(cast(GtkWidget*)cPtr);
    return _retval;
  }
   ...
   * toplevel. $(LPAREN)This does not mean that the #GtkWidget:has-focus property is
   * necessarily set; #GtkWidget:has-focus will only be set if the
   * toplevel widget additionally has the global input focus.$(RPAREN)
   ...
   * Currently only #GtkWindow and #GtkInvisible $(LPAREN)and out-of-process
   * #GtkPlugs$(RPAREN) are toplevel widgets. Toplevel widgets have no parent
   * widget.
  ...
  {
    bool _retval;
    _retval = gtk_widget_is_toplevel(cast(GtkWidget*)cPtr);
    return _retval;
  }
  ...
  {
    GList* _cretval;
    _cretval = gtk_widget_list_accel_closures(cast(GtkWidget*)cPtr);
  ...
  {
    const(char*)* _cretval;
    _cretval = gtk_widget_list_action_prefixes(cast(GtkWidget*)cPtr);
    string[] _retval;
   ...
   * which this widget is the target of a mnemonic $(LPAREN)see for example,
   * [gtk.label.Label.setMnemonicWidget]$(RPAREN).
   * The widgets in the list are not individually referenced. If you
   * want to iterate through the list and perform actions involving
   * callbacks that might destroy the widgets, you
   * must call `g_list_foreach $(LPAREN)result,
   * $(LPAREN)GFunc$(RPAREN)g_object_ref, NULL$(RPAREN)` first, and then unref all the
   * widgets afterwards.
   * Returns: the list of
   ...
   * $(LPAREN)see [gtk.widget.Widget.modifyText]$(RPAREN) for widgets such as #GtkEntry
   * and #GtkTextView. See also [gtk.widget.Widget.modifyStyle].
   * > Note that “no window” widgets $(LPAREN)which have the %GTK_NO_WINDOW
   * > flag set$(RPAREN) draw on their parent container’s window and thus may
   ...
   *   color = the color to assign $(LPAREN)does not need to
   *     be allocated$(RPAREN), or %NULL to undo the effect of previous
   ...
   *   color = the color to assign $(LPAREN)does not need
   *     to be allocated$(RPAREN), or %NULL to undo the effect of previous
   ...
   * See also [gtk.widget.Widget.modifyStyle].
   * Params:
   *   primary = the color to use for primary cursor $(LPAREN)does not
   *     need to be allocated$(RPAREN), or %NULL to undo the effect of previous
   *     calls to of [gtk.widget.Widget.modifyCursor].
   *   secondary = the color to use for secondary cursor $(LPAREN)does
   *     not need to be allocated$(RPAREN), or %NULL to undo the effect of
   ...
   *   color = the color to assign $(LPAREN)does not need to be allocated$(RPAREN),
   ...
   * base color $(LPAREN)see [gtk.widget.Widget.modifyBase]$(RPAREN) for widgets such
   ...
   * results $(LPAREN)such as uniform background color everywhere$(RPAREN), in
   ...
   * Params:
   *   cursor = the color to use for primary cursor $(LPAREN)does not need to be
   *     allocated$(RPAREN), or %NULL to undo the effect of previous calls to
   *     of [gtk.widget.Widget.overrideCursor].
   *   secondaryCursor = the color to use for secondary cursor $(LPAREN)does not
   *     need to be allocated$(RPAREN), or %NULL to undo the effect of previous
   ...
   * widget by default $(LPAREN)e.g. “GtkButton”$(RPAREN) or can be set to an
  ...
  {
    gtk_widget_queue_compute_expand(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_widget_queue_draw_area(cast(GtkWidget*)cPtr, x, y, width, height);
  }

  /**
   * Invalidates the area of widget defined by region by calling
   * [gdk.window.Window.invalidateRegion] on the widget’s window and all its
   * child windows. Once the main loop becomes idle $(LPAREN)after the current
   * batch of events has been processed, roughly$(RPAREN), the window will
  ...
  {
    gtk_widget_queue_resize_no_redraw(cast(GtkWidget*)cPtr);
  }

  /**
   * Creates the GDK $(LPAREN)windowing system$(RPAREN) resources associated with a
   ...
   * #GtkWidget::draw. Or simply g_signal_connect $(LPAREN)$(RPAREN) to the
   ...
   * this widget. $(LPAREN)See [gtk.widget.Widget.listMnemonicLabels]$(RPAREN). The widget
   ...
   * freed after use with [gobject.object.ObjectG.unref].
   * Params:
   *   stockId = a stock ID
   *   size = a stock size $(LPAREN)#GtkIconSize$(RPAREN). A size of `$(LPAREN)GtkIconSize$(RPAREN)-1`
   *     means render at the size of the source and don’t scale $(LPAREN)if there are
   *     multiple source sizes, GTK+ picks one of the available sizes$(RPAREN).
   ...
   * after use with [gobject.object.ObjectG.unref].
   * Params:
   *   stockId = a stock ID
   *   size = a stock size $(LPAREN)#GtkIconSize$(RPAREN). A size of `$(LPAREN)GtkIconSize$(RPAREN)-1`
   *     means render at the size of the source and don’t scale $(LPAREN)if there are
  ...
  void resetRcStyles()
  {
    gtk_widget_reset_rc_styles(cast(GtkWidget*)cPtr);
  }
  ...
  void resetStyle()
  {
    gtk_widget_reset_style(cast(GtkWidget*)cPtr);
  }
   ...
   * event to a windowless child widget $(LPAREN)[gtk.widget.Widget.getHasWindow] is %FALSE$(RPAREN),
  ...
  {
    int _retval;
    _retval = gtk_widget_send_expose(cast(GtkWidget*)cPtr, event ? cast(GdkEvent*)event.cPtr : null);
    return _retval;
  }
   ...
   * |[<!-- language\="C" -->
   * GdkEvent *fevent \= gdk_event_new $(LPAREN)GDK_FOCUS_CHANGE$(RPAREN);
   * fevent->focus_change.type \= GDK_FOCUS_CHANGE;
   * fevent->focus_change.in \= TRUE;
   * fevent->focus_change.window \= _gtk_widget_get_window $(LPAREN)widget$(RPAREN);
   * if $(LPAREN)fevent->focus_change.window !\= NULL$(RPAREN)
   * g_object_ref $(LPAREN)fevent->focus_change.window$(RPAREN);
   * gtk_widget_send_focus_change $(LPAREN)widget, fevent$(RPAREN);
   * gdk_event_free $(LPAREN)event$(RPAREN);
   * ]|
   * Params:
  ...
  {
    bool _retval;
    _retval = gtk_widget_send_focus_change(cast(GtkWidget*)cPtr, event ? cast(GdkEvent*)event.cPtr : null);
    return _retval;
  }
   ...
   * will be activated.  This removes any accelerators $(LPAREN)for any
   * accelerator group$(RPAREN) installed by previous calls to
   * [gtk.widget.Widget.setAccelPath]. Associating accelerators with
   * paths allows them to be modified by the user and the modifications
   * to be saved for future use. $(LPAREN)See [gtk.accel_map.AccelMap.save].$(RPAREN)
   ...
   * background. $(LPAREN)Children of the widget will still be drawn.$(RPAREN) The application
  ...
  {
    gtk_widget_set_app_paintable(cast(GtkWidget*)cPtr, appPaintable);
  }
  ...
  {
    gtk_widget_set_can_default(cast(GtkWidget*)cPtr, canDefault);
  }
  ...
  {
    gtk_widget_set_child_visible(cast(GtkWidget*)cPtr, isVisible);
  }
   ...
   * $(LPAREN)i.e. the one that [gdk.window.Window.getEvents] returns$(RPAREN).
   * Params:
   *   device = a #GdkDevice
  ...
  /**
   * Sets the device event mask $(LPAREN)see #GdkEventMask$(RPAREN) for a widget. The event
   ...
   * mask. This function can’t be used with windowless widgets $(LPAREN)which return
   * %FALSE from [gtk.widget.Widget.getHasWindow]$(RPAREN);
   ...
   * pixmap will not happen automatically $(LPAREN)as it is done in
   * [gdk.window.Window.beginDrawFrame]$(RPAREN).
  ...
  {
    gtk_widget_set_double_buffered(cast(GtkWidget*)cPtr, doubleBuffered);
  }

  /**
   * Sets the event mask $(LPAREN)see #GdkEventMask$(RPAREN) for a widget. The event
   ...
   * $(LPAREN)See [gtk.widget.Widget.getHasWindow]$(RPAREN).  To get events on those widgets,
  ...
  {
    gtk_widget_set_events(cast(GtkWidget*)cPtr, events);
  }
   ...
   * $(LPAREN)[gtk.widget.Widget.getWindow] never returns a %NULL window when a widget
   * is realized$(RPAREN), but for many of them it’s actually the #GdkWindow of
   * one of its parent widgets. Widgets that do not create a %window for
   * themselves in #GtkWidget::realize must announce this by
   * calling this function with has_window \= %FALSE.
   * This function should only be called by widget implementations,
   * and they should call it in their init$(LPAREN)$(RPAREN) function.
   * Params:
   *   hasWindow = whether or not widget has a window.
   */
  void setHasWindow(bool hasWindow)
  {
    gtk_widget_set_has_window(cast(GtkWidget*)cPtr, hasWindow);
  }
   ...
   * [gtk.widget.Widget.setHexpand] sets the hexpand-set property $(LPAREN)see
   * [gtk.widget.Widget.setHexpandSet]$(RPAREN) which causes the widget’s hexpand
  ...
  /**
   * Sets whether the hexpand flag $(LPAREN)see [gtk.widget.Widget.getHexpand]$(RPAREN) will
   * be used.
  ...
  {
    gtk_widget_set_mapped(cast(GtkWidget*)cPtr, mapped);
  }
  ...
  {
    gtk_widget_set_margin_left(cast(GtkWidget*)cPtr, margin);
  }
  ...
  {
    gtk_widget_set_margin_right(cast(GtkWidget*)cPtr, margin);
  }
   ...
   * same page as the docs for #GtkStyleContext$(RPAREN).
  ...
  {
    gtk_widget_set_no_show_all(cast(GtkWidget*)cPtr, noShowAll);
  }

  /**
   * Request the widget to be rendered partially transparent,
   * with opacity 0 being fully transparent and 1 fully opaque. $(LPAREN)Opacity values
   * are clamped to the [0,1] range.$(RPAREN).
  ...
  {
    gtk_widget_set_realized(cast(GtkWidget*)cPtr, realized);
  }
  ...
  {
    gtk_widget_set_redraw_on_allocate(cast(GtkWidget*)cPtr, redrawOnAllocate);
  }
   ...
   * of a widget $(LPAREN)insensitive, prelighted, etc.$(RPAREN) Usually you should set
  ...
  {
    gtk_widget_set_state(cast(GtkWidget*)cPtr, state);
  }

  /**
   * This function is for use in widget implementations. Turns on flag
   * values in the current widget state $(LPAREN)insensitive, prelighted, etc.$(RPAREN).
  ...
  /**
   * Used to set the #GtkStyle for a widget $(LPAREN)widget->style$(RPAREN). Since
  ...
  {
    gtk_widget_set_support_multidevice(cast(GtkWidget*)cPtr, supportMultidevice);
  }
  ...
  /**
   * Sets whether the vexpand flag $(LPAREN)see [gtk.widget.Widget.getVexpand]$(RPAREN) will
   * be used.
   ...
   * widget’s init$(LPAREN)$(RPAREN) function.
  ...
  /**
   * Recursively shows a widget, and any child widgets $(LPAREN)if the widget is
   * a container$(RPAREN).
   */
  void showAll()
  {
    gtk_widget_show_all(cast(GtkWidget*)cPtr);
  }

  /**
   * Shows a widget. If the widget is an unmapped toplevel widget
   * $(LPAREN)i.e. a #GtkWindow that has not yet been shown$(RPAREN), enter the main
  ...
  void showNow()
  {
    gtk_widget_show_now(cast(GtkWidget*)cPtr);
  }
   ...
   * |[
   * widget->style \= gtk_style_attach $(LPAREN)widget->style, widget->window$(RPAREN);
   * ]|
   * and should only ever be called in a derived widget’s “realize”
   * implementation which does not chain up to its parent class'
   * “realize” implementation, because one of the parent classes
   * $(LPAREN)finally #GtkWidget$(RPAREN) would attach the style itself.

   * Deprecated: This step is unnecessary with #GtkStyleContext.
   */
  void styleAttach()
  {
    gtk_widget_style_attach(cast(GtkWidget*)cPtr);
  }
  ...
  {
    gtk_widget_thaw_child_notify(cast(GtkWidget*)cPtr);
  }
   ...
   * associated with the widget, such as widget->window$(RPAREN).
   */
  void unrealize()
  {
   ...
   * values for the current widget state $(LPAREN)insensitive, prelighted, etc.$(RPAREN).
  ...
  alias AccelClosuresChangedCallbackDlg = void delegate(gtk.widget.Widget widget);
  alias AccelClosuresChangedCallbackFunc = void function(gtk.widget.Widget widget);
   ...
   * $(LPAREN)typically from a mouse$(RPAREN) is pressed.
   ...
   */
  alias ButtonPressEventCallbackDlg = bool delegate(gdk.event_button.EventButton event, gtk.widget.Widget widget);
  alias ButtonPressEventCallbackFunc = bool function(gdk.event_button.EventButton event, gtk.widget.Widget widget);
  ...
  if (is(T : ButtonPressEventCallbackDlg) || is(T : ButtonPressEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      _retval = _dClosure.dlg(event, widget);
   ...
   * $(LPAREN)typically from a mouse$(RPAREN) is released.
   * To receive this signal, the #GdkWindow associated to the
   ...
   *   %FALSE to propagate the event further.
   */
  alias ButtonReleaseEventCallbackDlg = bool delegate(gdk.event_button.EventButton event, gtk.widget.Widget widget);
  alias ButtonReleaseEventCallbackFunc = bool function(gdk.event_button.EventButton event, gtk.widget.Widget widget);
   ...
   */
  alias CanActivateAccelCallbackDlg = bool delegate(uint signalId, gtk.widget.Widget widget);
  alias CanActivateAccelCallbackFunc = bool function(uint signalId, gtk.widget.Widget widget);
  ...
  if (is(T : CanActivateAccelCallbackDlg) || is(T : CanActivateAccelCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto signalId = getVal!(uint)(&_paramVals[1]);
      _retval = _dClosure.dlg(signalId, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   widget = the instance the signal is connected to
   */
  alias ChildNotifyCallbackDlg = void delegate(gobject.param_spec.ParamSpec childProperty, gtk.widget.Widget widget);
  alias ChildNotifyCallbackFunc = void function(gobject.param_spec.ParamSpec childProperty, gtk.widget.Widget widget);
  ...
  if (is(T : ChildNotifyCallbackDlg) || is(T : ChildNotifyCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto childProperty = getVal!(gobject.param_spec.ParamSpec)(&_paramVals[1]);
      _dClosure.dlg(childProperty, widget);
    }
   ...
   */
  alias CompositedChangedCallbackDlg = void delegate(gtk.widget.Widget widget);
  alias CompositedChangedCallbackFunc = void function(gtk.widget.Widget widget);
   ...
   *   %FALSE to propagate the event further.
   */
  alias ConfigureEventCallbackDlg = bool delegate(gdk.event_configure.EventConfigure event, gtk.widget.Widget widget);
  alias ConfigureEventCallbackFunc = bool function(gdk.event_configure.EventConfigure event, gtk.widget.Widget widget);
  ...
  if (is(T : ConfigureEventCallbackDlg) || is(T : ConfigureEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_configure.EventConfigure)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias DamageEventCallbackDlg = bool delegate(gdk.event_expose.EventExpose event, gtk.widget.Widget widget);
  alias DamageEventCallbackFunc = bool function(gdk.event_expose.EventExpose event, gtk.widget.Widget widget);
  ...
  if (is(T : DamageEventCallbackDlg) || is(T : DamageEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_expose.EventExpose)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias DeleteEventCallbackDlg = bool delegate(gdk.event.Event event, gtk.widget.Widget widget);
  alias DeleteEventCallbackFunc = bool function(gdk.event.Event event, gtk.widget.Widget widget);
   ...
   *   %FALSE to propagate the event further.
   */
  alias DestroyEventCallbackDlg = bool delegate(gdk.event.Event event, gtk.widget.Widget widget);
  alias DestroyEventCallbackFunc = bool function(gdk.event.Event event, gtk.widget.Widget widget);
   ...
   * this signal, so you may have to use g_signal_connect_after$(LPAREN)$(RPAREN) to
   * override what the default handler did.
   * Params
   *   context = the drag context
   *   widget = the instance the signal is connected to
   */
  alias DragBeginCallbackDlg = void delegate(gdk.drag_context.DragContext context, gtk.widget.Widget widget);
  alias DragBeginCallbackFunc = void function(gdk.drag_context.DragContext context, gtk.widget.Widget widget);
  ...
  if (is(T : DragBeginCallbackDlg) || is(T : DragBeginCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto context = getVal!(gdk.drag_context.DragContext)(&_paramVals[1]);
      _dClosure.dlg(context, widget);
    }
   ...
   *   widget = the instance the signal is connected to
   */
  alias DragDataDeleteCallbackDlg = void delegate(gdk.drag_context.DragContext context, gtk.widget.Widget widget);
  alias DragDataDeleteCallbackFunc = void function(gdk.drag_context.DragContext context, gtk.widget.Widget widget);
   ...
   *   widget = the instance the signal is connected to
   */
  alias DragDataGetCallbackDlg = void delegate(gdk.drag_context.DragContext context, gtk.selection_data.SelectionData data, uint info, uint time, gtk.widget.Widget widget);
  alias DragDataGetCallbackFunc = void function(gdk.drag_context.DragContext context, gtk.selection_data.SelectionData data, uint info, uint time, gtk.widget.Widget widget);
  ...
  if (is(T : DragDataGetCallbackDlg) || is(T : DragDataGetCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto context = getVal!(gdk.drag_context.DragContext)(&_paramVals[1]);
      auto data = getVal!(gtk.selection_data.SelectionData)(&_paramVals[2]);
      auto info = getVal!(uint)(&_paramVals[3]);
      auto time = getVal!(uint)(&_paramVals[4]);
      _dClosure.dlg(context, data, info, time, widget);
    }
   ...
   * $(LPAREN)and this is the last target to be received$(RPAREN), the handler for this
   ...
   * [gtk.global.dragFinish], e.g. to implement %GDK_ACTION_ASK as
   * shown in the following example:
   * |[<!-- language\="C" -->
   * void
   * drag_data_received $(LPAREN)GtkWidget          *widget,
   * GdkDragContext     *context,
   * gint                x,
   * gint                y,
   ...
   * guint               time$(RPAREN)
   * {
   * if $(LPAREN)$(LPAREN)data->length >\= 0$(RPAREN) && $(LPAREN)data->format \=\= 8$(RPAREN)$(RPAREN)
   * {
   * GdkDragAction action;
   * // handle data here
   * action \= gdk_drag_context_get_selected_action $(LPAREN)context$(RPAREN);
   * if $(LPAREN)action \=\= GDK_ACTION_ASK$(RPAREN)
   * {
   * GtkWidget *dialog;
   * gint response;
   * dialog \= gtk_message_dialog_new $(LPAREN)NULL,
   * GTK_DIALOG_MODAL |
   * GTK_DIALOG_DESTROY_WITH_PARENT,
   * GTK_MESSAGE_INFO,
   * GTK_BUTTONS_YES_NO,
   * "Move the data ?\n"$(RPAREN);
   * response \= gtk_dialog_run $(LPAREN)GTK_DIALOG $(LPAREN)dialog$(RPAREN)$(RPAREN);
   * gtk_widget_destroy $(LPAREN)dialog$(RPAREN);
   * if $(LPAREN)response \=\= GTK_RESPONSE_YES$(RPAREN)
   * action \= GDK_ACTION_MOVE;
   * else
   * action \= GDK_ACTION_COPY;
   * }
   * gtk_drag_finish $(LPAREN)context, TRUE, action \=\= GDK_ACTION_MOVE, time$(RPAREN);
   * }
   * else
   * gtk_drag_finish $(LPAREN)context, FALSE, FALSE, time$(RPAREN);
   * }
   * ]|
   * Params
   *   context = the drag context
   ...
   *   widget = the instance the signal is connected to
   */
  alias DragDataReceivedCallbackDlg = void delegate(gdk.drag_context.DragContext context, int x, int y, gtk.selection_data.SelectionData data, uint info, uint time, gtk.widget.Widget widget);
  alias DragDataReceivedCallbackFunc = void function(gdk.drag_context.DragContext context, int x, int y, gtk.selection_data.SelectionData data, uint info, uint time, gtk.widget.Widget widget);
  ...
  if (is(T : DragDataReceivedCallbackDlg) || is(T : DragDataReceivedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto data = getVal!(gtk.selection_data.SelectionData)(&_paramVals[4]);
      auto info = getVal!(uint)(&_paramVals[5]);
      auto time = getVal!(uint)(&_paramVals[6]);
      _dClosure.dlg(context, x, y, data, info, time, widget);
    }
   ...
   */
  alias DragDropCallbackDlg = bool delegate(gdk.drag_context.DragContext context, int x, int y, uint time, gtk.widget.Widget widget);
  alias DragDropCallbackFunc = bool function(gdk.drag_context.DragContext context, int x, int y, uint time, gtk.widget.Widget widget);
  ...
  if (is(T : DragDropCallbackDlg) || is(T : DragDropCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto y = getVal!(int)(&_paramVals[3]);
      auto time = getVal!(uint)(&_paramVals[4]);
      _retval = _dClosure.dlg(context, x, y, time, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   widget = the instance the signal is connected to
   */
  alias DragEndCallbackDlg = void delegate(gdk.drag_context.DragContext context, gtk.widget.Widget widget);
  alias DragEndCallbackFunc = void function(gdk.drag_context.DragContext context, gtk.widget.Widget widget);
   ...
   * been already handled $(LPAREN)not showing the default "drag operation failed"
   * animation$(RPAREN), otherwise it returns %FALSE.
   * Params
   *   context = the drag context
   ...
   */
  alias DragFailedCallbackDlg = bool delegate(gdk.drag_context.DragContext context, gtk.types.DragResult result, gtk.widget.Widget widget);
  alias DragFailedCallbackFunc = bool function(gdk.drag_context.DragContext context, gtk.types.DragResult result, gtk.widget.Widget widget);
  ...
  if (is(T : DragFailedCallbackDlg) || is(T : DragFailedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto context = getVal!(gdk.drag_context.DragContext)(&_paramVals[1]);
      auto result = getVal!(gtk.types.DragResult)(&_paramVals[2]);
      _retval = _dClosure.dlg(context, result, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   widget = the instance the signal is connected to
   */
  alias DragLeaveCallbackDlg = void delegate(gdk.drag_context.DragContext context, uint time, gtk.widget.Widget widget);
  alias DragLeaveCallbackFunc = void function(gdk.drag_context.DragContext context, uint time, gtk.widget.Widget widget);
  ...
  if (is(T : DragLeaveCallbackDlg) || is(T : DragLeaveCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto context = getVal!(gdk.drag_context.DragContext)(&_paramVals[1]);
      auto time = getVal!(uint)(&_paramVals[2]);
      _dClosure.dlg(context, time, widget);
    }
   ...
   * {
   * GdkAtom target;
   * PrivateData *private_data \= GET_PRIVATE_DATA $(LPAREN)widget$(RPAREN);
   * if $(LPAREN)!private_data->drag_highlight$(RPAREN)
   * {
   * private_data->drag_highlight \= 1;
   * gtk_drag_highlight $(LPAREN)widget$(RPAREN);
   * }
   * target \= gtk_drag_dest_find_target $(LPAREN)widget, context, NULL$(RPAREN);
   * if $(LPAREN)target \=\= GDK_NONE$(RPAREN)
   * gdk_drag_status $(LPAREN)context, 0, time$(RPAREN);
   * else
   * {
   * private_data->pending_status
   * \= gdk_drag_context_get_suggested_action $(LPAREN)context$(RPAREN);
   * gtk_drag_get_data $(LPAREN)widget, context, target, time$(RPAREN);
   * }
   * return TRUE;
   * }
   * static void
   ...
   * {
   * PrivateData *private_data \= GET_PRIVATE_DATA $(LPAREN)widget$(RPAREN);
   * if $(LPAREN)private_data->suggested_action$(RPAREN)
   * {
   * private_data->suggested_action \= 0;
   * // We are getting this data due to a request in drag_motion,
   * // rather than due to a request in drag_drop, so we are just
   * // supposed to call [gdk.global.dragStatus], not actually paste in
   * // the data.
   * str \= gtk_selection_data_get_text $(LPAREN)selection_data$(RPAREN);
   * if $(LPAREN)!data_is_acceptable $(LPAREN)str$(RPAREN)$(RPAREN)
   * gdk_drag_status $(LPAREN)context, 0, time$(RPAREN);
   * else
   * gdk_drag_status $(LPAREN)context,
   ...
   * Returns: whether the cursor position is in a drop zone
   */
  alias DragMotionCallbackDlg = bool delegate(gdk.drag_context.DragContext context, int x, int y, uint time, gtk.widget.Widget widget);
  alias DragMotionCallbackFunc = bool function(gdk.drag_context.DragContext context, int x, int y, uint time, gtk.widget.Widget widget);
   ...
   *   %FALSE to propagate the event further.
   */
  alias DrawCallbackDlg = bool delegate(cairo.context.Context cr, gtk.widget.Widget widget);
  alias DrawCallbackFunc = bool function(cairo.context.Context cr, gtk.widget.Widget widget);
  ...
  if (is(T : DrawCallbackDlg) || is(T : DrawCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto cr = getVal!(cairo.context.Context)(&_paramVals[1]);
      _retval = _dClosure.dlg(cr, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias EnterNotifyEventCallbackDlg = bool delegate(gdk.event_crossing.EventCrossing event, gtk.widget.Widget widget);
  alias EnterNotifyEventCallbackFunc = bool function(gdk.event_crossing.EventCrossing event, gtk.widget.Widget widget);
  ...
  if (is(T : EnterNotifyEventCallbackDlg) || is(T : EnterNotifyEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_crossing.EventCrossing)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   * signal that matches the type of event delivered $(LPAREN)e.g.
   * #GtkWidget::key-press-event$(RPAREN) and finally a generic
   ...
   *   the return value.
   */
  alias EventCallbackDlg = bool delegate(gdk.event.Event event, gtk.widget.Widget widget);
  alias EventCallbackFunc = bool function(gdk.event.Event event, gtk.widget.Widget widget);
  ...
  /**
   * After the emission of the #GtkWidget::event signal and $(LPAREN)optionally$(RPAREN)
   ...
   *   widget = the instance the signal is connected to
   */
  alias EventAfterCallbackDlg = void delegate(gdk.event.Event event, gtk.widget.Widget widget);
  alias EventAfterCallbackFunc = void function(gdk.event.Event event, gtk.widget.Widget widget);
  ...
  alias FocusCallbackDlg = bool delegate(gtk.types.DirectionType direction, gtk.widget.Widget widget);
  alias FocusCallbackFunc = bool function(gtk.types.DirectionType direction, gtk.widget.Widget widget);
   ...
   *   %FALSE to propagate the event further.
   */
  alias FocusInEventCallbackDlg = bool delegate(gdk.event_focus.EventFocus event, gtk.widget.Widget widget);
  alias FocusInEventCallbackFunc = bool function(gdk.event_focus.EventFocus event, gtk.widget.Widget widget);
  ...
  if (is(T : FocusInEventCallbackDlg) || is(T : FocusInEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_focus.EventFocus)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias FocusOutEventCallbackDlg = bool delegate(gdk.event_focus.EventFocus event, gtk.widget.Widget widget);
  alias FocusOutEventCallbackFunc = bool function(gdk.event_focus.EventFocus event, gtk.widget.Widget widget);
   ...
   * $(LPAREN)i.e. it or one of its ancestors is unmapped$(RPAREN), or if the same
   ...
   */
  alias GrabBrokenEventCallbackDlg = bool delegate(gdk.event_grab_broken.EventGrabBroken event, gtk.widget.Widget widget);
  alias GrabBrokenEventCallbackFunc = bool function(gdk.event_grab_broken.EventGrabBroken event, gtk.widget.Widget widget);
  ...
  if (is(T : GrabBrokenEventCallbackDlg) || is(T : GrabBrokenEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_grab_broken.EventGrabBroken)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
  ...
  alias GrabFocusCallbackDlg = void delegate(gtk.widget.Widget widget);
  alias GrabFocusCallbackFunc = void function(gtk.widget.Widget widget);
   ...
   * shadowed by a GTK+ grab $(LPAREN)not a pointer or keyboard grab$(RPAREN) on
   ...
   *   widget = the instance the signal is connected to
   */
  alias GrabNotifyCallbackDlg = void delegate(bool wasGrabbed, gtk.widget.Widget widget);
  alias GrabNotifyCallbackFunc = void function(bool wasGrabbed, gtk.widget.Widget widget);
  ...
  if (is(T : GrabNotifyCallbackDlg) || is(T : GrabNotifyCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto wasGrabbed = getVal!(bool)(&_paramVals[1]);
      _dClosure.dlg(wasGrabbed, widget);
    }
   ...
   *   widget = the instance the signal is connected to
   */
  alias HierarchyChangedCallbackDlg = void delegate(gtk.widget.Widget previousToplevel, gtk.widget.Widget widget);
  alias HierarchyChangedCallbackFunc = void function(gtk.widget.Widget previousToplevel, gtk.widget.Widget widget);
  ...
  if (is(T : HierarchyChangedCallbackDlg) || is(T : HierarchyChangedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto previousToplevel = getVal!(gtk.widget.Widget)(&_paramVals[1]);
      _dClosure.dlg(previousToplevel, widget);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias KeyPressEventCallbackDlg = bool delegate(gdk.event_key.EventKey event, gtk.widget.Widget widget);
  alias KeyPressEventCallbackFunc = bool function(gdk.event_key.EventKey event, gtk.widget.Widget widget);
  ...
  if (is(T : KeyPressEventCallbackDlg) || is(T : KeyPressEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_key.EventKey)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias KeyReleaseEventCallbackDlg = bool delegate(gdk.event_key.EventKey event, gtk.widget.Widget widget);
  alias KeyReleaseEventCallbackFunc = bool function(gdk.event_key.EventKey event, gtk.widget.Widget widget);
   ...
   *   %FALSE to propagate the event further.
   */
  alias LeaveNotifyEventCallbackDlg = bool delegate(gdk.event_crossing.EventCrossing event, gtk.widget.Widget widget);
  alias LeaveNotifyEventCallbackFunc = bool function(gdk.event_crossing.EventCrossing event, gtk.widget.Widget widget);
   ...
   * [gtk.widget.Widget.setVisible]$(RPAREN) and all its parents up to the toplevel widget
   ...
   *   %FALSE to propagate the event further.
   */
  alias MapEventCallbackDlg = bool delegate(gdk.event_any.EventAny event, gtk.widget.Widget widget);
  alias MapEventCallbackFunc = bool function(gdk.event_any.EventAny event, gtk.widget.Widget widget);
  ...
  if (is(T : MapEventCallbackDlg) || is(T : MapEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_any.EventAny)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias MotionNotifyEventCallbackDlg = bool delegate(gdk.event_motion.EventMotion event, gtk.widget.Widget widget);
  alias MotionNotifyEventCallbackFunc = bool function(gdk.event_motion.EventMotion event, gtk.widget.Widget widget);
  ...
  if (is(T : MotionNotifyEventCallbackDlg) || is(T : MotionNotifyEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_motion.EventMotion)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   widget = the instance the signal is connected to
   */
  alias ParentSetCallbackDlg = void delegate(gtk.widget.Widget oldParent, gtk.widget.Widget widget);
  alias ParentSetCallbackFunc = void function(gtk.widget.Widget oldParent, gtk.widget.Widget widget);
  ...
  if (is(T : ParentSetCallbackDlg) || is(T : ParentSetCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto oldParent = getVal!(gtk.widget.Widget)(&_paramVals[1]);
      _dClosure.dlg(oldParent, widget);
    }
   ...
   */
  alias PopupMenuCallbackDlg = bool delegate(gtk.widget.Widget widget);
  alias PopupMenuCallbackFunc = bool function(gtk.widget.Widget widget);
   ...
   *   %FALSE to propagate the event further.
   */
  alias PropertyNotifyEventCallbackDlg = bool delegate(gdk.event_property.EventProperty event, gtk.widget.Widget widget);
  alias PropertyNotifyEventCallbackFunc = bool function(gdk.event_property.EventProperty event, gtk.widget.Widget widget);
  ...
  if (is(T : PropertyNotifyEventCallbackDlg) || is(T : PropertyNotifyEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_property.EventProperty)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias ProximityInEventCallbackDlg = bool delegate(gdk.event_proximity.EventProximity event, gtk.widget.Widget widget);
  alias ProximityInEventCallbackFunc = bool function(gdk.event_proximity.EventProximity event, gtk.widget.Widget widget);
  ...
  if (is(T : ProximityInEventCallbackDlg) || is(T : ProximityInEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_proximity.EventProximity)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias ProximityOutEventCallbackDlg = bool delegate(gdk.event_proximity.EventProximity event, gtk.widget.Widget widget);
  alias ProximityOutEventCallbackFunc = bool function(gdk.event_proximity.EventProximity event, gtk.widget.Widget widget);
   ...
   * widget has been mapped $(LPAREN)that is, it is going to be drawn$(RPAREN).
   *   widget = the instance the signal is connected to
   */
   ...
   *   widget = the instance the signal is connected to
   */
  alias ScreenChangedCallbackDlg = void delegate(gdk.screen.Screen previousScreen, gtk.widget.Widget widget);
  alias ScreenChangedCallbackFunc = void function(gdk.screen.Screen previousScreen, gtk.widget.Widget widget);
  ...
  if (is(T : ScreenChangedCallbackDlg) || is(T : ScreenChangedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto previousScreen = getVal!(gdk.screen.Screen)(&_paramVals[1]);
      _dClosure.dlg(previousScreen, widget);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias ScrollEventCallbackDlg = bool delegate(gdk.event_scroll.EventScroll event, gtk.widget.Widget widget);
  alias ScrollEventCallbackFunc = bool function(gdk.event_scroll.EventScroll event, gtk.widget.Widget widget);
   ...
   *   %FALSE to propagate the event further.
   */
  alias SelectionClearEventCallbackDlg = bool delegate(gdk.event_selection.EventSelection event, gtk.widget.Widget widget);
  alias SelectionClearEventCallbackFunc = bool function(gdk.event_selection.EventSelection event, gtk.widget.Widget widget);
  ...
  if (is(T : SelectionClearEventCallbackDlg) || is(T : SelectionClearEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_selection.EventSelection)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
  ...
  alias SelectionGetCallbackDlg = void delegate(gtk.selection_data.SelectionData data, uint info, uint time, gtk.widget.Widget widget);
  alias SelectionGetCallbackFunc = void function(gtk.selection_data.SelectionData data, uint info, uint time, gtk.widget.Widget widget);
  ...
  if (is(T : SelectionGetCallbackDlg) || is(T : SelectionGetCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto data = getVal!(gtk.selection_data.SelectionData)(&_paramVals[1]);
      auto info = getVal!(uint)(&_paramVals[2]);
      auto time = getVal!(uint)(&_paramVals[3]);
      _dClosure.dlg(data, info, time, widget);
    }
  ...
  alias SelectionNotifyEventCallbackDlg = bool delegate(gdk.event_selection.EventSelection event, gtk.widget.Widget widget);
  alias SelectionNotifyEventCallbackFunc = bool function(gdk.event_selection.EventSelection event, gtk.widget.Widget widget);
  ...
  alias SelectionReceivedCallbackDlg = void delegate(gtk.selection_data.SelectionData data, uint time, gtk.widget.Widget widget);
  alias SelectionReceivedCallbackFunc = void function(gtk.selection_data.SelectionData data, uint time, gtk.widget.Widget widget);
  ...
  if (is(T : SelectionReceivedCallbackDlg) || is(T : SelectionReceivedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto data = getVal!(gtk.selection_data.SelectionData)(&_paramVals[1]);
      auto time = getVal!(uint)(&_paramVals[2]);
      _dClosure.dlg(data, time, widget);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias SelectionRequestEventCallbackDlg = bool delegate(gdk.event_selection.EventSelection event, gtk.widget.Widget widget);
  alias SelectionRequestEventCallbackFunc = bool function(gdk.event_selection.EventSelection event, gtk.widget.Widget widget);
  ...
  alias ShowHelpCallbackDlg = bool delegate(gtk.types.WidgetHelpType helpType, gtk.widget.Widget widget);
  alias ShowHelpCallbackFunc = bool function(gtk.types.WidgetHelpType helpType, gtk.widget.Widget widget);
  ...
  if (is(T : ShowHelpCallbackDlg) || is(T : ShowHelpCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto helpType = getVal!(gtk.types.WidgetHelpType)(&_paramVals[1]);
      _retval = _dClosure.dlg(helpType, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   */
  alias StateChangedCallbackDlg = void delegate(gtk.types.StateType state, gtk.widget.Widget widget);
  alias StateChangedCallbackFunc = void function(gtk.types.StateType state, gtk.widget.Widget widget);
  ...
  if (is(T : StateChangedCallbackDlg) || is(T : StateChangedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto state = getVal!(gtk.types.StateType)(&_paramVals[1]);
      _dClosure.dlg(state, widget);
    }
   ...
   */
  alias StyleSetCallbackDlg = void delegate(gtk.style.Style previousStyle, gtk.widget.Widget widget);
  alias StyleSetCallbackFunc = void function(gtk.style.Style previousStyle, gtk.widget.Widget widget);
  ...
  if (is(T : StyleSetCallbackDlg) || is(T : StyleSetCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto previousStyle = getVal!(gtk.style.Style)(&_paramVals[1]);
      _dClosure.dlg(previousStyle, widget);
    }
   ...
   *   widget = the instance the signal is connected to
   */
  alias StyleUpdatedCallbackDlg = void delegate(gtk.widget.Widget widget);
  alias StyleUpdatedCallbackFunc = void function(gtk.widget.Widget widget);
  ...
  alias TouchEventCallbackDlg = bool delegate(gdk.event.Event object, gtk.widget.Widget widget);
  alias TouchEventCallbackFunc = bool function(gdk.event.Event object, gtk.widget.Widget widget);
  ...
  if (is(T : TouchEventCallbackDlg) || is(T : TouchEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto object = getVal!(gdk.event.Event)(&_paramVals[1]);
      _retval = _dClosure.dlg(object, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   *   %FALSE to propagate the event further.
   */
  alias UnmapEventCallbackDlg = bool delegate(gdk.event_any.EventAny event, gtk.widget.Widget widget);
  alias UnmapEventCallbackFunc = bool function(gdk.event_any.EventAny event, gtk.widget.Widget widget);
   ...
   * called or the widget has been unmapped $(LPAREN)that is, it is going to be
   * hidden$(RPAREN).
   *   widget = the instance the signal is connected to
   */
   ...
   *   information.
   */
  alias VisibilityNotifyEventCallbackDlg = bool delegate(gdk.event_visibility.EventVisibility event, gtk.widget.Widget widget);
  alias VisibilityNotifyEventCallbackFunc = bool function(gdk.event_visibility.EventVisibility event, gtk.widget.Widget widget);
  ...
  if (is(T : VisibilityNotifyEventCallbackDlg) || is(T : VisibilityNotifyEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_visibility.EventVisibility)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
   ...
   */
  alias WindowStateEventCallbackDlg = bool delegate(gdk.event_window_state.EventWindowState event, gtk.widget.Widget widget);
  alias WindowStateEventCallbackFunc = bool function(gdk.event_window_state.EventWindowState event, gtk.widget.Widget widget);
  ...
  if (is(T : WindowStateEventCallbackDlg) || is(T : WindowStateEventCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      bool _retval;
      auto widget = getVal!(gtk.widget.Widget)(_paramVals);
      auto event = getVal!(gdk.event_window_state.EventWindowState)(&_paramVals[1]);
      _retval = _dClosure.dlg(event, widget);
      setVal!bool(_returnValue, _retval);
    }
