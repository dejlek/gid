...
class TextMark : gobject.object.ObjectG
{
   ...
   * right gravity $(LPAREN)left_gravity \= %FALSE$(RPAREN), the mark will end up on the
   * right of newly-inserted text. The standard left-to-right cursor is a
   * mark with right gravity $(LPAREN)when you type, the cursor stays on the right
  ...
  /**
   * Returns %TRUE if the mark is visible $(LPAREN)i.e. a cursor is displayed
   * for it$(RPAREN).
