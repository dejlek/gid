...
class Adjustment : gobject.initially_unowned.InitiallyUnowned
{
   ...
   *   of the properties $(LPAREN)other than value$(RPAREN) change
   */
  void changed()
  {
   ...
   * between lower and upper is in the current page $(LPAREN)i.e. between
   * #GtkAdjustment:value and #GtkAdjustment:value + #GtkAdjustment:page-size$(RPAREN).
