...
class AspectFrame : gtk.frame.Frame
{
   ...
   *     the #GtkAspectFrame. This ranges from 0.0 $(LPAREN)left aligned$(RPAREN)
   *     to 1.0 $(LPAREN)right aligned$(RPAREN)
   *   yalign = Vertical alignment of the child within the allocation of
   *     the #GtkAspectFrame. This ranges from 0.0 $(LPAREN)top aligned$(RPAREN)
   *     to 1.0 $(LPAREN)bottom aligned$(RPAREN)
