...
template TreeModelT()
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       a #GtkTreePath-struct identifying the changed row
      * $(B iter)       a valid #GtkTreeIter-struct pointing to the changed row
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       a #GtkTreePath-struct identifying the row
      * $(B treeModel) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B path)       a #GtkTreePath-struct identifying the row
      * $(B iter)       a valid #GtkTreeIter-struct pointing to the row
      * $(B treeModel) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       a #GtkTreePath-struct identifying the new row
      * $(B iter)       a valid #GtkTreeIter-struct pointing to the new row
      * $(B treeModel) the instance the signal is connected to
    )
  */
