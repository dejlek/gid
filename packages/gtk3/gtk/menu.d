...
class Menu : gtk.menu_shell.MenuShell
{
   ...
   * by means of being attached to a widget $(LPAREN)see [gtk.menu.Menu.attachToWidget]$(RPAREN)
  ...
  /**
   * Adds a new #GtkMenuItem to a $(LPAREN)table$(RPAREN) menu. The number of “cells” that
   * an item will occupy is specified by left_attach, right_attach,
   * top_attach and bottom_attach. These each represent the leftmost,
   * rightmost, uppermost and lower column and row numbers of the table.
   * $(LPAREN)Columns and rows are indexed from zero$(RPAREN).
   ...
   * properly, this needs to be the timestamp of the user event $(LPAREN)such as
   * a mouse click or key press$(RPAREN) that caused the initiation of the popup.
   ...
   * See gtk_menu_popup_at_widget $(LPAREN)$(RPAREN) to pop up a menu at a widget.
   * gtk_menu_popup_at_rect $(LPAREN)$(RPAREN) also allows you to position a menu at an arbitrary
   * rectangle.
  ...
  /**
   * Displays menu and makes it available for selection.
   * See gtk_menu_popup_at_widget $(LPAREN)$(RPAREN) and gtk_menu_popup_at_pointer $(LPAREN)$(RPAREN), which
  ...
  /**
   * Displays menu and makes it available for selection.
   * See gtk_menu_popup_at_pointer $(LPAREN)$(RPAREN) to pop up a menu at the master pointer.
   * gtk_menu_popup_at_rect $(LPAREN)$(RPAREN) also allows you to position a menu at an arbitrary
   * rectangle.
   * ![](popup-anchors.png)
   ...
   * of device $(LPAREN)or its corresponding pointer$(RPAREN).
   * The button parameter should be the mouse button pressed to initiate
   ...
   * properly, this needs to be the time stamp of the user event $(LPAREN)such as
   * a mouse click or key press$(RPAREN) that caused the initiation of the popup.
   * Only if no such event is available, [gtk.global.getCurrentEventTime] can
   * be used instead.
   * Note that this function does not work very well on GDK backends that
   ...
   * `gtk_menu_set_accel_path $(LPAREN)menu, "<Gnumeric-Sheet>/File"$(RPAREN);` has been
   ...
   * using gtk_menu_popup_at_rect $(LPAREN)$(RPAREN), gtk_menu_popup_at_widget $(LPAREN)$(RPAREN), or
   * gtk_menu_popup_at_pointer $(LPAREN)$(RPAREN).
   ...
   * See gtk_menu_popup_at_rect $(LPAREN)$(RPAREN), gtk_menu_popup_at_widget $(LPAREN)$(RPAREN),
   * gtk_menu_popup_at_pointer $(LPAREN)$(RPAREN), #GtkMenu:anchor-hints,
   ...
   *   menu = the instance the signal is connected to
   */
