...
class MenuShell : gtk.container.Container
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B forceHide)       if true, hide the menu after activating the menu item
      * $(B menuShell) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B direction)       the direction to cycle in
      * $(B menuShell) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B child)       the #GtkMenuItem that is being inserted
      * $(B position)       the position at which the insert occurs
      * $(B menuShell) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B direction)       the direction to move
      * $(B menuShell) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B distance)       +1 to move to the next item, -1 to move to the previous
      * $(B menuShell) the instance the signal is connected to
    )
