...
class IconInfo : gobject.object.ObjectG
{
   ...
   * up too far. $(LPAREN)This maintains sharpness.$(RPAREN). This behaviour can be changed
   ...
   *     of the icon or %NULL to use the default color $(LPAREN)allow-none$(RPAREN)
