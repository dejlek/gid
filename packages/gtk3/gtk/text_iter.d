...
class TextIter : gobject.boxed.Boxed
{
   ...
   * was possible; if iter was the first in the buffer $(LPAREN)character
   * offset 0$(RPAREN), [gtk.text_iter.TextIter.backwardChar] returns %FALSE for convenience when
   * writing loops.
  ...
  /**
   * Moves count characters backward, if possible $(LPAREN)if count would move
   * past the start or end of the buffer, moves to the start or end of
   * the buffer$(RPAREN).  The return value indicates whether the iterator moved
  ...
  /**
   * Moves count lines backward, if possible $(LPAREN)if count would move
   * past the start or end of the buffer, moves to the start or end of
   * the buffer$(RPAREN).  The return value indicates whether the iterator moved
   * onto a dereferenceable position; if the iterator didn’t move, or
   * moved onto the end iterator, then %FALSE is returned. If count is 0,
   ...
   * any language $(LPAREN)if not, the correct fix would be to the Pango text
   * boundary algorithms$(RPAREN).
  ...
  /**
   * Moves count visible lines backward, if possible $(LPAREN)if count would move
   * past the start or end of the buffer, moves to the start or end of
   * the buffer$(RPAREN).  The return value indicates whether the iterator moved
   * onto a dereferenceable position; if the iterator didn’t move, or
   * moved onto the end iterator, then %FALSE is returned. If count is 0,
  ...
  /**
   * Moves backward to the previous visible word start. $(LPAREN)If iter is currently
   * on a word start, moves backward to the next one after that.$(RPAREN) Word breaks
   * are determined by Pango and should be correct for nearly any
   * language $(LPAREN)if not, the correct fix would be to the Pango word break
   * algorithms$(RPAREN).
   * Returns: %TRUE if iter moved and is not the end iterator
   */
  ...
  /**
   * Moves backward to the previous word start. $(LPAREN)If iter is currently on a
   * word start, moves backward to the next one after that.$(RPAREN) Word breaks
   * are determined by Pango and should be correct for nearly any
   * language $(LPAREN)if not, the correct fix would be to the Pango word break
   * algorithms$(RPAREN).
   * Returns: %TRUE if iter moved and is not the end iterator
   ...
   */
  bool beginsTag(gtk.text_tag.TextTag tag)
  {
    bool _retval;
    _retval = gtk_text_iter_begins_tag(cast(const(GtkTextIter)*)cPtr, tag ? cast(GtkTextTag*)tag.cPtr(No.Dup) : null);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_can_insert(cast(const(GtkTextIter)*)cPtr, defaultEditability);
    return _retval;
  }
   ...
   * simple assignment $(LPAREN)`GtkTextIter i \= j;`$(RPAREN). The
   * function is used by language bindings.
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_editable(cast(const(GtkTextIter)*)cPtr, defaultSetting);
    return _retval;
  }

  /**
   * Returns %TRUE if iter points to the start of the paragraph
   * delimiter characters for a line $(LPAREN)delimiters will be either a
   * newline, a carriage return, a carriage return followed by a
   * newline, or a Unicode paragraph separator character$(RPAREN). Note that an
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_ends_line(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
   ...
   * $(LPAREN)if not, the correct fix would be to the Pango text boundary
   * algorithms$(RPAREN).
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_ends_sentence(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_ends_word(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  /**
   * Moves count characters if possible $(LPAREN)if count would move past the
   * start or end of the buffer, moves to the start or end of the
   * buffer$(RPAREN). The return value indicates whether the new position of
   ...
   * are $(LPAREN)unsurprisingly$(RPAREN) positions where the cursor can appear. Perhaps
  ...
  /**
   * Moves count lines forward, if possible $(LPAREN)if count would move
   * past the start or end of the buffer, moves to the start or end of
   * the buffer$(RPAREN).  The return value indicates whether the iterator moved
   * onto a dereferenceable position; if the iterator didn’t move, or
   * moved onto the end iterator, then %FALSE is returned. If count is 0,
   ...
   * limit. Note that a search is a linear or O$(LPAREN)n$(RPAREN) operation, so you
  ...
  /**
   * Moves forward to the next sentence end. $(LPAREN)If iter is at the end of
   * a sentence, moves to the next end of sentence.$(RPAREN)  Sentence
   * boundaries are determined by Pango and should be correct for nearly
   * any language $(LPAREN)if not, the correct fix would be to the Pango text
   * boundary algorithms$(RPAREN).
   * Returns: %TRUE if iter moved and is not the end iterator
  ...
  /**
   * Calls [gtk.text_iter.TextIter.forwardSentenceEnd] count times $(LPAREN)or until
   * [gtk.text_iter.TextIter.forwardSentenceEnd] returns %FALSE$(RPAREN). If count is
  ...
  /**
   * Moves count visible lines forward, if possible $(LPAREN)if count would move
   * past the start or end of the buffer, moves to the start or end of
   * the buffer$(RPAREN).  The return value indicates whether the iterator moved
   * onto a dereferenceable position; if the iterator didn’t move, or
   * moved onto the end iterator, then %FALSE is returned. If count is 0,
  ...
  /**
   * Moves forward to the next visible word end. $(LPAREN)If iter is currently on a
   * word end, moves forward to the next one after that.$(RPAREN) Word breaks
   * are determined by Pango and should be correct for nearly any
   * language $(LPAREN)if not, the correct fix would be to the Pango word break
   * algorithms$(RPAREN).
   * Returns: %TRUE if iter moved and is not the end iterator
  ...
  /**
   * Moves forward to the next word end. $(LPAREN)If iter is currently on a
   * word end, moves forward to the next one after that.$(RPAREN) Word breaks
   * are determined by Pango and should be correct for nearly any
   * language $(LPAREN)if not, the correct fix would be to the Pango word break
   * algorithms$(RPAREN).
  ...
  bool getAttributes(out gtk.text_attributes.TextAttributes values)
  {
    ...
    _retval = gtk_text_iter_get_attributes(cast(const(GtkTextIter)*)cPtr, &_values);
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_bytes_in_line(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }

  /**
   * The Unicode character at this iterator is returned.  $(LPAREN)Equivalent to
   * operator* on a C++ iterator.$(RPAREN)  If the element at this iterator is a
  ...
  {
    dchar _retval;
    _retval = gtk_text_iter_get_char(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_chars_in_line(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }

  /**
   * If the location at iter contains a child anchor, the
   * anchor is returned $(LPAREN)with no new reference count added$(RPAREN). Otherwise,
   * %NULL is returned.
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_line(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_line_index(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_line_offset(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }

  /**
   * Returns a list of all #GtkTextMark at this location. Because marks
   * are not iterable $(LPAREN)they don’t take up any "space" in the buffer,
   * they are just marks in between iterable locations$(RPAREN), multiple marks
  ...
  {
    GSList* _cretval;
    _cretval = gtk_text_iter_get_marks(cast(const(GtkTextIter)*)cPtr);
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_offset(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }

  /**
   * If the element at iter is a pixbuf, the pixbuf is returned
   * $(LPAREN)with no new reference count added$(RPAREN). Otherwise,
   * %NULL is returned.
   ...
   * priority $(LPAREN)highest-priority tags are last$(RPAREN). The #GtkTextTag in the
  ...
  {
    GSList* _cretval;
    _cretval = gtk_text_iter_get_tags(cast(const(GtkTextIter)*)cPtr);
   ...
   * point.  $(LPAREN)If toggled_on is %TRUE, the list contains tags that are
   * toggled on.$(RPAREN) If a tag is toggled on at iter, then some non-empty
  ...
  {
    GSList* _cretval;
    _cretval = gtk_text_iter_get_toggled_tags(cast(const(GtkTextIter)*)cPtr, toggledOn);
    auto _retval = gSListToD!(gtk.text_tag.TextTag, GidOwnership.Container)(cast(GSList*)_cretval);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_visible_line_index(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = gtk_text_iter_get_visible_line_offset(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
   ...
   * letter of the next sentence$(RPAREN).  Sentence boundaries are determined
   * by Pango and should be correct for nearly any language $(LPAREN)if not, the
   * correct fix would be to the Pango text boundary algorithms$(RPAREN).
   * Returns: %TRUE if iter is inside a sentence.
   */
  bool insideSentence()
  {
    bool _retval;
    _retval = gtk_text_iter_inside_sentence(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }

  /**
   * Determines whether the character pointed by iter is part of a
   * natural-language word $(LPAREN)as opposed to say inside some whitespace$(RPAREN).  Word
   * breaks are determined by Pango and should be correct for nearly any language
   * $(LPAREN)if not, the correct fix would be to the Pango word break algorithms$(RPAREN).
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_inside_word(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_is_cursor_position(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_is_end(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_is_start(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
   ...
   * $(LPAREN)not byte$(RPAREN) offset. The given character offset must be less than or
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_starts_line(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_starts_sentence(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gtk_text_iter_starts_word(cast(const(GtkTextIter)*)cPtr);
    return _retval;
  }

  /**
   * This is equivalent to $(LPAREN)[gtk.text_iter.TextIter.startsTag] ||
   * [gtk.text_iter.TextIter.endsTag]$(RPAREN), i.e. it tells you whether a range with
