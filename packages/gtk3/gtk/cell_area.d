...
class CellArea : gobject.initially_unowned.InitiallyUnowned, gtk.buildable.Buildable, gtk.cell_layout.CellLayout
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B renderer)       the #GtkCellRenderer that started the edited
      * $(B editable)       the #GtkCellEditable widget to add
      * $(B cellArea)       the #GtkWidget relative #GdkRectangle coordinates
                    where editable should be added
      * $(B path)       the #GtkTreePath string this edit was initiated for
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B model)       the #GtkTreeModel to apply the attributes from
      * $(B iter)       the #GtkTreeIter indicating which row to apply the attributes of
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B renderer)       the #GtkCellRenderer that has focus
      * $(B path)       the current #GtkTreePath string set for area
      * $(B cellArea) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B renderer)       the #GtkCellRenderer that finished editeding
      * $(B editable)       the #GtkCellEditable widget to remove
      * $(B cellArea) the instance the signal is connected to
    )
  */
