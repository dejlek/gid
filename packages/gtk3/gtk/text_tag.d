...
class TextTag : gobject.object.ObjectG
{
   ...
   * Returns: result of signal emission $(LPAREN)whether the event was handled$(RPAREN)
   */
   ...
   * Params
   *   object = the object the event was fired from $(LPAREN)typically a #GtkTextView$(RPAREN)
   *   event = the event which triggered the signal
   *   iter = a #GtkTextIter pointing at the location the event occurred
   *   textTag = the instance the signal is connected to
