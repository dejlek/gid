...
class NativeDialog : gobject.object.ObjectG
{
   ...
   * Note that this does not release any reference to the object $(LPAREN)as opposed to
   * destroying a GtkWindow$(RPAREN) because there is no reference from the windowing
   ...
   * |[<!-- language\="C" -->
   * gint result \= gtk_native_dialog_run $(LPAREN)GTK_NATIVE_DIALOG $(LPAREN)dialog$(RPAREN)$(RPAREN);
   ...
   * break;
   * }
   * g_object_unref $(LPAREN)dialog$(RPAREN);
   * ]|
