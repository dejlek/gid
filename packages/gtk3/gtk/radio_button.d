...
class RadioButton : gtk.check_button.CheckButton
{
  ...
  {
    GSList* _cretval;
    _cretval = gtk_radio_button_get_group(cast(GtkRadioButton*)cPtr);
   ...
   * while $(LPAREN)some_condition$(RPAREN)
   * {
   * radio_button \= gtk_radio_button_new $(LPAREN)NULL$(RPAREN);
   * gtk_radio_button_join_group $(LPAREN)radio_button, last_button$(RPAREN);
  ...
  void setGroup(gtk.radio_button.RadioButton[] group)
  {
    auto _group = gSListFromD!(gtk.radio_button.RadioButton)(group);
    scope(exit) containerFree!(GSList*, gtk.radio_button.RadioButton, GidOwnership.None)(_group);
    gtk_radio_button_set_group(cast(GtkRadioButton*)cPtr, _group);
  }
   ...
   *   radioButton = the instance the signal is connected to
   */
  alias GroupChangedCallbackDlg = void delegate(gtk.radio_button.RadioButton radioButton);
  alias GroupChangedCallbackFunc = void function(gtk.radio_button.RadioButton radioButton);
  ...
  if (is(T : GroupChangedCallbackDlg) || is(T : GroupChangedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto radioButton = getVal!(gtk.radio_button.RadioButton)(_paramVals);
      _dClosure.dlg(radioButton);
    }
