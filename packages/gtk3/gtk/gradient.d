...
class Gradient : gobject.boxed.Boxed
{
  ...
  /**
   * Creates a new linear gradient along the line defined by $(LPAREN)x0, y0$(RPAREN) and $(LPAREN)x1, y1$(RPAREN). Before using the gradient
  ...
  /**
   * Creates a new radial gradient along the two circles defined by $(LPAREN)x0, y0, radius0$(RPAREN) and
   * $(LPAREN)x1, y1, radius1$(RPAREN). Before using the gradient a number of stop colors must be added
