...
class Alignment : gtk.bin.Bin
{
   ...
   * Params:
   *   xalign = the horizontal alignment of the child widget, from 0 $(LPAREN)left$(RPAREN) to 1
   *     $(LPAREN)right$(RPAREN).
   *   yalign = the vertical alignment of the child widget, from 0 $(LPAREN)top$(RPAREN) to 1
   *     $(LPAREN)bottom$(RPAREN).
   ...
   * See gtk_alignment_set_padding $(LPAREN)$(RPAREN).
   * Params:
