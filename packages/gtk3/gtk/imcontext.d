...
class IMContext : gobject.object.ObjectG
{
   ...
   *   cursorPos = location to store position of cursor $(LPAREN)in characters$(RPAREN)
   ...
   * to display feedback. If use_preedit is FALSE $(LPAREN)default
   * is TRUE$(RPAREN), then the IM context may use some other method to display
