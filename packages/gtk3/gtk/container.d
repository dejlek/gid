...
class Container : gtk.widget.Widget
{
   ...
   * children that are considered “internal” $(LPAREN)implementation details
   * of the container$(RPAREN). “Internal” children generally weren’t added
   ...
   * added to the container by the application with explicit add$(LPAREN)$(RPAREN)
   * calls.
   ...
   * gtk_container_set_focus_hadjustment $(LPAREN)$(RPAREN).
   ...
   * gtk_container_set_resize_mode $(LPAREN)$(RPAREN).
  ...
  alias AddCallbackDlg = void delegate(gtk.widget.Widget object, gtk.container.Container container);
  alias AddCallbackFunc = void function(gtk.widget.Widget object, gtk.container.Container container);
  ...
  if (is(T : AddCallbackDlg) || is(T : AddCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto container = getVal!(gtk.container.Container)(_paramVals);
      auto object = getVal!(gtk.widget.Widget)(&_paramVals[1]);
      _dClosure.dlg(object, container);
    }
  ...
  alias CheckResizeCallbackDlg = void delegate(gtk.container.Container container);
  alias CheckResizeCallbackFunc = void function(gtk.container.Container container);
  ...
  alias RemoveCallbackDlg = void delegate(gtk.widget.Widget object, gtk.container.Container container);
  alias RemoveCallbackFunc = void function(gtk.widget.Widget object, gtk.container.Container container);
  ...
  alias SetFocusChildCallbackDlg = void delegate(gtk.widget.Widget object, gtk.container.Container container);
  alias SetFocusChildCallbackFunc = void function(gtk.widget.Widget object, gtk.container.Container container);
