...
class FlowBox : gtk.container.Container, gtk.orientable.Orientable
{
   ...
   * [gtk.flow_box.FlowBox.insert] or [gtk.container.Container.add]$(RPAREN) while box is bound to a
   * model.
   ...
   * [gtk.flow_box_child.FlowBoxChild.changed]$(RPAREN) or when [gtk.flow_box.FlowBox.invalidateFilter]
   * is called.
   ...
   * [gtk.flow_box_child.FlowBoxChild.changed]$(RPAREN) and when [gtk.flow_box.FlowBox.invalidateSort]
   * is called.
