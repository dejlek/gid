...
class Action : gobject.object.ObjectG, gtk.buildable.Buildable
{
   ...
   * cases $(LPAREN)updating toggle state for instance$(RPAREN).
   ...
   * Params:
   *   iconSize = the size of the icon $(LPAREN)#GtkIconSize$(RPAREN) that should
   *     be created.
   ...
   *   action = the instance the signal is connected to
