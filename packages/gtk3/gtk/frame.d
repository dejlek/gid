...
class Frame : gtk.bin.Bin
{
   ...
   * text in the label widget. $(LPAREN)The frame will have a #GtkLabel
   * for the label widget if a non-%NULL argument was passed
   * to [gtk.frame.Frame.new_].$(RPAREN)
   ...
   * $(LPAREN)%GTK_SHADOW_NONE$(RPAREN) or with $(LPAREN)other values$(RPAREN) a visible border. Values other than
