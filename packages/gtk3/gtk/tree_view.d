...
class TreeView : gtk.container.Container, gtk.scrollable.Scrollable
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B treeView) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       the #GtkTreePath for the activated row
      * $(B column)       the #GtkTreeViewColumn in which the activation occurred
      * $(B treeView) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B iter)       the tree iter of the collapsed row
      * $(B path)       a tree path that points to the row
      * $(B treeView) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B iter)       the tree iter of the expanded row
      * $(B path)       a tree path that points to the row
      * $(B treeView) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B iter)       the tree iter of the row to collapse
      * $(B path)       a tree path that points to the row
      * $(B treeView) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B iter)       the tree iter of the row to expand
      * $(B path)       a tree path that points to the row
      * $(B treeView) the instance the signal is connected to
    )
