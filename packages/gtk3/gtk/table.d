...
class Table : gtk.container.Container
{
   ...
   * and row numbers of the table. $(LPAREN)Columns and rows are indexed from zero$(RPAREN).
   * To make a button occupy the lower right cell of a 2x2 table, use
   * |[
   * gtk_table_attach $(LPAREN)table, button,
   * 1, 2, // left, right attach
   * 1, 2, // top, bottom attach
   * xoptions, yoptions,
   * xpadding, ypadding$(RPAREN);
   * ]|
   ...
   * $(LPAREN)See [gtk.table.Table.setColSpacings]$(RPAREN)
   ...
   * $(LPAREN)See [gtk.table.Table.setRowSpacings]$(RPAREN)
   ...
   * width and height. $(LPAREN)See gtk_table_set_homogeneous $(LPAREN)$(RPAREN)$(RPAREN)
