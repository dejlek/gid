...
class IconFactory : gobject.object.ObjectG, gtk.buildable.Buildable
{
   ...
   * particular icon $(LPAREN)i.e. a #GtkIconSet contains variants for different
   * sizes and widget states$(RPAREN). Icons in an icon factory are named by a
   ...
   * an icon with the same name $(LPAREN)such as "myapp-whatever-icon"$(RPAREN) to
