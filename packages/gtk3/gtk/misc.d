...
class Misc : gtk.widget.Widget
{
   ...
   *   yalign = the vertical alignment, from 0 $(LPAREN)top$(RPAREN) to 1 $(LPAREN)bottom$(RPAREN).

   * Deprecated: Use #GtkWidget's alignment $(LPAREN)#GtkWidget:halign and #GtkWidget:valign$(RPAREN) and margin properties or #GtkLabel's #GtkLabel:xalign and #GtkLabel:yalign properties.
   */
