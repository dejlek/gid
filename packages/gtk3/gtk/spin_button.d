...
class SpinButton : gtk.entry.Entry, gtk.orientable.Orientable
{
   ...
   * gchar *text;
   * int value;
   * adjustment \= gtk_spin_button_get_adjustment $(LPAREN)spin$(RPAREN);
   * value \= $(LPAREN)int$(RPAREN)gtk_adjustment_get_value $(LPAREN)adjustment$(RPAREN);
   * text \= g_strdup_printf $(LPAREN)"%02d", value$(RPAREN);
   * gtk_entry_set_text $(LPAREN)GTK_ENTRY $(LPAREN)spin$(RPAREN), text$(RPAREN);
