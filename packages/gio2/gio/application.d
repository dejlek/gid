...
class Application : gobject.object.ObjectG, gio.action_group.ActionGroup, gio.action_map.ActionMap
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B commandLine)       a #GApplicationCommandLine representing the
            passed commandline
      * $(B application) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B options)       the options dictionary
      * $(B application) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B files)       an array of #GFiles
      * $(B hint)       a hint provided by the calling instance
      * $(B application) the instance the signal is connected to
    )
  */
