...
class Settings : gobject.object.ObjectG
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B keys)       an array of #GQuarks for the changed keys, or null
      * $(B settings) the instance the signal is connected to
    )
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B key)       the name of the key that changed
      * $(B settings) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B key)       the quark of the key, or 0
      * $(B settings) the instance the signal is connected to
    )
    Returns:     true to stop other handlers from being invoked for the
               event. FALSE to propagate the event further.
