...
class ContextMenuItem : gobject.initially_unowned.InitiallyUnowned
{
  ...
  */
  static webkitwebprocessextension.context_menu_item.ContextMenuItem newFromGaction(gio.action.Action action, string label, glib.variant.VariantG target = null)
  {
  ...
  */
  webkitwebprocessextension.context_menu.ContextMenu getSubmenu()
  {
    ...
    auto _retval = ObjectG.getDObject!(webkitwebprocessextension.context_menu.ContextMenu)(cast(WebKitContextMenu*)_cretval, No.Take);
    return _retval;
  }
