...
{
  // Context
  extern(C) GType function() c_cairo_gobject_context_get_type;
  ...
  // Device
  extern(C) GType function() c_cairo_gobject_device_get_type;
  ...
  // FontFace
  extern(C) GType function() c_cairo_gobject_font_face_get_type;
  ...
  // FontOptions
  extern(C) GType function() c_cairo_gobject_font_options_get_type;
  ...
  // Glyph
  extern(C) GType function() c_cairo_gobject_glyph_get_type;
  void function(cairo_glyph_t* glyphs) c_cairo_glyph_free;

  // Matrix
  extern(C) GType function() c_cairo_gobject_matrix_get_type;
  ...
  // Path
  extern(C) GType function() c_cairo_gobject_path_get_type;
  void function(cairo_path_t* path) c_cairo_path_destroy;

  // Pattern
  extern(C) GType function() c_cairo_gobject_pattern_get_type;
  ...
  // Rectangle
  extern(C) GType function() c_cairo_gobject_rectangle_get_type;

  // RectangleInt
  extern(C) GType function() c_cairo_gobject_rectangle_int_get_type;

  // RectangleList
  extern(C) GType function() c_cairo_gobject_rectangle_list_get_type;
  void function(cairo_rectangle_list_t* rectangleList) c_cairo_rectangle_list_destroy;

  // Region
  extern(C) GType function() c_cairo_gobject_region_get_type;
  ...
  // ScaledFont
  extern(C) GType function() c_cairo_gobject_scaled_font_get_type;
  ...
  // Surface
  extern(C) GType function() c_cairo_gobject_surface_get_type;
  ...
  // TextCluster
  extern(C) GType function() c_cairo_gobject_text_cluster_get_type;
