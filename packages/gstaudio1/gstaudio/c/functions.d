...
{
  // AudioAggregator
  extern(C) GType function() c_gst_audio_aggregator_get_type;
  ...
  extern(C) GType function() c_gst_audio_aggregator_convert_pad_get_type;

  // AudioAggregatorPad
  extern(C) GType function() c_gst_audio_aggregator_pad_get_type;

  // AudioBaseSink
  extern(C) GType function() c_gst_audio_base_sink_get_type;
  ...
  // AudioBaseSrc
  extern(C) GType function() c_gst_audio_base_src_get_type;
  ...
  // AudioCdSrc
  extern(C) GType function() c_gst_audio_cd_src_get_type;
  ...
  // AudioClock
  extern(C) GType function() c_gst_audio_clock_get_type;
  ...
  // AudioConverter
  extern(C) GType function() c_gst_audio_converter_get_type;
  ...
  // AudioDecoder
  extern(C) GType function() c_gst_audio_decoder_get_type;
  ...
  // AudioEncoder
  extern(C) GType function() c_gst_audio_encoder_get_type;
  ...
  // AudioFilter
  extern(C) GType function() c_gst_audio_filter_get_type;
  ...
  // AudioInfo
  extern(C) GType function() c_gst_audio_info_get_type;
  ...
  // AudioRingBuffer
  extern(C) GType function() c_gst_audio_ring_buffer_get_type;
  ...
  // AudioSink
  extern(C) GType function() c_gst_audio_sink_get_type;

  // AudioSrc
  extern(C) GType function() c_gst_audio_src_get_type;

  // AudioStreamAlign
  extern(C) GType function() c_gst_audio_stream_align_get_type;
  ...
  // DsdInfo
  extern(C) GType function() c_gst_dsd_info_get_type;
  ...
  // StreamVolume
  extern(C) GType function() c_gst_stream_volume_get_type;
