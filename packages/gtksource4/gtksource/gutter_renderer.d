...
class GutterRenderer : gobject.initially_unowned.InitiallyUnowned
{
  ...
  */
  ...
  /**
    ...
    $(LIST
      ...
      * $(B event)       the event that caused the activation
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B iter)       a #GtkTextIter
      * $(B area)       a #GdkRectangle
      * $(B event)       the #GdkEvent that is causing the activatable query
      * $(B gutterRenderer) the instance the signal is connected to
    )
    Returns: 
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B start)       a #GtkTextIter
      * $(B end)       a #GtkTextIter
      * $(B state)       the renderer state
      * $(B gutterRenderer) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B iter)       a #GtkTextIter
      * $(B area)       a #GdkRectangle
      * $(B x)       the x position (in window coordinates)
      * $(B y)       the y position (in window coordinates)
