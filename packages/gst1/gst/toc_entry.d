...
class TocEntry : gobject.boxed.Boxed
{
  ...
  */
  ...
  {
    gst_toc_entry_append_sub_entry(cast(GstTocEntry*)cPtr, subentry ? cast(GstTocEntry*)subentry.cPtr(Yes.Dup) : null);
  }
  ...
  gst.types.TocEntryType getEntryType()
  {
    ...
    _cretval = gst_toc_entry_get_entry_type(cast(const(GstTocEntry)*)cPtr);
  ...
  */
  ...
  {
    bool _retval;
    _retval = gst_toc_entry_get_loop(cast(const(GstTocEntry)*)cPtr, &loopType, cast(int*)&repeatCount);
    return _retval;
  }
  ...
  */
  ...
  {
    GstTocEntry* _cretval;
    _cretval = gst_toc_entry_get_parent(cast(GstTocEntry*)cPtr);
  ...
  */
  ...
  {
    bool _retval;
    _retval = gst_toc_entry_get_start_stop_times(cast(const(GstTocEntry)*)cPtr, cast(long*)&start, cast(long*)&stop);
    return _retval;
  }
  ...
  */
  ...
  {
    GList* _cretval;
    _cretval = gst_toc_entry_get_sub_entries(cast(const(GstTocEntry)*)cPtr);
  ...
  */
  ...
  {
    GstTagList* _cretval;
    _cretval = gst_toc_entry_get_tags(cast(const(GstTocEntry)*)cPtr);
  ...
  */
  ...
  {
    GstToc* _cretval;
    _cretval = gst_toc_entry_get_toc(cast(GstTocEntry*)cPtr);
  ...
  */
  ...
  {
    const(char)* _cretval;
    _cretval = gst_toc_entry_get_uid(cast(const(GstTocEntry)*)cPtr);
  ...
  {
    bool _retval;
    _retval = gst_toc_entry_is_alternative(cast(const(GstTocEntry)*)cPtr);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = gst_toc_entry_is_sequence(cast(const(GstTocEntry)*)cPtr);
    return _retval;
  }
  ...
  */
  ...
  {
    gst_toc_entry_merge_tags(cast(GstTocEntry*)cPtr, tags ? cast(GstTagList*)tags.cPtr(No.Dup) : null, mode);
  }
  ...
  */
  ...
  {
    gst_toc_entry_set_loop(cast(GstTocEntry*)cPtr, loopType, repeatCount);
  }
  ...
  */
  ...
  {
    gst_toc_entry_set_start_stop_times(cast(GstTocEntry*)cPtr, start, stop);
  }
  ...
  */
  ...
  {
    gst_toc_entry_set_tags(cast(GstTocEntry*)cPtr, tags ? cast(GstTagList*)tags.cPtr(Yes.Dup) : null);
  }
}
