...
class PadTemplate : gst.object.ObjectGst
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B pad)       the pad that was created.
      * $(B padTemplate) the instance the signal is connected to
    )
  */
  alias PadCreatedCallbackDlg = void delegate(gst.pad.Pad pad, gst.pad_template.PadTemplate padTemplate);

  /** ditto */
  alias PadCreatedCallbackFunc = void function(gst.pad.Pad pad, gst.pad_template.PadTemplate padTemplate);
  ...
  */
  ...
  if (is(T : PadCreatedCallbackDlg) || is(T : PadCreatedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto padTemplate = getVal!(gst.pad_template.PadTemplate)(_paramVals);
      auto pad = getVal!(gst.pad.Pad)(&_paramVals[1]);
      _dClosure.dlg(pad, padTemplate);
    }
