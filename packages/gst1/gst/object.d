...
class ObjectGst : gobject.initially_unowned.InitiallyUnowned
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B propObject)       the object that originated the signal
      * $(B prop)       the property that changed
      * $(B objectGst) the instance the signal is connected to
    )
  */
  alias DeepNotifyCallbackDlg = void delegate(gst.object.ObjectGst propObject, gobject.param_spec.ParamSpec prop, gst.object.ObjectGst objectGst);

  /** ditto */
  alias DeepNotifyCallbackFunc = void function(gst.object.ObjectGst propObject, gobject.param_spec.ParamSpec prop, gst.object.ObjectGst objectGst);
  ...
  */
  ...
  if (is(T : DeepNotifyCallbackDlg) || is(T : DeepNotifyCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto objectGst = getVal!(gst.object.ObjectGst)(_paramVals);
      auto propObject = getVal!(gst.object.ObjectGst)(&_paramVals[1]);
      auto prop = getVal!(gobject.param_spec.ParamSpec)(&_paramVals[2]);
      _dClosure.dlg(propObject, prop, objectGst);
    }
