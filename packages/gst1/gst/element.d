...
class Element : gst.object.ObjectGst
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B element) the instance the signal is connected to
    )
  */
  alias NoMorePadsCallbackDlg = void delegate(gst.element.Element element);

  /** ditto */
  alias NoMorePadsCallbackFunc = void function(gst.element.Element element);
  ...
  */
  ...
  if (is(T : NoMorePadsCallbackDlg) || is(T : NoMorePadsCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto element = getVal!(gst.element.Element)(_paramVals);
      _dClosure.dlg(element);
    }
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B newPad)       the pad that has been added
      * $(B element) the instance the signal is connected to
    )
  */
  alias PadAddedCallbackDlg = void delegate(gst.pad.Pad newPad, gst.element.Element element);

  /** ditto */
  alias PadAddedCallbackFunc = void function(gst.pad.Pad newPad, gst.element.Element element);
  ...
  */
  ...
  if (is(T : PadAddedCallbackDlg) || is(T : PadAddedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto element = getVal!(gst.element.Element)(_paramVals);
      auto newPad = getVal!(gst.pad.Pad)(&_paramVals[1]);
      _dClosure.dlg(newPad, element);
    }
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B oldPad)       the pad that has been removed
      * $(B element) the instance the signal is connected to
    )
  */
  alias PadRemovedCallbackDlg = void delegate(gst.pad.Pad oldPad, gst.element.Element element);

  /** ditto */
  alias PadRemovedCallbackFunc = void function(gst.pad.Pad oldPad, gst.element.Element element);
  ...
  */
  ...
  if (is(T : PadRemovedCallbackDlg) || is(T : PadRemovedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto _dClosure = cast(DGClosure!T*)_closure;
      auto element = getVal!(gst.element.Element)(_paramVals);
      auto oldPad = getVal!(gst.pad.Pad)(&_paramVals[1]);
      _dClosure.dlg(oldPad, element);
    }
