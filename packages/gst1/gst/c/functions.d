...
{
  // AllocationParams
  extern(C) GType function() c_gst_allocation_params_get_type;
  ...
  // Allocator
  extern(C) GType function() c_gst_allocator_get_type;
  ...
  // AtomicQueue
  extern(C) GType function() c_gst_atomic_queue_get_type;
  ...
  // Bin
  extern(C) GType function() c_gst_bin_get_type;
  ...
  // Bitmask
  extern(C) GType function() c_gst_bitmask_get_type;

  // Buffer
  extern(C) GType function() c_gst_buffer_get_type;
  ...
  // BufferList
  extern(C) GType function() c_gst_buffer_list_get_type;
  ...
  // BufferPool
  extern(C) GType function() c_gst_buffer_pool_get_type;
  ...
  // Bus
  extern(C) GType function() c_gst_bus_get_type;
  ...
  // Caps
  extern(C) GType function() c_gst_caps_get_type;
  ...
  // CapsFeatures
  extern(C) GType function() c_gst_caps_features_get_type;
  ...
  // ChildProxy
  extern(C) GType function() c_gst_child_proxy_get_type;
  void function(GstChildProxy* parent, ObjectC* child, const(char)* name) c_gst_child_proxy_child_added;
  void function(GstChildProxy* parent, ObjectC* child, const(char)* name) c_gst_child_proxy_child_removed;
  void function(GstChildProxy* object, const(char)* firstPropertyName,  ...) c_gst_child_proxy_get;
  ObjectC* function(GstChildProxy* parent, uint index) c_gst_child_proxy_get_child_by_index;
  ObjectC* function(GstChildProxy* parent, const(char)* name) c_gst_child_proxy_get_child_by_name;
  ObjectC* function(GstChildProxy* childProxy, const(char)* name) c_gst_child_proxy_get_child_by_name_recurse;
  ...
  bool function(GstChildProxy* object, const(char)* name, ObjectC** target, GParamSpec** pspec) c_gst_child_proxy_lookup;
  ...
  // Clock
  extern(C) GType function() c_gst_clock_get_type;
  ...
  // Context
  extern(C) GType function() c_gst_context_get_type;
  ...
  // ControlBinding
  extern(C) GType function() c_gst_control_binding_get_type;
  ...
  // ControlSource
  extern(C) GType function() c_gst_control_source_get_type;
  ...
  // DateTime
  extern(C) GType function() c_gst_date_time_get_type;
  ...
  // Device
  extern(C) GType function() c_gst_device_get_type;
  ...
  // DeviceMonitor
  extern(C) GType function() c_gst_device_monitor_get_type;
  ...
  // DeviceProvider
  extern(C) GType function() c_gst_device_provider_get_type;
  ...
  extern(C) GType function() c_gst_device_provider_factory_get_type;
  ...
  // DoubleRange
  extern(C) GType function() c_gst_double_range_get_type;

  // DynamicTypeFactory
  extern(C) GType function() c_gst_dynamic_type_factory_get_type;
  GType function(const(char)* factoryname) c_gst_dynamic_type_factory_load;

  // Element
  extern(C) GType function() c_gst_element_get_type;
  ...
  // ElementFactory
  extern(C) GType function() c_gst_element_factory_get_type;
  ...
  // Event
  extern(C) GType function() c_gst_event_get_type;
  ...
  // FlagSet
  extern(C) GType function() c_gst_flagset_get_type;
  GType function(GType flagsType) c_gst_flagset_register;

  // Fraction
  extern(C) GType function() c_gst_fraction_get_type;

  // FractionRange
  extern(C) GType function() c_gst_fraction_range_get_type;

  // GhostPad
  extern(C) GType function() c_gst_ghost_pad_get_type;
  ...
  // Int64Range
  extern(C) GType function() c_gst_int64_range_get_type;

  // IntRange
  extern(C) GType function() c_gst_int_range_get_type;

  // Iterator
  extern(C) GType function() c_gst_iterator_get_type;
  ...
  GstIterator* function(GType type, GMutex* lock, uint* masterCookie, GList** list, ObjectC* owner, GstIteratorItemFunction item) c_gst_iterator_new_list;
  ...
  // Memory
  extern(C) GType function() c_gst_memory_get_type;
  ...
  // Message
  extern(C) GType function() c_gst_message_get_type;
  ...
  // MiniObject
  extern(C) GType function() c_gst_mini_object_get_type;
  ...
  // ObjectGst
  extern(C) GType function() c_gst_object_get_type;
  ...
  // Pad
  extern(C) GType function() c_gst_pad_get_type;
  ...
  // PadTemplate
  extern(C) GType function() c_gst_pad_template_get_type;
  ...
  // ParamArray
  extern(C) GType function() c_gst_param_spec_array_get_type;

  // ParamFraction
  extern(C) GType function() c_gst_param_spec_fraction_get_type;

  // ParentBufferMeta
  const(GstMetaInfo)* function() c_gst_parent_buffer_meta_get_info;

  // ParseContext
  extern(C) GType function() c_gst_parse_context_get_type;
  ...
  // Pipeline
  extern(C) GType function() c_gst_pipeline_get_type;
  ...
  // Plugin
  extern(C) GType function() c_gst_plugin_get_type;
  ...
  // PluginFeature
  extern(C) GType function() c_gst_plugin_feature_get_type;
  ...
  // Preset
  extern(C) GType function() c_gst_preset_get_type;
  ...
  // Promise
  extern(C) GType function() c_gst_promise_get_type;
  ...
  // ProxyPad
  extern(C) GType function() c_gst_proxy_pad_get_type;
  ...
  // Query
  extern(C) GType function() c_gst_query_get_type;
  ...
  // Registry
  extern(C) GType function() c_gst_registry_get_type;
  ...
  // Sample
  extern(C) GType function() c_gst_sample_get_type;
  ...
  // Segment
  extern(C) GType function() c_gst_segment_get_type;
  ...
  // SharedTaskPool
  extern(C) GType function() c_gst_shared_task_pool_get_type;
  ...
  // Stream
  extern(C) GType function() c_gst_stream_get_type;
  ...
  // StreamCollection
  extern(C) GType function() c_gst_stream_collection_get_type;
  ...
  // Structure
  extern(C) GType function() c_gst_structure_get_type;
  ...
  // TagSetter
  extern(C) GType function() c_gst_tag_setter_get_type;
  ...
  // Task
  extern(C) GType function() c_gst_task_get_type;
  ...
  // TaskPool
  extern(C) GType function() c_gst_task_pool_get_type;
  ...
  // Toc
  extern(C) GType function() c_gst_toc_get_type;
  ...
  // TocEntry
  extern(C) GType function() c_gst_toc_entry_get_type;
  ...
  // TocSetter
  extern(C) GType function() c_gst_toc_setter_get_type;
  ...
  // TypeFindFactory
  extern(C) GType function() c_gst_type_find_factory_get_type;
  ...
  // URIHandler
  extern(C) GType function() c_gst_uri_handler_get_type;
  ...
  // Uri
  extern(C) GType function() c_gst_uri_get_type;
  ...
  // ValueArray
  extern(C) GType function() c_gst_value_array_get_type;
  ...
  // ValueList
  extern(C) GType function() c_gst_value_list_get_type;
  ...
  void function(GstDebugCategory* category, GstDebugLevel level, const(char)* file, const(char)* function_, int line, ObjectC* object, const(char)* format,  ...) c_gst_debug_log;
  void function(GstDebugCategory* category, GstDebugLevel level, const(char)* file, const(char)* function_, int line, ObjectC* object, GstDebugMessage* message, void* userData) c_gst_debug_log_default;
  char* function(GstDebugCategory* category, GstDebugLevel level, const(char)* file, const(char)* function_, int line, ObjectC* object, GstDebugMessage* message) c_gst_debug_log_get_line;
  ...
  void function(GstDebugCategory* category, GstDebugLevel level, const(char)* file, const(char)* function_, int line, ObjectC* object, const(char)* messageString) c_gst_debug_log_literal;
  void function(GstDebugCategory* category, GstDebugLevel level, const(char)* file, const(char)* function_, int line, ObjectC* object, const(char)* format, void* args) c_gst_debug_log_valist;
  ...
  bool function(ObjectC* object, const(char)* name, GValueArray** array) c_gst_util_get_object_array;
  ...
  void function(ObjectC* object, const(char)* name, const(char)* value) c_gst_util_set_object_arg;
  bool function(ObjectC* object, const(char)* name, const(GValueArray)* array) c_gst_util_set_object_array;
