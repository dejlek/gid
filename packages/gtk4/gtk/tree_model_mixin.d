...
template TreeModelT()
{
  ...
  */
  override gtk.tree_model.TreeModel filterNew(gtk.tree_path.TreePath root = null)
  {
    ...
    auto _retval = ObjectG.getDObject!(gtk.tree_model.TreeModel)(cast(GtkTreeModel*)_cretval, Yes.Take);
    return _retval;
  }
  ...
  */
  override void foreach_(gtk.types.TreeModelForeachFunc func)
  {
    extern(C) bool _funcCallback(GtkTreeModel* model, GtkTreePath* path, GtkTreeIter* iter, void* data)
    {
      ...
      bool _retval = (*_dlg)(ObjectG.getDObject!(gtk.tree_model.TreeModel)(cast(void*)model, No.Take), path ? new gtk.tree_path.TreePath(cast(void*)path, No.Take) : null, iter ? new gtk.tree_iter.TreeIter(cast(void*)iter, No.Take) : null);
      return _retval;
    }
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       a [gtk.tree_path.TreePath] identifying the changed row
      * $(B iter)       a valid [gtk.tree_iter.TreeIter] pointing to the changed row
      * $(B treeModel) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  if (is(T : RowChangedCallbackDlg) || is(T : RowChangedCallbackFunc))
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      auto treeModel = getVal!(gtk.tree_model.TreeModel)(_paramVals);
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       a [gtk.tree_path.TreePath] identifying the row
      * $(B treeModel) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    $(LIST
      * $(B path)       a [gtk.tree_path.TreePath] identifying the row
      * $(B iter)       a valid [gtk.tree_iter.TreeIter] pointing to the row
      * $(B treeModel) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       a [gtk.tree_path.TreePath] identifying the new row
      * $(B iter)       a valid [gtk.tree_iter.TreeIter] pointing to the new row
      * $(B treeModel) the instance the signal is connected to
    )
  */
