...
class TreeView : gtk.widget.Widget, gtk.scrollable.Scrollable
{
  ...
  */
  ...
  /**
    ...
    $(LIST
      ...
      * $(B direction)       the direction to move: +1 to move forwards; -1 to move
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B path)       the [gtk.tree_path.TreePath] for the activated row
      * $(B column)       the [gtk.tree_view_column.TreeViewColumn] in which the activation occurred
      * $(B treeView) the instance the signal is connected to
    )
  */
