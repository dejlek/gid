...
class SignalListItemFactory : gtk.list_item_factory.ListItemFactory
{
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B object)       The [gobject.object.ObjectG] to bind
      * $(B signalListItemFactory) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B object)       The [gobject.object.ObjectG] to set up
      * $(B signalListItemFactory) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B object)       The [gobject.object.ObjectG] to tear down
      * $(B signalListItemFactory) the instance the signal is connected to
    )
  */
  ...
  */
  ...
  /**
    ...
    ## Parameters
    $(LIST
      * $(B object)       The [gobject.object.ObjectG] to unbind
      * $(B signalListItemFactory) the instance the signal is connected to
    )
  */
