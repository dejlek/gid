...
// Enums
alias GtkAccessibleAnnouncementPriority = gtk.types.AccessibleAnnouncementPriority;
alias GtkAccessibleAutocomplete = gtk.types.AccessibleAutocomplete;
alias GtkAccessibleInvalidState = gtk.types.AccessibleInvalidState;
alias GtkAccessiblePlatformState = gtk.types.AccessiblePlatformState;
alias GtkAccessibleProperty = gtk.types.AccessibleProperty;
alias GtkAccessibleRelation = gtk.types.AccessibleRelation;
alias GtkAccessibleRole = gtk.types.AccessibleRole;
alias GtkAccessibleSort = gtk.types.AccessibleSort;
alias GtkAccessibleState = gtk.types.AccessibleState;
alias GtkAccessibleTextContentChange = gtk.types.AccessibleTextContentChange;
alias GtkAccessibleTextGranularity = gtk.types.AccessibleTextGranularity;
alias GtkAccessibleTristate = gtk.types.AccessibleTristate;
...
alias GtkBuilderClosureFlags = gtk.types.BuilderClosureFlags;
...
alias GtkCollation = gtk.types.Collation;
alias GtkConstraintAttribute = gtk.types.ConstraintAttribute;
alias GtkConstraintRelation = gtk.types.ConstraintRelation;
alias GtkConstraintStrength = gtk.types.ConstraintStrength;
alias GtkConstraintVflParserError = gtk.types.ConstraintVflParserError;
alias GtkContentFit = gtk.types.ContentFit;
alias GtkCornerType = gtk.types.CornerType;
alias GtkCssParserError = gtk.types.CssParserError;
alias GtkCssParserWarning = gtk.types.CssParserWarning;
alias GtkDebugFlags = gtk.types.DebugFlags;
alias GtkDeleteType = gtk.types.DeleteType;
alias GtkDialogError = gtk.types.DialogError;
alias GtkDialogFlags = gtk.types.DialogFlags;
alias GtkDirectionType = gtk.types.DirectionType;
alias GtkEditableProperties = gtk.types.EditableProperties;
...
alias GtkFilterChange = gtk.types.FilterChange;
alias GtkFilterMatch = gtk.types.FilterMatch;
alias GtkFontChooserLevel = gtk.types.FontChooserLevel;
alias GtkFontLevel = gtk.types.FontLevel;
alias GtkGraphicsOffloadEnabled = gtk.types.GraphicsOffloadEnabled;
...
alias GtkInscriptionOverflow = gtk.types.InscriptionOverflow;
...
alias GtkListScrollFlags = gtk.types.ListScrollFlags;
alias GtkListTabBehavior = gtk.types.ListTabBehavior;
alias GtkMessageType = gtk.types.MessageType;
alias GtkMovementStep = gtk.types.MovementStep;
alias GtkNaturalWrapMode = gtk.types.NaturalWrapMode;
alias GtkNotebookTab = gtk.types.NotebookTab;
alias GtkNumberUpLayout = gtk.types.NumberUpLayout;
alias GtkOrdering = gtk.types.Ordering;
alias GtkOrientation = gtk.types.Orientation;
alias GtkOverflow = gtk.types.Overflow;
...
alias GtkPickFlags = gtk.types.PickFlags;
alias GtkPolicyType = gtk.types.PolicyType;
alias GtkPopoverMenuFlags = gtk.types.PopoverMenuFlags;
alias GtkPositionType = gtk.types.PositionType;
alias GtkPrintCapabilities = gtk.types.PrintCapabilities;
...
alias GtkPropagationLimit = gtk.types.PropagationLimit;
...
alias GtkShortcutActionFlags = gtk.types.ShortcutActionFlags;
alias GtkShortcutScope = gtk.types.ShortcutScope;
...
alias GtkSorterChange = gtk.types.SorterChange;
alias GtkSorterOrder = gtk.types.SorterOrder;
...
alias GtkStringFilterMatchMode = gtk.types.StringFilterMatchMode;
alias GtkStyleContextPrintFlags = gtk.types.StyleContextPrintFlags;
alias GtkSymbolicColor = gtk.types.SymbolicColor;
alias GtkSystemSetting = gtk.types.SystemSetting;
