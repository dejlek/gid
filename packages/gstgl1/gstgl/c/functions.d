...
{
  // GLAllocationParams
  extern(C) GType function() c_gst_gl_allocation_params_get_type;
  ...
  // GLBaseFilter
  extern(C) GType function() c_gst_gl_base_filter_get_type;
  ...
  // GLBaseMemory
  extern(C) GType function() c_gst_gl_base_memory_get_type;
  ...
  extern(C) GType function() c_gst_gl_base_memory_allocator_get_type;

  // GLBaseMixer
  extern(C) GType function() c_gst_gl_base_mixer_get_type;
  GstGLContext* function(GstGLBaseMixer* mix) c_gst_gl_base_mixer_get_gl_context;

  // GLBaseMixerPad
  extern(C) GType function() c_gst_gl_base_mixer_pad_get_type;

  // GLBaseSrc
  extern(C) GType function() c_gst_gl_base_src_get_type;

  // GLBuffer
  extern(C) GType function() c_gst_gl_buffer_get_type;
  void function() c_gst_gl_buffer_init_once;

  // GLBufferAllocationParams
  extern(C) GType function() c_gst_gl_buffer_allocation_params_get_type;
  ...
  // GLBufferAllocator
  extern(C) GType function() c_gst_gl_buffer_allocator_get_type;

  // GLBufferPool
  extern(C) GType function() c_gst_gl_buffer_pool_get_type;
  ...
  // GLColorConvert
  extern(C) GType function() c_gst_gl_color_convert_get_type;
  ...
  // GLContext
  extern(C) GType function() c_gst_gl_context_get_type;
  ...
  // GLDisplay
  extern(C) GType function() c_gst_gl_display_get_type;
  ...
  // GLFilter
  extern(C) GType function() c_gst_gl_filter_get_type;
  ...
  // GLFramebuffer
  extern(C) GType function() c_gst_gl_framebuffer_get_type;
  ...
  // GLMemory
  extern(C) GType function() c_gst_gl_memory_get_type;
  ...
  // GLMemoryAllocator
  extern(C) GType function() c_gst_gl_memory_allocator_get_type;
  GstGLMemoryAllocator* function(GstGLContext* context) c_gst_gl_memory_allocator_get_default;

  // GLMemoryPBO
  extern(C) GType function() c_gst_gl_memory_pbo_get_type;
  ...
  extern(C) GType function() c_gst_gl_memory_pbo_allocator_get_type;

  // GLMixer
  extern(C) GType function() c_gst_gl_mixer_get_type;
  ...
  // GLMixerPad
  extern(C) GType function() c_gst_gl_mixer_pad_get_type;

  // GLOverlayCompositor
  extern(C) GType function() c_gst_gl_overlay_compositor_get_type;
  ...
  // GLRenderbuffer
  extern(C) GType function() c_gst_gl_renderbuffer_get_type;
  ...
  extern(C) GType function() c_gst_gl_renderbuffer_allocation_params_get_type;
  ...
  extern(C) GType function() c_gst_gl_renderbuffer_allocator_get_type;

  // GLSLStage
  extern(C) GType function() c_gst_glsl_stage_get_type;
  ...
  // GLShader
  extern(C) GType function() c_gst_gl_shader_get_type;
  ...
  // GLUpload
  extern(C) GType function() c_gst_gl_upload_get_type;
  ...
  extern(C) GType function() c_gst_gl_video_allocation_params_get_type;
  ...
  // GLViewConvert
  extern(C) GType function() c_gst_gl_view_convert_get_type;
  ...
  // GLWindow
  extern(C) GType function() c_gst_gl_window_get_type;
