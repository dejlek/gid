...
{
  // Array
  extern(C) GType function() c_json_array_get_type;
  ...
  // Builder
  extern(C) GType function() c_json_builder_get_type;
  ...
  // Generator
  extern(C) GType function() c_json_generator_get_type;
  ...
  // Node
  extern(C) GType function() c_json_node_get_type;
  ...
  // ObjectJson
  extern(C) GType function() c_json_object_get_type;
  ...
  // Parser
  extern(C) GType function() c_json_parser_get_type;
  ...
  // Path
  extern(C) GType function() c_json_path_get_type;
  ...
  // Reader
  extern(C) GType function() c_json_reader_get_type;
  ...
  // Serializable
  extern(C) GType function() c_json_serializable_get_type;
