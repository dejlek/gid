...
// Enums
alias SoupCacheType = soup.types.CacheType;
alias SoupCacheability = soup.types.Cacheability;
alias SoupCookieJarAcceptPolicy = soup.types.CookieJarAcceptPolicy;
alias SoupDateFormat = soup.types.DateFormat;
alias SoupEncoding = soup.types.Encoding;
alias SoupExpectation = soup.types.Expectation;
alias SoupHTTPVersion = soup.types.HTTPVersion;
alias SoupLoggerLogLevel = soup.types.LoggerLogLevel;
alias SoupMemoryUse = soup.types.MemoryUse;
alias SoupMessageFlags = soup.types.MessageFlags;
alias SoupMessageHeadersType = soup.types.MessageHeadersType;
alias SoupMessagePriority = soup.types.MessagePriority;
alias SoupSameSitePolicy = soup.types.SameSitePolicy;
alias SoupServerListenOptions = soup.types.ServerListenOptions;
alias SoupSessionError = soup.types.SessionError;
alias SoupStatus = soup.types.Status;
alias SoupTLDError = soup.types.TLDError;
alias SoupURIComponent = soup.types.URIComponent;
alias SoupWebsocketCloseCode = soup.types.WebsocketCloseCode;
alias SoupWebsocketConnectionType = soup.types.WebsocketConnectionType;
alias SoupWebsocketDataType = soup.types.WebsocketDataType;
alias SoupWebsocketError = soup.types.WebsocketError;
alias SoupWebsocketState = soup.types.WebsocketState;
/**
