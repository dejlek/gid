...
{
  // Auth
  extern(C) GType function() c_soup_auth_get_type;
  ...
  // AuthBasic
  extern(C) GType function() c_soup_auth_basic_get_type;

  // AuthDigest
  extern(C) GType function() c_soup_auth_digest_get_type;

  // AuthDomain
  extern(C) GType function() c_soup_auth_domain_get_type;
  ...
  // AuthDomainBasic
  extern(C) GType function() c_soup_auth_domain_basic_get_type;
  ...
  // AuthDomainDigest
  extern(C) GType function() c_soup_auth_domain_digest_get_type;
  ...
  // AuthManager
  extern(C) GType function() c_soup_auth_manager_get_type;
  ...
  // AuthNTLM
  extern(C) GType function() c_soup_auth_ntlm_get_type;

  // AuthNegotiate
  extern(C) GType function() c_soup_auth_negotiate_get_type;
  bool function() c_soup_auth_negotiate_supported;

  // Cache
  extern(C) GType function() c_soup_cache_get_type;
  ...
  // ContentDecoder
  extern(C) GType function() c_soup_content_decoder_get_type;

  // ContentSniffer
  extern(C) GType function() c_soup_content_sniffer_get_type;
  ...
  // Cookie
  extern(C) GType function() c_soup_cookie_get_type;
  ...
  // CookieJar
  extern(C) GType function() c_soup_cookie_jar_get_type;
  ...
  // CookieJarDB
  extern(C) GType function() c_soup_cookie_jar_db_get_type;
  ...
  // HSTSEnforcerDB
  extern(C) GType function() c_soup_hsts_enforcer_db_get_type;
  SoupHSTSEnforcer* function(const(char)* filename) c_soup_hsts_enforcer_db_new;

  // HSTSPolicy
  extern(C) GType function() c_soup_hsts_policy_get_type;
  ...
  // Logger
  extern(C) GType function() c_soup_logger_get_type;
  ...
  // Message
  extern(C) GType function() c_soup_message_get_type;
  ...
  // MessageBody
  extern(C) GType function() c_soup_message_body_get_type;
  ...
  // MessageHeaders
  extern(C) GType function() c_soup_message_headers_get_type;
  ...
  // MessageMetrics
  extern(C) GType function() c_soup_message_metrics_get_type;
  ...
  // Multipart
  extern(C) GType function() c_soup_multipart_get_type;
  ...
  extern(C) GType function() c_soup_multipart_input_stream_get_type;
  ...
  // Server
  extern(C) GType function() c_soup_server_get_type;
  ...
  // ServerMessage
  extern(C) GType function() c_soup_server_message_get_type;
  ...
  // Session
  extern(C) GType function() c_soup_session_get_type;
  ...
  // SessionFeature
  extern(C) GType function() c_soup_session_feature_get_type;

  // WebsocketConnection
  extern(C) GType function() c_soup_websocket_connection_get_type;
  ...
  // WebsocketExtension
  extern(C) GType function() c_soup_websocket_extension_get_type;
  ...
  extern(C) GType function() c_soup_websocket_extension_deflate_get_type;
