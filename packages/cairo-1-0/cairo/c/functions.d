...
{
  // Context
  gidLink(cairo_gobject_context_get_type, "cairo_gobject_context_get_type", LIBS);
  gidLink(cairo_append_path, "cairo_append_path", LIBS);
  gidLink(cairo_arc, "cairo_arc", LIBS);
  gidLink(cairo_arc_negative, "cairo_arc_negative", LIBS);
  gidLink(cairo_clip, "cairo_clip", LIBS);
  gidLink(cairo_clip_extents, "cairo_clip_extents", LIBS);
  gidLink(cairo_clip_preserve, "cairo_clip_preserve", LIBS);
  gidLink(cairo_close_path, "cairo_close_path", LIBS);
  gidLink(cairo_copy_clip_rectangle_list, "cairo_copy_clip_rectangle_list", LIBS);
  gidLink(cairo_copy_page, "cairo_copy_page", LIBS);
  gidLink(cairo_copy_path, "cairo_copy_path", LIBS);
  gidLink(cairo_copy_path_flat, "cairo_copy_path_flat", LIBS);
  gidLink(cairo_curve_to, "cairo_curve_to", LIBS);
  gidLink(cairo_device_to_user, "cairo_device_to_user", LIBS);
  gidLink(cairo_device_to_user_distance, "cairo_device_to_user_distance", LIBS);
  gidLink(cairo_fill, "cairo_fill", LIBS);
  gidLink(cairo_fill_extents, "cairo_fill_extents", LIBS);
  gidLink(cairo_fill_preserve, "cairo_fill_preserve", LIBS);
  gidLink(cairo_font_extents, "cairo_font_extents", LIBS);
  gidLink(cairo_get_antialias, "cairo_get_antialias", LIBS);
  gidLink(cairo_get_current_point, "cairo_get_current_point", LIBS);
  gidLink(cairo_get_dash, "cairo_get_dash", LIBS);
  gidLink(cairo_get_dash_count, "cairo_get_dash_count", LIBS);
  gidLink(cairo_get_fill_rule, "cairo_get_fill_rule", LIBS);
  gidLink(cairo_get_font_face, "cairo_get_font_face", LIBS);
  gidLink(cairo_get_font_matrix, "cairo_get_font_matrix", LIBS);
  gidLink(cairo_get_font_options, "cairo_get_font_options", LIBS);
  gidLink(cairo_get_group_target, "cairo_get_group_target", LIBS);
  gidLink(cairo_get_hairline, "cairo_get_hairline", LIBS);
  gidLink(cairo_get_line_cap, "cairo_get_line_cap", LIBS);
  gidLink(cairo_get_line_join, "cairo_get_line_join", LIBS);
  gidLink(cairo_get_line_width, "cairo_get_line_width", LIBS);
  gidLink(cairo_get_matrix, "cairo_get_matrix", LIBS);
  gidLink(cairo_get_miter_limit, "cairo_get_miter_limit", LIBS);
  gidLink(cairo_get_operator, "cairo_get_operator", LIBS);
  gidLink(cairo_get_scaled_font, "cairo_get_scaled_font", LIBS);
  gidLink(cairo_get_source, "cairo_get_source", LIBS);
  gidLink(cairo_get_target, "cairo_get_target", LIBS);
  gidLink(cairo_get_tolerance, "cairo_get_tolerance", LIBS);
  gidLink(cairo_glyph_extents, "cairo_glyph_extents", LIBS);
  gidLink(cairo_glyph_path, "cairo_glyph_path", LIBS);
  gidLink(cairo_has_current_point, "cairo_has_current_point", LIBS);
  gidLink(cairo_identity_matrix, "cairo_identity_matrix", LIBS);
  gidLink(cairo_in_clip, "cairo_in_clip", LIBS);
  gidLink(cairo_in_fill, "cairo_in_fill", LIBS);
  gidLink(cairo_in_stroke, "cairo_in_stroke", LIBS);
  gidLink(cairo_line_to, "cairo_line_to", LIBS);
  gidLink(cairo_mask, "cairo_mask", LIBS);
  gidLink(cairo_mask_surface, "cairo_mask_surface", LIBS);
  gidLink(cairo_move_to, "cairo_move_to", LIBS);
  gidLink(cairo_new_path, "cairo_new_path", LIBS);
  gidLink(cairo_new_sub_path, "cairo_new_sub_path", LIBS);
  gidLink(cairo_paint, "cairo_paint", LIBS);
  gidLink(cairo_paint_with_alpha, "cairo_paint_with_alpha", LIBS);
  gidLink(cairo_path_extents, "cairo_path_extents", LIBS);
  gidLink(cairo_pop_group, "cairo_pop_group", LIBS);
  gidLink(cairo_pop_group_to_source, "cairo_pop_group_to_source", LIBS);
  gidLink(cairo_push_group, "cairo_push_group", LIBS);
  gidLink(cairo_push_group_with_content, "cairo_push_group_with_content", LIBS);
  gidLink(cairo_rectangle, "cairo_rectangle", LIBS);
  gidLink(cairo_rel_curve_to, "cairo_rel_curve_to", LIBS);
  gidLink(cairo_rel_line_to, "cairo_rel_line_to", LIBS);
  gidLink(cairo_rel_move_to, "cairo_rel_move_to", LIBS);
  gidLink(cairo_reset_clip, "cairo_reset_clip", LIBS);
  gidLink(cairo_restore, "cairo_restore", LIBS);
  gidLink(cairo_rotate, "cairo_rotate", LIBS);
  gidLink(cairo_save, "cairo_save", LIBS);
  gidLink(cairo_scale, "cairo_scale", LIBS);
  gidLink(cairo_select_font_face, "cairo_select_font_face", LIBS);
  gidLink(cairo_set_antialias, "cairo_set_antialias", LIBS);
  gidLink(cairo_set_dash, "cairo_set_dash", LIBS);
  gidLink(cairo_set_fill_rule, "cairo_set_fill_rule", LIBS);
  gidLink(cairo_set_font_face, "cairo_set_font_face", LIBS);
  gidLink(cairo_set_font_matrix, "cairo_set_font_matrix", LIBS);
  gidLink(cairo_set_font_options, "cairo_set_font_options", LIBS);
  gidLink(cairo_set_font_size, "cairo_set_font_size", LIBS);
  gidLink(cairo_set_hairline, "cairo_set_hairline", LIBS);
  gidLink(cairo_set_line_cap, "cairo_set_line_cap", LIBS);
  gidLink(cairo_set_line_join, "cairo_set_line_join", LIBS);
  gidLink(cairo_set_line_width, "cairo_set_line_width", LIBS);
  gidLink(cairo_set_matrix, "cairo_set_matrix", LIBS);
  gidLink(cairo_set_miter_limit, "cairo_set_miter_limit", LIBS);
  gidLink(cairo_set_operator, "cairo_set_operator", LIBS);
  gidLink(cairo_set_scaled_font, "cairo_set_scaled_font", LIBS);
  gidLink(cairo_set_source, "cairo_set_source", LIBS);
  gidLink(cairo_set_source_rgb, "cairo_set_source_rgb", LIBS);
  gidLink(cairo_set_source_rgba, "cairo_set_source_rgba", LIBS);
  gidLink(cairo_set_source_surface, "cairo_set_source_surface", LIBS);
  gidLink(cairo_set_tolerance, "cairo_set_tolerance", LIBS);
  gidLink(cairo_show_glyphs, "cairo_show_glyphs", LIBS);
  gidLink(cairo_show_page, "cairo_show_page", LIBS);
  gidLink(cairo_show_text, "cairo_show_text", LIBS);
  gidLink(cairo_show_text_glyphs, "cairo_show_text_glyphs", LIBS);
  gidLink(cairo_status, "cairo_status", LIBS);
  gidLink(cairo_stroke, "cairo_stroke", LIBS);
  gidLink(cairo_stroke_extents, "cairo_stroke_extents", LIBS);
  gidLink(cairo_stroke_preserve, "cairo_stroke_preserve", LIBS);
  gidLink(cairo_tag_begin, "cairo_tag_begin", LIBS);
  gidLink(cairo_tag_end, "cairo_tag_end", LIBS);
  gidLink(cairo_text_extents, "cairo_text_extents", LIBS);
  gidLink(cairo_text_path, "cairo_text_path", LIBS);
  gidLink(cairo_transform, "cairo_transform", LIBS);
  gidLink(cairo_translate, "cairo_translate", LIBS);
  gidLink(cairo_user_to_device, "cairo_user_to_device", LIBS);
  gidLink(cairo_user_to_device_distance, "cairo_user_to_device_distance", LIBS);

  // Device
  gidLink(cairo_gobject_device_get_type, "cairo_gobject_device_get_type", LIBS);
  gidLink(cairo_device_acquire, "cairo_device_acquire", LIBS);
  gidLink(cairo_device_destroy, "cairo_device_destroy", LIBS);
  gidLink(cairo_device_finish, "cairo_device_finish", LIBS);
  gidLink(cairo_device_flush, "cairo_device_flush", LIBS);
  gidLink(cairo_device_get_reference_count, "cairo_device_get_reference_count", LIBS);
  gidLink(cairo_device_get_type, "cairo_device_get_type", LIBS);
  gidLink(cairo_device_get_user_data, "cairo_device_get_user_data", LIBS);
  gidLink(cairo_device_observer_elapsed, "cairo_device_observer_elapsed", LIBS);
  gidLink(cairo_device_observer_fill_elapsed, "cairo_device_observer_fill_elapsed", LIBS);
  gidLink(cairo_device_observer_glyphs_elapsed, "cairo_device_observer_glyphs_elapsed", LIBS);
  gidLink(cairo_device_observer_mask_elapsed, "cairo_device_observer_mask_elapsed", LIBS);
  gidLink(cairo_device_observer_paint_elapsed, "cairo_device_observer_paint_elapsed", LIBS);
  gidLink(cairo_device_observer_print, "cairo_device_observer_print", LIBS);
  gidLink(cairo_device_observer_stroke_elapsed, "cairo_device_observer_stroke_elapsed", LIBS);
  gidLink(cairo_device_reference, "cairo_device_reference", LIBS);
  gidLink(cairo_device_release, "cairo_device_release", LIBS);
  gidLink(cairo_device_set_user_data, "cairo_device_set_user_data", LIBS);
  gidLink(cairo_device_status, "cairo_device_status", LIBS);

  // FontFace
  gidLink(cairo_gobject_font_face_get_type, "cairo_gobject_font_face_get_type", LIBS);
  gidLink(cairo_font_face_destroy, "cairo_font_face_destroy", LIBS);
  gidLink(cairo_font_face_get_reference_count, "cairo_font_face_get_reference_count", LIBS);
  gidLink(cairo_font_face_get_type, "cairo_font_face_get_type", LIBS);
  gidLink(cairo_font_face_get_user_data, "cairo_font_face_get_user_data", LIBS);
  gidLink(cairo_font_face_reference, "cairo_font_face_reference", LIBS);
  gidLink(cairo_font_face_set_user_data, "cairo_font_face_set_user_data", LIBS);
  gidLink(cairo_font_face_status, "cairo_font_face_status", LIBS);

  // FontOptions
  gidLink(cairo_gobject_font_options_get_type, "cairo_gobject_font_options_get_type", LIBS);
  gidLink(cairo_font_options_copy, "cairo_font_options_copy", LIBS);
  gidLink(cairo_font_options_destroy, "cairo_font_options_destroy", LIBS);
  gidLink(cairo_font_options_equal, "cairo_font_options_equal", LIBS);
  gidLink(cairo_font_options_get_antialias, "cairo_font_options_get_antialias", LIBS);
  gidLink(cairo_font_options_get_color_mode, "cairo_font_options_get_color_mode", LIBS);
  gidLink(cairo_font_options_get_color_palette, "cairo_font_options_get_color_palette", LIBS);
  gidLink(cairo_font_options_get_custom_palette_color, "cairo_font_options_get_custom_palette_color", LIBS);
  gidLink(cairo_font_options_get_hint_metrics, "cairo_font_options_get_hint_metrics", LIBS);
  gidLink(cairo_font_options_get_hint_style, "cairo_font_options_get_hint_style", LIBS);
  gidLink(cairo_font_options_get_subpixel_order, "cairo_font_options_get_subpixel_order", LIBS);
  gidLink(cairo_font_options_get_variations, "cairo_font_options_get_variations", LIBS);
  gidLink(cairo_font_options_hash, "cairo_font_options_hash", LIBS);
  gidLink(cairo_font_options_merge, "cairo_font_options_merge", LIBS);
  gidLink(cairo_font_options_set_antialias, "cairo_font_options_set_antialias", LIBS);
  gidLink(cairo_font_options_set_color_mode, "cairo_font_options_set_color_mode", LIBS);
  gidLink(cairo_font_options_set_color_palette, "cairo_font_options_set_color_palette", LIBS);
  gidLink(cairo_font_options_set_custom_palette_color, "cairo_font_options_set_custom_palette_color", LIBS);
  gidLink(cairo_font_options_set_hint_metrics, "cairo_font_options_set_hint_metrics", LIBS);
  gidLink(cairo_font_options_set_hint_style, "cairo_font_options_set_hint_style", LIBS);
  gidLink(cairo_font_options_set_subpixel_order, "cairo_font_options_set_subpixel_order", LIBS);
  gidLink(cairo_font_options_set_variations, "cairo_font_options_set_variations", LIBS);
  gidLink(cairo_font_options_status, "cairo_font_options_status", LIBS);

  // Global
  gidLink(cairo_create, "cairo_create", LIBS);
  gidLink(cairo_debug_reset_static_data, "cairo_debug_reset_static_data", LIBS);
  gidLink(cairo_destroy, "cairo_destroy", LIBS);
  gidLink(cairo_font_options_create, "cairo_font_options_create", LIBS);
  gidLink(cairo_format_stride_for_width, "cairo_format_stride_for_width", LIBS);
  gidLink(cairo_get_reference_count, "cairo_get_reference_count", LIBS);
  gidLink(cairo_get_user_data, "cairo_get_user_data", LIBS);
  gidLink(cairo_glyph_allocate, "cairo_glyph_allocate", LIBS);
  gidLink(cairo_image_surface_create, "cairo_image_surface_create", LIBS);
  gidLink(cairo_image_surface_create_for_data, "cairo_image_surface_create_for_data", LIBS);
  gidLink(cairo_image_surface_create_from_png, "cairo_image_surface_create_from_png", LIBS);
  gidLink(cairo_image_surface_create_from_png_stream, "cairo_image_surface_create_from_png_stream", LIBS);
  gidLink(cairo_image_surface_get_data, "cairo_image_surface_get_data", LIBS);
  gidLink(cairo_image_surface_get_format, "cairo_image_surface_get_format", LIBS);
  gidLink(cairo_image_surface_get_height, "cairo_image_surface_get_height", LIBS);
  gidLink(cairo_image_surface_get_stride, "cairo_image_surface_get_stride", LIBS);
  gidLink(cairo_image_surface_get_width, "cairo_image_surface_get_width", LIBS);
  gidLink(cairo_mesh_pattern_begin_patch, "cairo_mesh_pattern_begin_patch", LIBS);
  gidLink(cairo_mesh_pattern_curve_to, "cairo_mesh_pattern_curve_to", LIBS);
  gidLink(cairo_mesh_pattern_end_patch, "cairo_mesh_pattern_end_patch", LIBS);
  gidLink(cairo_mesh_pattern_get_control_point, "cairo_mesh_pattern_get_control_point", LIBS);
  gidLink(cairo_mesh_pattern_get_corner_color_rgba, "cairo_mesh_pattern_get_corner_color_rgba", LIBS);
  gidLink(cairo_mesh_pattern_get_patch_count, "cairo_mesh_pattern_get_patch_count", LIBS);
  gidLink(cairo_mesh_pattern_get_path, "cairo_mesh_pattern_get_path", LIBS);
  gidLink(cairo_mesh_pattern_line_to, "cairo_mesh_pattern_line_to", LIBS);
  gidLink(cairo_mesh_pattern_move_to, "cairo_mesh_pattern_move_to", LIBS);
  gidLink(cairo_mesh_pattern_set_control_point, "cairo_mesh_pattern_set_control_point", LIBS);
  gidLink(cairo_mesh_pattern_set_corner_color_rgb, "cairo_mesh_pattern_set_corner_color_rgb", LIBS);
  gidLink(cairo_mesh_pattern_set_corner_color_rgba, "cairo_mesh_pattern_set_corner_color_rgba", LIBS);
  gidLink(cairo_pattern_create_for_surface, "cairo_pattern_create_for_surface", LIBS);
  gidLink(cairo_pattern_create_linear, "cairo_pattern_create_linear", LIBS);
  gidLink(cairo_pattern_create_mesh, "cairo_pattern_create_mesh", LIBS);
  gidLink(cairo_pattern_create_radial, "cairo_pattern_create_radial", LIBS);
  gidLink(cairo_pattern_create_raster_source, "cairo_pattern_create_raster_source", LIBS);
  gidLink(cairo_pattern_create_rgb, "cairo_pattern_create_rgb", LIBS);
  gidLink(cairo_pattern_create_rgba, "cairo_pattern_create_rgba", LIBS);
  gidLink(cairo_pdf_get_versions, "cairo_pdf_get_versions", LIBS);
  gidLink(cairo_pdf_surface_add_outline, "cairo_pdf_surface_add_outline", LIBS);
  gidLink(cairo_pdf_surface_create, "cairo_pdf_surface_create", LIBS);
  gidLink(cairo_pdf_surface_create_for_stream, "cairo_pdf_surface_create_for_stream", LIBS);
  gidLink(cairo_pdf_surface_restrict_to_version, "cairo_pdf_surface_restrict_to_version", LIBS);
  gidLink(cairo_pdf_surface_set_custom_metadata, "cairo_pdf_surface_set_custom_metadata", LIBS);
  gidLink(cairo_pdf_surface_set_metadata, "cairo_pdf_surface_set_metadata", LIBS);
  gidLink(cairo_pdf_surface_set_page_label, "cairo_pdf_surface_set_page_label", LIBS);
  gidLink(cairo_pdf_surface_set_size, "cairo_pdf_surface_set_size", LIBS);
  gidLink(cairo_pdf_surface_set_thumbnail_size, "cairo_pdf_surface_set_thumbnail_size", LIBS);
  gidLink(cairo_pdf_version_to_string, "cairo_pdf_version_to_string", LIBS);
  gidLink(cairo_ps_get_levels, "cairo_ps_get_levels", LIBS);
  gidLink(cairo_ps_level_to_string, "cairo_ps_level_to_string", LIBS);
  gidLink(cairo_ps_surface_create, "cairo_ps_surface_create", LIBS);
  gidLink(cairo_ps_surface_create_for_stream, "cairo_ps_surface_create_for_stream", LIBS);
  gidLink(cairo_ps_surface_dsc_begin_page_setup, "cairo_ps_surface_dsc_begin_page_setup", LIBS);
  gidLink(cairo_ps_surface_dsc_begin_setup, "cairo_ps_surface_dsc_begin_setup", LIBS);
  gidLink(cairo_ps_surface_dsc_comment, "cairo_ps_surface_dsc_comment", LIBS);
  gidLink(cairo_ps_surface_get_eps, "cairo_ps_surface_get_eps", LIBS);
  gidLink(cairo_ps_surface_restrict_to_level, "cairo_ps_surface_restrict_to_level", LIBS);
  gidLink(cairo_ps_surface_set_eps, "cairo_ps_surface_set_eps", LIBS);
  gidLink(cairo_ps_surface_set_size, "cairo_ps_surface_set_size", LIBS);
  gidLink(cairo_raster_source_pattern_get_acquire, "cairo_raster_source_pattern_get_acquire", LIBS);
  gidLink(cairo_raster_source_pattern_get_callback_data, "cairo_raster_source_pattern_get_callback_data", LIBS);
  gidLink(cairo_raster_source_pattern_get_copy, "cairo_raster_source_pattern_get_copy", LIBS);
  gidLink(cairo_raster_source_pattern_get_finish, "cairo_raster_source_pattern_get_finish", LIBS);
  gidLink(cairo_raster_source_pattern_get_snapshot, "cairo_raster_source_pattern_get_snapshot", LIBS);
  gidLink(cairo_raster_source_pattern_set_acquire, "cairo_raster_source_pattern_set_acquire", LIBS);
  gidLink(cairo_raster_source_pattern_set_callback_data, "cairo_raster_source_pattern_set_callback_data", LIBS);
  gidLink(cairo_raster_source_pattern_set_copy, "cairo_raster_source_pattern_set_copy", LIBS);
  gidLink(cairo_raster_source_pattern_set_finish, "cairo_raster_source_pattern_set_finish", LIBS);
  gidLink(cairo_raster_source_pattern_set_snapshot, "cairo_raster_source_pattern_set_snapshot", LIBS);
  gidLink(cairo_recording_surface_create, "cairo_recording_surface_create", LIBS);
  gidLink(cairo_recording_surface_get_extents, "cairo_recording_surface_get_extents", LIBS);
  gidLink(cairo_recording_surface_ink_extents, "cairo_recording_surface_ink_extents", LIBS);
  gidLink(cairo_reference, "cairo_reference", LIBS);
  gidLink(cairo_region_create, "cairo_region_create", LIBS);
  gidLink(cairo_region_create_rectangle, "cairo_region_create_rectangle", LIBS);
  gidLink(cairo_region_create_rectangles, "cairo_region_create_rectangles", LIBS);
  gidLink(cairo_scaled_font_create, "cairo_scaled_font_create", LIBS);
  gidLink(cairo_script_create, "cairo_script_create", LIBS);
  gidLink(cairo_script_create_for_stream, "cairo_script_create_for_stream", LIBS);
  gidLink(cairo_script_from_recording_surface, "cairo_script_from_recording_surface", LIBS);
  gidLink(cairo_script_get_mode, "cairo_script_get_mode", LIBS);
  gidLink(cairo_script_set_mode, "cairo_script_set_mode", LIBS);
  gidLink(cairo_script_surface_create, "cairo_script_surface_create", LIBS);
  gidLink(cairo_script_surface_create_for_target, "cairo_script_surface_create_for_target", LIBS);
  gidLink(cairo_script_write_comment, "cairo_script_write_comment", LIBS);
  gidLink(cairo_set_user_data, "cairo_set_user_data", LIBS);
  gidLink(cairo_status_to_string, "cairo_status_to_string", LIBS);
  gidLink(cairo_svg_get_versions, "cairo_svg_get_versions", LIBS);
  gidLink(cairo_svg_surface_create, "cairo_svg_surface_create", LIBS);
  gidLink(cairo_svg_surface_create_for_stream, "cairo_svg_surface_create_for_stream", LIBS);
  gidLink(cairo_svg_surface_get_document_unit, "cairo_svg_surface_get_document_unit", LIBS);
  gidLink(cairo_svg_surface_restrict_to_version, "cairo_svg_surface_restrict_to_version", LIBS);
  gidLink(cairo_svg_surface_set_document_unit, "cairo_svg_surface_set_document_unit", LIBS);
  gidLink(cairo_svg_version_to_string, "cairo_svg_version_to_string", LIBS);
  gidLink(cairo_tee_surface_add, "cairo_tee_surface_add", LIBS);
  gidLink(cairo_tee_surface_create, "cairo_tee_surface_create", LIBS);
  gidLink(cairo_tee_surface_index, "cairo_tee_surface_index", LIBS);
  gidLink(cairo_tee_surface_remove, "cairo_tee_surface_remove", LIBS);
  gidLink(cairo_text_cluster_allocate, "cairo_text_cluster_allocate", LIBS);
  gidLink(cairo_toy_font_face_create, "cairo_toy_font_face_create", LIBS);
  gidLink(cairo_toy_font_face_get_family, "cairo_toy_font_face_get_family", LIBS);
  gidLink(cairo_toy_font_face_get_slant, "cairo_toy_font_face_get_slant", LIBS);
  gidLink(cairo_toy_font_face_get_weight, "cairo_toy_font_face_get_weight", LIBS);
  gidLink(cairo_user_font_face_create, "cairo_user_font_face_create", LIBS);
  gidLink(cairo_user_font_face_get_init_func, "cairo_user_font_face_get_init_func", LIBS);
  gidLink(cairo_user_font_face_get_render_color_glyph_func, "cairo_user_font_face_get_render_color_glyph_func", LIBS);
  gidLink(cairo_user_font_face_get_render_glyph_func, "cairo_user_font_face_get_render_glyph_func", LIBS);
  gidLink(cairo_user_font_face_get_text_to_glyphs_func, "cairo_user_font_face_get_text_to_glyphs_func", LIBS);
  gidLink(cairo_user_font_face_get_unicode_to_glyph_func, "cairo_user_font_face_get_unicode_to_glyph_func", LIBS);
  gidLink(cairo_user_font_face_set_init_func, "cairo_user_font_face_set_init_func", LIBS);
  gidLink(cairo_user_font_face_set_render_color_glyph_func, "cairo_user_font_face_set_render_color_glyph_func", LIBS);
  gidLink(cairo_user_font_face_set_render_glyph_func, "cairo_user_font_face_set_render_glyph_func", LIBS);
  gidLink(cairo_user_font_face_set_text_to_glyphs_func, "cairo_user_font_face_set_text_to_glyphs_func", LIBS);
  gidLink(cairo_user_font_face_set_unicode_to_glyph_func, "cairo_user_font_face_set_unicode_to_glyph_func", LIBS);
  gidLink(cairo_user_scaled_font_get_foreground_marker, "cairo_user_scaled_font_get_foreground_marker", LIBS);
  gidLink(cairo_user_scaled_font_get_foreground_source, "cairo_user_scaled_font_get_foreground_source", LIBS);
  gidLink(cairo_version, "cairo_version", LIBS);
  gidLink(cairo_version_string, "cairo_version_string", LIBS);

  // Glyph
  gidLink(cairo_gobject_glyph_get_type, "cairo_gobject_glyph_get_type", LIBS);
  gidLink(cairo_glyph_free, "cairo_glyph_free", LIBS);

  // Matrix
  gidLink(cairo_gobject_matrix_get_type, "cairo_gobject_matrix_get_type", LIBS);
  gidLink(cairo_matrix_init, "cairo_matrix_init", LIBS);
  gidLink(cairo_matrix_init_identity, "cairo_matrix_init_identity", LIBS);
  gidLink(cairo_matrix_init_rotate, "cairo_matrix_init_rotate", LIBS);
  gidLink(cairo_matrix_init_scale, "cairo_matrix_init_scale", LIBS);
  gidLink(cairo_matrix_init_translate, "cairo_matrix_init_translate", LIBS);
  gidLink(cairo_matrix_invert, "cairo_matrix_invert", LIBS);
  gidLink(cairo_matrix_multiply, "cairo_matrix_multiply", LIBS);
  gidLink(cairo_matrix_rotate, "cairo_matrix_rotate", LIBS);
  gidLink(cairo_matrix_scale, "cairo_matrix_scale", LIBS);
  gidLink(cairo_matrix_transform_distance, "cairo_matrix_transform_distance", LIBS);
  gidLink(cairo_matrix_transform_point, "cairo_matrix_transform_point", LIBS);
  gidLink(cairo_matrix_translate, "cairo_matrix_translate", LIBS);

  // Path
  gidLink(cairo_gobject_path_get_type, "cairo_gobject_path_get_type", LIBS);
  gidLink(cairo_path_destroy, "cairo_path_destroy", LIBS);

  // Pattern
  gidLink(cairo_gobject_pattern_get_type, "cairo_gobject_pattern_get_type", LIBS);
  gidLink(cairo_pattern_add_color_stop_rgb, "cairo_pattern_add_color_stop_rgb", LIBS);
  gidLink(cairo_pattern_add_color_stop_rgba, "cairo_pattern_add_color_stop_rgba", LIBS);
  gidLink(cairo_pattern_destroy, "cairo_pattern_destroy", LIBS);
  gidLink(cairo_pattern_get_color_stop_count, "cairo_pattern_get_color_stop_count", LIBS);
  gidLink(cairo_pattern_get_color_stop_rgba, "cairo_pattern_get_color_stop_rgba", LIBS);
  gidLink(cairo_pattern_get_dither, "cairo_pattern_get_dither", LIBS);
  gidLink(cairo_pattern_get_extend, "cairo_pattern_get_extend", LIBS);
  gidLink(cairo_pattern_get_filter, "cairo_pattern_get_filter", LIBS);
  gidLink(cairo_pattern_get_linear_points, "cairo_pattern_get_linear_points", LIBS);
  gidLink(cairo_pattern_get_matrix, "cairo_pattern_get_matrix", LIBS);
  gidLink(cairo_pattern_get_radial_circles, "cairo_pattern_get_radial_circles", LIBS);
  gidLink(cairo_pattern_get_reference_count, "cairo_pattern_get_reference_count", LIBS);
  gidLink(cairo_pattern_get_rgba, "cairo_pattern_get_rgba", LIBS);
  gidLink(cairo_pattern_get_surface, "cairo_pattern_get_surface", LIBS);
  gidLink(cairo_pattern_get_type, "cairo_pattern_get_type", LIBS);
  gidLink(cairo_pattern_get_user_data, "cairo_pattern_get_user_data", LIBS);
  gidLink(cairo_pattern_reference, "cairo_pattern_reference", LIBS);
  gidLink(cairo_pattern_set_dither, "cairo_pattern_set_dither", LIBS);
  gidLink(cairo_pattern_set_extend, "cairo_pattern_set_extend", LIBS);
  gidLink(cairo_pattern_set_filter, "cairo_pattern_set_filter", LIBS);
  gidLink(cairo_pattern_set_matrix, "cairo_pattern_set_matrix", LIBS);
  gidLink(cairo_pattern_set_user_data, "cairo_pattern_set_user_data", LIBS);
  gidLink(cairo_pattern_status, "cairo_pattern_status", LIBS);

  // Rectangle
  gidLink(cairo_gobject_rectangle_get_type, "cairo_gobject_rectangle_get_type", LIBS);

  // RectangleInt
  gidLink(cairo_gobject_rectangle_int_get_type, "cairo_gobject_rectangle_int_get_type", LIBS);

  // RectangleList
  gidLink(cairo_gobject_rectangle_list_get_type, "cairo_gobject_rectangle_list_get_type", LIBS);
  gidLink(cairo_rectangle_list_destroy, "cairo_rectangle_list_destroy", LIBS);

  // Region
  gidLink(cairo_gobject_region_get_type, "cairo_gobject_region_get_type", LIBS);
  gidLink(cairo_region_contains_point, "cairo_region_contains_point", LIBS);
  gidLink(cairo_region_contains_rectangle, "cairo_region_contains_rectangle", LIBS);
  gidLink(cairo_region_copy, "cairo_region_copy", LIBS);
  gidLink(cairo_region_destroy, "cairo_region_destroy", LIBS);
  gidLink(cairo_region_equal, "cairo_region_equal", LIBS);
  gidLink(cairo_region_get_extents, "cairo_region_get_extents", LIBS);
  gidLink(cairo_region_get_rectangle, "cairo_region_get_rectangle", LIBS);
  gidLink(cairo_region_intersect, "cairo_region_intersect", LIBS);
  gidLink(cairo_region_intersect_rectangle, "cairo_region_intersect_rectangle", LIBS);
  gidLink(cairo_region_is_empty, "cairo_region_is_empty", LIBS);
  gidLink(cairo_region_num_rectangles, "cairo_region_num_rectangles", LIBS);
  gidLink(cairo_region_reference, "cairo_region_reference", LIBS);
  gidLink(cairo_region_status, "cairo_region_status", LIBS);
  gidLink(cairo_region_subtract, "cairo_region_subtract", LIBS);
  gidLink(cairo_region_subtract_rectangle, "cairo_region_subtract_rectangle", LIBS);
  gidLink(cairo_region_translate, "cairo_region_translate", LIBS);
  gidLink(cairo_region_union, "cairo_region_union", LIBS);
  gidLink(cairo_region_union_rectangle, "cairo_region_union_rectangle", LIBS);
  gidLink(cairo_region_xor, "cairo_region_xor", LIBS);
  gidLink(cairo_region_xor_rectangle, "cairo_region_xor_rectangle", LIBS);

  // ScaledFont
  gidLink(cairo_gobject_scaled_font_get_type, "cairo_gobject_scaled_font_get_type", LIBS);
  gidLink(cairo_scaled_font_destroy, "cairo_scaled_font_destroy", LIBS);
  gidLink(cairo_scaled_font_extents, "cairo_scaled_font_extents", LIBS);
  gidLink(cairo_scaled_font_get_ctm, "cairo_scaled_font_get_ctm", LIBS);
  gidLink(cairo_scaled_font_get_font_face, "cairo_scaled_font_get_font_face", LIBS);
  gidLink(cairo_scaled_font_get_font_matrix, "cairo_scaled_font_get_font_matrix", LIBS);
  gidLink(cairo_scaled_font_get_font_options, "cairo_scaled_font_get_font_options", LIBS);
  gidLink(cairo_scaled_font_get_reference_count, "cairo_scaled_font_get_reference_count", LIBS);
  gidLink(cairo_scaled_font_get_scale_matrix, "cairo_scaled_font_get_scale_matrix", LIBS);
  gidLink(cairo_scaled_font_get_type, "cairo_scaled_font_get_type", LIBS);
  gidLink(cairo_scaled_font_get_user_data, "cairo_scaled_font_get_user_data", LIBS);
  gidLink(cairo_scaled_font_glyph_extents, "cairo_scaled_font_glyph_extents", LIBS);
  gidLink(cairo_scaled_font_reference, "cairo_scaled_font_reference", LIBS);
  gidLink(cairo_scaled_font_set_user_data, "cairo_scaled_font_set_user_data", LIBS);
  gidLink(cairo_scaled_font_status, "cairo_scaled_font_status", LIBS);
  gidLink(cairo_scaled_font_text_extents, "cairo_scaled_font_text_extents", LIBS);
  gidLink(cairo_scaled_font_text_to_glyphs, "cairo_scaled_font_text_to_glyphs", LIBS);

  // Surface
  gidLink(cairo_gobject_surface_get_type, "cairo_gobject_surface_get_type", LIBS);
  gidLink(cairo_surface_copy_page, "cairo_surface_copy_page", LIBS);
  gidLink(cairo_surface_create_for_rectangle, "cairo_surface_create_for_rectangle", LIBS);
  gidLink(cairo_surface_create_observer, "cairo_surface_create_observer", LIBS);
  gidLink(cairo_surface_create_similar, "cairo_surface_create_similar", LIBS);
  gidLink(cairo_surface_create_similar_image, "cairo_surface_create_similar_image", LIBS);
  gidLink(cairo_surface_destroy, "cairo_surface_destroy", LIBS);
  gidLink(cairo_surface_finish, "cairo_surface_finish", LIBS);
  gidLink(cairo_surface_flush, "cairo_surface_flush", LIBS);
  gidLink(cairo_surface_get_content, "cairo_surface_get_content", LIBS);
  gidLink(cairo_surface_get_device, "cairo_surface_get_device", LIBS);
  gidLink(cairo_surface_get_device_offset, "cairo_surface_get_device_offset", LIBS);
  gidLink(cairo_surface_get_device_scale, "cairo_surface_get_device_scale", LIBS);
  gidLink(cairo_surface_get_fallback_resolution, "cairo_surface_get_fallback_resolution", LIBS);
  gidLink(cairo_surface_get_font_options, "cairo_surface_get_font_options", LIBS);
  gidLink(cairo_surface_get_mime_data, "cairo_surface_get_mime_data", LIBS);
  gidLink(cairo_surface_get_reference_count, "cairo_surface_get_reference_count", LIBS);
  gidLink(cairo_surface_get_type, "cairo_surface_get_type", LIBS);
  gidLink(cairo_surface_get_user_data, "cairo_surface_get_user_data", LIBS);
  gidLink(cairo_surface_has_show_text_glyphs, "cairo_surface_has_show_text_glyphs", LIBS);
  gidLink(cairo_surface_map_to_image, "cairo_surface_map_to_image", LIBS);
  gidLink(cairo_surface_mark_dirty, "cairo_surface_mark_dirty", LIBS);
  gidLink(cairo_surface_mark_dirty_rectangle, "cairo_surface_mark_dirty_rectangle", LIBS);
  gidLink(cairo_surface_observer_add_fill_callback, "cairo_surface_observer_add_fill_callback", LIBS);
  gidLink(cairo_surface_observer_add_finish_callback, "cairo_surface_observer_add_finish_callback", LIBS);
  gidLink(cairo_surface_observer_add_flush_callback, "cairo_surface_observer_add_flush_callback", LIBS);
  gidLink(cairo_surface_observer_add_glyphs_callback, "cairo_surface_observer_add_glyphs_callback", LIBS);
  gidLink(cairo_surface_observer_add_mask_callback, "cairo_surface_observer_add_mask_callback", LIBS);
  gidLink(cairo_surface_observer_add_paint_callback, "cairo_surface_observer_add_paint_callback", LIBS);
  gidLink(cairo_surface_observer_add_stroke_callback, "cairo_surface_observer_add_stroke_callback", LIBS);
  gidLink(cairo_surface_observer_elapsed, "cairo_surface_observer_elapsed", LIBS);
  gidLink(cairo_surface_observer_print, "cairo_surface_observer_print", LIBS);
  gidLink(cairo_surface_reference, "cairo_surface_reference", LIBS);
  gidLink(cairo_surface_set_device_offset, "cairo_surface_set_device_offset", LIBS);
  gidLink(cairo_surface_set_device_scale, "cairo_surface_set_device_scale", LIBS);
  gidLink(cairo_surface_set_fallback_resolution, "cairo_surface_set_fallback_resolution", LIBS);
  gidLink(cairo_surface_set_mime_data, "cairo_surface_set_mime_data", LIBS);
  gidLink(cairo_surface_set_user_data, "cairo_surface_set_user_data", LIBS);
  gidLink(cairo_surface_show_page, "cairo_surface_show_page", LIBS);
  gidLink(cairo_surface_status, "cairo_surface_status", LIBS);
  gidLink(cairo_surface_supports_mime_type, "cairo_surface_supports_mime_type", LIBS);
  gidLink(cairo_surface_unmap_image, "cairo_surface_unmap_image", LIBS);
  gidLink(cairo_surface_write_to_png, "cairo_surface_write_to_png", LIBS);
  gidLink(cairo_surface_write_to_png_stream, "cairo_surface_write_to_png_stream", LIBS);

  // TextCluster
  gidLink(cairo_gobject_text_cluster_get_type, "cairo_gobject_text_cluster_get_type", LIBS);
  gidLink(cairo_text_cluster_free, "cairo_text_cluster_free", LIBS);
}
