...
class Int64ArrayBuilder : arrow.array_builder.ArrayBuilder
{
  ...
  bool append(long value)
  {
    bool _retval;
    GError *_err;
    _retval = garrow_int64_array_builder_append(cast(GArrowInt64ArrayBuilder*)cPtr, value, &_err);
    if (_err)
  ...
  bool appendValue(long value)
  {
    bool _retval;
    GError *_err;
    _retval = garrow_int64_array_builder_append_value(cast(GArrowInt64ArrayBuilder*)cPtr, value, &_err);
    if (_err)
      throw new ErrorG(_err);
    return _retval;
  }
  ...
  */
  bool appendValues(long[] values, bool[] isValids = null)
  {
    ...
    GError *_err;
    _retval = garrow_int64_array_builder_append_values(cast(GArrowInt64ArrayBuilder*)cPtr, _values, _valuesLength, _isValids, _isValidsLength, &_err);
    if (_err)
      throw new ErrorG(_err);
    return _retval;
  }
