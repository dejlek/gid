...
// Enums
alias GArrowCompressionType = arrow.types.CompressionType;
alias GArrowCountMode = arrow.types.CountMode;
alias GArrowError = arrow.types.Error;
alias GArrowFileMode = arrow.types.FileMode;
alias GArrowFileType = arrow.types.FileType;
alias GArrowFilterNullSelectionBehavior = arrow.types.FilterNullSelectionBehavior;
alias GArrowIntervalType = arrow.types.IntervalType;
alias GArrowJSONReadUnexpectedFieldBehavior = arrow.types.JSONReadUnexpectedFieldBehavior;
alias GArrowJoinType = arrow.types.JoinType;
alias GArrowMetadataVersion = arrow.types.MetadataVersion;
alias GArrowNullPlacement = arrow.types.NullPlacement;
alias GArrowQuantileInterpolation = arrow.types.QuantileInterpolation;
alias GArrowRankTiebreaker = arrow.types.RankTiebreaker;
alias GArrowRoundMode = arrow.types.RoundMode;
alias GArrowS3LogLevel = arrow.types.S3LogLevel;
alias GArrowSortOrder = arrow.types.SortOrder;
alias GArrowTimeUnit = arrow.types.TimeUnit;
alias GArrowType = arrow.types.Type;
alias GArrowUTF8NormalizeForm = arrow.types.UTF8NormalizeForm;
/** */
