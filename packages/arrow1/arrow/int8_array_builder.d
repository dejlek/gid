...
class Int8ArrayBuilder : arrow.array_builder.ArrayBuilder
{
  ...
  bool append(byte value)
  {
    bool _retval;
    GError *_err;
    _retval = garrow_int8_array_builder_append(cast(GArrowInt8ArrayBuilder*)this._cPtr, value, &_err);
    if (_err)
  ...
  bool appendValue(byte value)
  {
    bool _retval;
    GError *_err;
    _retval = garrow_int8_array_builder_append_value(cast(GArrowInt8ArrayBuilder*)this._cPtr, value, &_err);
    if (_err)
      throw new ErrorWrap(_err);
    return _retval;
  }
  ...
  */
  bool appendValues(byte[] values, bool[] isValids = null)
  {
    ...
    GError *_err;
    _retval = garrow_int8_array_builder_append_values(cast(GArrowInt8ArrayBuilder*)this._cPtr, _values, _valuesLength, _isValids, _isValidsLength, &_err);
    if (_err)
      throw new ErrorWrap(_err);
    return _retval;
  }
