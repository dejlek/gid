...
public import Atk.SelectionIfaceProxy;
...
template SelectionT()
{
   ...
   * atk_get_accessible_value$(LPAREN)$(RPAREN) convenience method.
   ...
   * atk_get_accessible_value$(LPAREN)$(RPAREN) convenience method.
   * Params:
   *   i = a #gint specifying the index in the selection set.  $(LPAREN)e.g. the
   *     ith selection as opposed to the ith child$(RPAREN).
